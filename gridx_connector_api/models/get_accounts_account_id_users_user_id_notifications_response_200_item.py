...
T = TypeVar("T", bound="GetAccountsAccountIDUsersUserIDNotificationsResponse200Item")


@_attrs_define
class GetAccountsAccountIDUsersUserIDNotificationsResponse200Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_accounts_account_id_users_user_id_notifications_response_200_item = cls(
        ...
        get_accounts_account_id_users_user_id_notifications_response_200_item.additional_properties = d
        return get_accounts_account_id_users_user_id_notifications_response_200_item
