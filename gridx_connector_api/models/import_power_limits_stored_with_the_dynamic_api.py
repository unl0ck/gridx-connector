...
T = TypeVar("T", bound="ImportPowerLimitsStoredWithTheDynamicAPI")


@_attrs_define
class ImportPowerLimitsStoredWithTheDynamicAPI:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        import_power_limits_stored_with_the_dynamic_api = cls(
        ...
        import_power_limits_stored_with_the_dynamic_api.additional_properties = d
        return import_power_limits_stored_with_the_dynamic_api
