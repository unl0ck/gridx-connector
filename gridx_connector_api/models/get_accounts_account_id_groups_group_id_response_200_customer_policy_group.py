...
T = TypeVar("T", bound="GetAccountsAccountIDGroupsGroupIDResponse200CustomerPolicyGroup")


@_attrs_define
class GetAccountsAccountIDGroupsGroupIDResponse200CustomerPolicyGroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_accounts_account_id_groups_group_id_response_200_customer_policy_group = cls(
            name=name,
            id=id,
        ...
        get_accounts_account_id_groups_group_id_response_200_customer_policy_group.additional_properties = d
        return get_accounts_account_id_groups_group_id_response_200_customer_policy_group
