...
T = TypeVar("T", bound="PatchAccountTokensTokenIDOrganizationalAPITokenUserLanguage")


@_attrs_define
class PatchAccountTokensTokenIDOrganizationalAPITokenUserLanguage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_account_tokens_token_id_organizational_api_token_user_language = cls(
            tag=tag,
            name=name,
            name_native=name_native,
        )

        patch_account_tokens_token_id_organizational_api_token_user_language.additional_properties = d
        return patch_account_tokens_token_id_organizational_api_token_user_language
