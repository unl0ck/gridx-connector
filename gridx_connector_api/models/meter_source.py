...
from ..models.meter_source_origin import MeterSourceOrigin
from ..types import UNSET, Unset

T = TypeVar("T", bound="MeterSource")
...
class MeterSource:
    """
    Attributes:
        origin (MeterSourceOrigin): Specifies who created the appliance. This can be one of:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        origin = MeterSourceOrigin(d.pop("origin"))
        ...
        meter_source.additional_properties = d
        return meter_source
