...
T = TypeVar("T", bound="GetGatewaysGatewayIDJobsResponse200ItemJobExecution")


@_attrs_define
class GetGatewaysGatewayIDJobsResponse200ItemJobExecution:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_gateways_gateway_id_jobs_response_200_item_job_execution = cls(
            id=id,
            job_id=job_id,
            succeeded=succeeded,
            error=error,
        ...
        get_gateways_gateway_id_jobs_response_200_item_job_execution.additional_properties = d
        return get_gateways_gateway_id_jobs_response_200_item_job_execution
