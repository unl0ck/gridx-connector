...
from ..models.get_accounts_account_id_accounts_account_kind import GetAccountsAccountIDAccountsAccountKind
from ..models.get_accounts_account_id_accounts_account_solution import GetAccountsAccountIDAccountsAccountSolution
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_accounts_account_id_accounts_account_address import GetAccountsAccountIDAccountsAccountAddress


T = TypeVar("T", bound="GetAccountsAccountIDAccountsAccount")


@_attrs_define
class GetAccountsAccountIDAccountsAccount:
    ...
    Attributes:
        ...
        solution (GetAccountsAccountIDAccountsAccountSolution | Unset): Represents the supported solutions within the
            account:
        ...
        kind (GetAccountsAccountIDAccountsAccountKind | Unset): If b2b, the account is a regular account. If end-user,
            the account is a customer account which contains just one user.
        main_address (GetAccountsAccountIDAccountsAccountAddress | Unset): Represents a physical address of a customer.
    ...
    solution: GetAccountsAccountIDAccountsAccountSolution | Unset = UNSET
    parent_id: UUID | Unset = UNSET
    systems_count: int | Unset = UNSET
    kind: GetAccountsAccountIDAccountsAccountKind | Unset = UNSET
    main_address: GetAccountsAccountIDAccountsAccountAddress | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        solution: GetAccountsAccountIDAccountsAccountSolution | Unset
        if isinstance(_solution, Unset):
            solution = UNSET
        else:
            solution = GetAccountsAccountIDAccountsAccountSolution(_solution)
        ...
        kind: GetAccountsAccountIDAccountsAccountKind | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = GetAccountsAccountIDAccountsAccountKind(_kind)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: GetAccountsAccountIDAccountsAccountAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = GetAccountsAccountIDAccountsAccountAddress.from_dict(_main_address)

        customization = d.pop("customization", UNSET)

        get_accounts_account_id_accounts_account = cls(
            id=id,
        ...
        get_accounts_account_id_accounts_account.additional_properties = d
        return get_accounts_account_id_accounts_account
