...
T = TypeVar("T", bound="AbstractEVStationEvLoadManagementParameters")


@_attrs_define
class AbstractEVStationEvLoadManagementParameters:
    ...
    **Deprecated** - Use the system's EV charging station configuration instead.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        abstract_ev_station_ev_load_management_parameters = cls(
            enabled=enabled,
            max_power=max_power,
        )

        abstract_ev_station_ev_load_management_parameters.additional_properties = d
        return abstract_ev_station_ev_load_management_parameters
