...
from ..models.appliance_update_heat_pump_information_type import ApplianceUpdateHeatPumpInformationType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ApplianceUpdateHeatPumpInformation")


@_attrs_define
class ApplianceUpdateHeatPumpInformation:
    """The heat pump specific information.

    Attributes:
        type_ (ApplianceUpdateHeatPumpInformationType | Unset): Describes the specific type of the heat pump.
    ...
    type_: ApplianceUpdateHeatPumpInformationType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: ApplianceUpdateHeatPumpInformationType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = ApplianceUpdateHeatPumpInformationType(_type_)
        ...
        appliance_update_heat_pump_information = cls(
            type_=type_,
        ...
        appliance_update_heat_pump_information.additional_properties = d
        return appliance_update_heat_pump_information
