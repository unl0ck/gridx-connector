...
from ..models.heater_source_origin import HeaterSourceOrigin
from ..types import UNSET, Unset

T = TypeVar("T", bound="HeaterSource")
...
class HeaterSource:
    """
    Attributes:
        origin (HeaterSourceOrigin): Specifies who created the appliance. This can be one of:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        origin = HeaterSourceOrigin(d.pop("origin"))
        ...
        heater_source.additional_properties = d
        return heater_source
