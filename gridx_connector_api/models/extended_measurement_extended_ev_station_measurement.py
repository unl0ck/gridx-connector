...
T = TypeVar("T", bound="ExtendedMeasurementExtendedEVStationMeasurement")


@_attrs_define
class ExtendedMeasurementExtendedEVStationMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        extended_measurement_extended_ev_station_measurement = cls(
            charge=charge,
            discharge=discharge,
        ...
        extended_measurement_extended_ev_station_measurement.additional_properties = d
        return extended_measurement_extended_ev_station_measurement
