...
from ..models.extended_measurement_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station_plug_state import (
...
T = TypeVar(
    "T",
    bound="ExtendedMeasurementMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation",
)


@_attrs_define
class ExtendedMeasurementMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation:
    """
    Attributes:
        ...
        plug_state (ExtendedMeasurementMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingSt
            ationPlugState | Unset): Defines whether this EV is currently plugged in the charging station and whether it's
            charging. Default: ExtendedMeasurementMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvCha
            rgingStationPlugState.UNPLUGGED.
    ...
    plug_state: (
        ExtendedMeasurementMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState
        | Unset
    ) = ExtendedMeasurementMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState.UNPLUGGED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_plug_state, Unset):
            ...
            plug_state = ExtendedMeasurementMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState(
                _plug_state
            )
        ...
        extended_measurement_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station = cls(
        ...
        extended_measurement_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station.additional_properties = d
        return extended_measurement_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station
