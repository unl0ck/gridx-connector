...
T = TypeVar("T", bound="GetGatewaysResponse403")


@_attrs_define
class GetGatewaysResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_gateways_response_403 = cls(
            message=message,
            details=details,
        )

        get_gateways_response_403.additional_properties = d
        return get_gateways_response_403
