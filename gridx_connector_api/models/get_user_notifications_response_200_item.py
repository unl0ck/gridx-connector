...
T = TypeVar("T", bound="GetUserNotificationsResponse200Item")


@_attrs_define
class GetUserNotificationsResponse200Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_notifications_response_200_item = cls(
        ...
        get_user_notifications_response_200_item.additional_properties = d
        return get_user_notifications_response_200_item
