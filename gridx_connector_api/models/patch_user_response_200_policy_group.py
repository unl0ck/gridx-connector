...
T = TypeVar("T", bound="PatchUserResponse200PolicyGroup")


@_attrs_define
class PatchUserResponse200PolicyGroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_user_response_200_policy_group = cls(
            name=name,
            id=id,
        ...
        patch_user_response_200_policy_group.additional_properties = d
        return patch_user_response_200_policy_group
