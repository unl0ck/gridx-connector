...
from ..models.base_appliance_appliance_connection_status_status import BaseApplianceApplianceConnectionStatusStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="BaseApplianceApplianceConnectionStatus")


@_attrs_define
class BaseApplianceApplianceConnectionStatus:
    """
    Attributes:
        status (BaseApplianceApplianceConnectionStatusStatus): Indicates the connection status of an appliance.
    ...
    status: BaseApplianceApplianceConnectionStatusStatus
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = BaseApplianceApplianceConnectionStatusStatus(d.pop("status"))
        ...
        base_appliance_appliance_connection_status = cls(
            status=status,
            contacted_at=contacted_at,
        )

        base_appliance_appliance_connection_status.additional_properties = d
        return base_appliance_appliance_connection_status
