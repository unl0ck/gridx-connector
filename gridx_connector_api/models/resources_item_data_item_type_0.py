...
from ..models.resources_item_data_item_type_0_state import ResourcesItemDataItemType0State
from ..models.resources_item_data_item_type_0_value_source import ResourcesItemDataItemType0ValueSource
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.resources_item_data_item_type_0_power_time_slots_item import (
        ResourcesItemDataItemType0PowerTimeSlotsItem,
    )


T = TypeVar("T", bound="ResourcesItemDataItemType0")


@_attrs_define
class ResourcesItemDataItemType0:
    """
    Attributes:
        ...
        power_time_slots (list[ResourcesItemDataItemType0PowerTimeSlotsItem]): List of power time slots for a power
            sequence. See EEBUS FSWG-060.
        sequence_id (int | Unset): Identifier of power sequence, must be unique in path. Example: 1.
        state (ResourcesItemDataItemType0State | Unset): EEBUS FSWG-025. See section 3.2.1.2.2.1.1.4 Example: scheduled.
        ...
        is_stoppable (bool | Unset): If the sequence can be stopped by the CEM, this element SHALL be present and set to
            ...
            For more details, see EEBUS FSWG-027.
             Default: False.
        value_source (ResourcesItemDataItemType0ValueSource | Unset): If not set, the source of forecasted values is
            undefined.
    ...
    power_time_slots: list[ResourcesItemDataItemType0PowerTimeSlotsItem]
    sequence_id: int | Unset = UNSET
    state: ResourcesItemDataItemType0State | Unset = UNSET
    ...
    value_source: ResourcesItemDataItemType0ValueSource | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for power_time_slots_item_data in _power_time_slots:
            power_time_slots_item = ResourcesItemDataItemType0PowerTimeSlotsItem.from_dict(power_time_slots_item_data)
        ...
        state: ResourcesItemDataItemType0State | Unset
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = ResourcesItemDataItemType0State(_state)
        ...
        value_source: ResourcesItemDataItemType0ValueSource | Unset
        if isinstance(_value_source, Unset):
            value_source = UNSET
        else:
            value_source = ResourcesItemDataItemType0ValueSource(_value_source)

        task_identifier = d.pop("taskIdentifier", UNSET)

        resources_item_data_item_type_0 = cls(
        ...
        resources_item_data_item_type_0.additional_properties = d
        return resources_item_data_item_type_0
