...
if TYPE_CHECKING:
    ...
    from ..models.user_policy_group import UserPolicyGroup
...
class User:
    ...
    This is the base type for the more concrete usages and not used directly within operations.
        ...
        Attributes:
            ...
            full_name (str | Unset): Full name of the user typically consisting of first name and last name. Example: John
                Doe.
            groups (list[UserPolicyGroup] | Unset): Policy groups attached to this user which determine the effective
                permissions through policies.
            main_address (UserAddress | Unset): Represents a physical address of a customer.
            language (UserLanguage | Unset): The language information of the user.
    """
    ...
    groups: list[UserPolicyGroup] | Unset = UNSET
    main_address: UserAddress | Unset = UNSET
    language: UserLanguage | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _groups is not UNSET:
            ...
            for groups_item_data in _groups:
                groups_item = UserPolicyGroup.from_dict(groups_item_data)

                groups.append(groups_item)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: UserAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = UserAddress.from_dict(_main_address)

        _language = d.pop("language", UNSET)
        language: UserLanguage | Unset
        if isinstance(_language, Unset):
            language = UNSET
        else:
            language = UserLanguage.from_dict(_language)
