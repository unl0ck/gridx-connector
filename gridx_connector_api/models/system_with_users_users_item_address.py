...
T = TypeVar("T", bound="SystemWithUsersUsersItemAddress")


@_attrs_define
class SystemWithUsersUsersItemAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        system_with_users_users_item_address = cls(
            city=city,
            country=country,
        ...
        system_with_users_users_item_address.additional_properties = d
        return system_with_users_users_item_address
