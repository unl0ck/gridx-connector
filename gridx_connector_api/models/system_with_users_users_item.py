...
if TYPE_CHECKING:
    from ..models.system_with_users_users_item_address import SystemWithUsersUsersItemAddress
    from ..models.system_with_users_users_item_language import SystemWithUsersUsersItemLanguage
    from ..models.system_with_users_users_item_policy_group import SystemWithUsersUsersItemPolicyGroup


T = TypeVar("T", bound="SystemWithUsersUsersItem")


@_attrs_define
class SystemWithUsersUsersItem:
    """
    Attributes:
        ...
        full_name (str | Unset): Full name of the user typically consisting of first name and last name. Example: John
            Doe.
        groups (list[SystemWithUsersUsersItemPolicyGroup] | Unset): Policy groups attached to this user which determine
            the effective permissions through policies.
        main_address (SystemWithUsersUsersItemAddress | Unset): Represents a physical address of a customer.
        language (SystemWithUsersUsersItemLanguage | Unset): The language information of the user.
    """
    ...
    groups: list[SystemWithUsersUsersItemPolicyGroup] | Unset = UNSET
    main_address: SystemWithUsersUsersItemAddress | Unset = UNSET
    language: SystemWithUsersUsersItemLanguage | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _groups is not UNSET:
            ...
            for groups_item_data in _groups:
                groups_item = SystemWithUsersUsersItemPolicyGroup.from_dict(groups_item_data)

                groups.append(groups_item)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: SystemWithUsersUsersItemAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = SystemWithUsersUsersItemAddress.from_dict(_main_address)

        _language = d.pop("language", UNSET)
        language: SystemWithUsersUsersItemLanguage | Unset
        if isinstance(_language, Unset):
            language = UNSET
        else:
            language = SystemWithUsersUsersItemLanguage.from_dict(_language)

        system_with_users_users_item = cls(
            id=id,
        ...
        system_with_users_users_item.additional_properties = d
        return system_with_users_users_item
