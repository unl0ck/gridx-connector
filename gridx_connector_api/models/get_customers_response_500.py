...
T = TypeVar("T", bound="GetCustomersResponse500")


@_attrs_define
class GetCustomersResponse500:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_customers_response_500 = cls(
            message=message,
            details=details,
        )

        get_customers_response_500.additional_properties = d
        return get_customers_response_500
