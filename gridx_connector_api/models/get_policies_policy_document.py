...
if TYPE_CHECKING:
    from ..models.get_policies_policy_document_policy_statement import GetPoliciesPolicyDocumentPolicyStatement


T = TypeVar("T", bound="GetPoliciesPolicyDocument")


@_attrs_define
class GetPoliciesPolicyDocument:
    """
    Attributes:
        ...
        statements (list[GetPoliciesPolicyDocumentPolicyStatement]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for statements_item_data in _statements:
            statements_item = GetPoliciesPolicyDocumentPolicyStatement.from_dict(statements_item_data)

            statements.append(statements_item)

        get_policies_policy_document = cls(
            name=name,
            version=version,
            id=id,
        ...
        get_policies_policy_document.additional_properties = d
        return get_policies_policy_document
