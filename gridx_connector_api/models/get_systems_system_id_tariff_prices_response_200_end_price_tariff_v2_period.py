...
T = TypeVar("T", bound="GetSystemsSystemIDTariffPricesResponse200EndPriceTariffV2Period")


@_attrs_define
class GetSystemsSystemIDTariffPricesResponse200EndPriceTariffV2Period:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_system_id_tariff_prices_response_200_end_price_tariff_v2_period = cls(
            from_=from_,
            to=to,
        ...
        get_systems_system_id_tariff_prices_response_200_end_price_tariff_v2_period.additional_properties = d
        return get_systems_system_id_tariff_prices_response_200_end_price_tariff_v2_period
