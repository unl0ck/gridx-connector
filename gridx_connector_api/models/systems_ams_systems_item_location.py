...
T = TypeVar("T", bound="SystemsAMSSystemsItemLocation")


@_attrs_define
class SystemsAMSSystemsItemLocation:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        systems_ams_systems_item_location = cls(
        ...
        systems_ams_systems_item_location.additional_properties = d
        return systems_ams_systems_item_location
