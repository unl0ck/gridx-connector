...
from ..models.post_accounts_account_kind import PostAccountsAccountKind
from ..models.post_accounts_account_solution import PostAccountsAccountSolution
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_accounts_account_address import PostAccountsAccountAddress


T = TypeVar("T", bound="PostAccountsAccount")


@_attrs_define
class PostAccountsAccount:
    ...
    Attributes:
        ...
        solution (PostAccountsAccountSolution | Unset): Represents the supported solutions within the account:
        ...
        kind (PostAccountsAccountKind | Unset): If b2b, the account is a regular account. If end-user, the account is a
            customer account which contains just one user.
        main_address (PostAccountsAccountAddress | Unset): Represents a physical address of a customer.
    ...
    solution: PostAccountsAccountSolution | Unset = UNSET
    parent_id: UUID | Unset = UNSET
    systems_count: int | Unset = UNSET
    kind: PostAccountsAccountKind | Unset = UNSET
    main_address: PostAccountsAccountAddress | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        solution: PostAccountsAccountSolution | Unset
        if isinstance(_solution, Unset):
            solution = UNSET
        else:
            solution = PostAccountsAccountSolution(_solution)
        ...
        kind: PostAccountsAccountKind | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = PostAccountsAccountKind(_kind)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: PostAccountsAccountAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = PostAccountsAccountAddress.from_dict(_main_address)

        customization = d.pop("customization", UNSET)

        post_accounts_account = cls(
            id=id,
        ...
        post_accounts_account.additional_properties = d
        return post_accounts_account
