...
if TYPE_CHECKING:
    from ..models.get_systems_system_id_historical_measurements_total_measurement_grid_measurement_grid_meter_reading import (
        GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementGridMeasurementGridMeterReading,
    )


T = TypeVar("T", bound="GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementGrid")


@_attrs_define
class GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementGrid:
    """
    Attributes:
        ...
        meter_reading (GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementGridMeasurementGridMeterReading | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meter_reading, Unset):
            ...
            meter_reading = (
                GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementGridMeasurementGridMeterReading.from_dict(
                    _meter_reading
                )
            )

        get_systems_system_id_historical_measurements_total_measurement_grid = cls(
        ...
        get_systems_system_id_historical_measurements_total_measurement_grid.additional_properties = d
        return get_systems_system_id_historical_measurements_total_measurement_grid
