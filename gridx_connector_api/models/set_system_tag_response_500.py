...
T = TypeVar("T", bound="SetSystemTagResponse500")


@_attrs_define
class SetSystemTagResponse500:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_system_tag_response_500 = cls(
            message=message,
            details=details,
        )

        set_system_tag_response_500.additional_properties = d
        return set_system_tag_response_500
