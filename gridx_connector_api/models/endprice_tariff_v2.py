...
if TYPE_CHECKING:
    from ..models.endprice_tariff_v2_end_price_tariff_v2_period import EndpriceTariffV2EndPriceTariffV2Period
...
class EndpriceTariffV2:
    ...
    Attributes:
        ...
        periods (list[EndpriceTariffV2EndPriceTariffV2Period]): List of periods containing end prices over non-
            overlapping periods.
    ...
    currency: str
    periods: list[EndpriceTariffV2EndPriceTariffV2Period]
    name: None | str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        endprice_tariff_v2.additional_properties = d
        return endprice_tariff_v2
