...
T = TypeVar("T", bound="PolicyGroupWithCustomersCustomerPolicyGroup")


@_attrs_define
class PolicyGroupWithCustomersCustomerPolicyGroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        policy_group_with_customers_customer_policy_group = cls(
            name=name,
            id=id,
        ...
        policy_group_with_customers_customer_policy_group.additional_properties = d
        return policy_group_with_customers_customer_policy_group
