...
from ..models.patch_account_account_kind import PatchAccountAccountKind
from ..models.patch_account_account_solution import PatchAccountAccountSolution
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.patch_account_account_address import PatchAccountAccountAddress


T = TypeVar("T", bound="PatchAccountAccount")


@_attrs_define
class PatchAccountAccount:
    ...
    Attributes:
        ...
        solution (PatchAccountAccountSolution | Unset): Represents the supported solutions within the account:
        ...
        kind (PatchAccountAccountKind | Unset): If b2b, the account is a regular account. If end-user, the account is a
            customer account which contains just one user.
        main_address (PatchAccountAccountAddress | Unset): Represents a physical address of a customer.
    ...
    solution: PatchAccountAccountSolution | Unset = UNSET
    parent_id: UUID | Unset = UNSET
    systems_count: int | Unset = UNSET
    kind: PatchAccountAccountKind | Unset = UNSET
    main_address: PatchAccountAccountAddress | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        solution: PatchAccountAccountSolution | Unset
        if isinstance(_solution, Unset):
            solution = UNSET
        else:
            solution = PatchAccountAccountSolution(_solution)
        ...
        kind: PatchAccountAccountKind | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = PatchAccountAccountKind(_kind)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: PatchAccountAccountAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = PatchAccountAccountAddress.from_dict(_main_address)

        customization = d.pop("customization", UNSET)

        patch_account_account = cls(
            id=id,
        ...
        patch_account_account.additional_properties = d
        return patch_account_account
