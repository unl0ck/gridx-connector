...
if TYPE_CHECKING:
    from ..models.get_user_response_200_address import GetUserResponse200Address
    from ..models.get_user_response_200_language import GetUserResponse200Language
    from ..models.get_user_response_200_policy_group import GetUserResponse200PolicyGroup
...
class GetUserResponse200:
    ...
    Attributes:
        ...
        full_name (str | Unset): Full name of the user typically consisting of first name and last name. Example: John
            Doe.
        groups (list[GetUserResponse200PolicyGroup] | Unset): Policy groups attached to this user which determine the
            effective permissions through policies.
        main_address (GetUserResponse200Address | Unset): Represents a physical address of a customer.
        language (GetUserResponse200Language | Unset): The language information of the user.
    """
    ...
    groups: list[GetUserResponse200PolicyGroup] | Unset = UNSET
    main_address: GetUserResponse200Address | Unset = UNSET
    language: GetUserResponse200Language | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _groups is not UNSET:
            ...
            for groups_item_data in _groups:
                groups_item = GetUserResponse200PolicyGroup.from_dict(groups_item_data)

                groups.append(groups_item)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: GetUserResponse200Address | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = GetUserResponse200Address.from_dict(_main_address)

        _language = d.pop("language", UNSET)
        language: GetUserResponse200Language | Unset
        if isinstance(_language, Unset):
            language = UNSET
        else:
            language = GetUserResponse200Language.from_dict(_language)
