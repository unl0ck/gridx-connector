...
T = TypeVar("T", bound="PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201PowerTimeSlotsItem")


@_attrs_define
class PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201PowerTimeSlotsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_spine_devices_device_id_powersequences_sequence_id_response_201_power_time_slots_item = cls(
            slot_id=slot_id,
        ...
        patch_spine_devices_device_id_powersequences_sequence_id_response_201_power_time_slots_item.additional_properties = d
        return patch_spine_devices_device_id_powersequences_sequence_id_response_201_power_time_slots_item
