...
if TYPE_CHECKING:
    from ..models.policy_group_with_customers_customer_address import PolicyGroupWithCustomersCustomerAddress
    from ..models.policy_group_with_customers_customer_language import PolicyGroupWithCustomersCustomerLanguage
    from ..models.policy_group_with_customers_customer_policy_group import PolicyGroupWithCustomersCustomerPolicyGroup


T = TypeVar("T", bound="PolicyGroupWithCustomersCustomer")


@_attrs_define
class PolicyGroupWithCustomersCustomer:
    ...
    Attributes:
        ...
        full_name (str | Unset): Full name of the user typically consisting of first name and last name. Example: John
            Doe.
        groups (list[PolicyGroupWithCustomersCustomerPolicyGroup] | Unset): Policy groups attached to this user which
            determine the effective permissions through policies.
        main_address (PolicyGroupWithCustomersCustomerAddress | Unset): Represents a physical address of a customer.
        language (PolicyGroupWithCustomersCustomerLanguage | Unset): The language information of the user.
    """
    ...
    groups: list[PolicyGroupWithCustomersCustomerPolicyGroup] | Unset = UNSET
    main_address: PolicyGroupWithCustomersCustomerAddress | Unset = UNSET
    language: PolicyGroupWithCustomersCustomerLanguage | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.policy_group_with_customers_customer_address import PolicyGroupWithCustomersCustomerAddress
        from ..models.policy_group_with_customers_customer_language import PolicyGroupWithCustomersCustomerLanguage
        from ..models.policy_group_with_customers_customer_policy_group import (
        ...
        if _groups is not UNSET:
            ...
            for groups_item_data in _groups:
                groups_item = PolicyGroupWithCustomersCustomerPolicyGroup.from_dict(groups_item_data)

                groups.append(groups_item)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: PolicyGroupWithCustomersCustomerAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = PolicyGroupWithCustomersCustomerAddress.from_dict(_main_address)

        _language = d.pop("language", UNSET)
        language: PolicyGroupWithCustomersCustomerLanguage | Unset
        if isinstance(_language, Unset):
            language = UNSET
        else:
            language = PolicyGroupWithCustomersCustomerLanguage.from_dict(_language)

        policy_group_with_customers_customer = cls(
            id=id,
        ...
        policy_group_with_customers_customer.additional_properties = d
        return policy_group_with_customers_customer
