...
T = TypeVar("T", bound="ElectricVehicleProfileCreate")


@_attrs_define
class ElectricVehicleProfileCreate:
    """
    Attributes:
        ...
        id (UUID | Unset): Unique identifier of an EV profile. Example: 51c0c70f-dfcc-4520-b535-0ecc44c75e12.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        electric_vehicle_profile_create = cls(
            name=name,
        ...
        electric_vehicle_profile_create.additional_properties = d
        return electric_vehicle_profile_create
