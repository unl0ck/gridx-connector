...
T = TypeVar("T", bound="PostAccountTokensResponse400")


@_attrs_define
class PostAccountTokensResponse400:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_account_tokens_response_400 = cls(
            message=message,
            details=details,
        )

        post_account_tokens_response_400.additional_properties = d
        return post_account_tokens_response_400
