...
T = TypeVar("T", bound="GetAccountsAccountIDUsersUserIDNotificationsNotificationIDResponse200")


@_attrs_define
class GetAccountsAccountIDUsersUserIDNotificationsNotificationIDResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_accounts_account_id_users_user_id_notifications_notification_id_response_200 = cls(
        ...
        get_accounts_account_id_users_user_id_notifications_notification_id_response_200.additional_properties = d
        return get_accounts_account_id_users_user_id_notifications_notification_id_response_200
