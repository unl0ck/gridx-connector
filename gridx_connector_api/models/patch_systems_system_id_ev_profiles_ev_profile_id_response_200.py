...
T = TypeVar("T", bound="PatchSystemsSystemIDEvProfilesEvProfileIDResponse200")


@_attrs_define
class PatchSystemsSystemIDEvProfilesEvProfileIDResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_systems_system_id_ev_profiles_ev_profile_id_response_200 = cls(
            id=id,
            system_id=system_id,
        ...
        patch_systems_system_id_ev_profiles_ev_profile_id_response_200.additional_properties = d
        return patch_systems_system_id_ev_profiles_ev_profile_id_response_200
