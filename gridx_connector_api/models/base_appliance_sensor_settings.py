...
T = TypeVar("T", bound="BaseApplianceSensorSettings")


@_attrs_define
class BaseApplianceSensorSettings:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        base_appliance_sensor_settings = cls(
        ...
        base_appliance_sensor_settings.additional_properties = d
        return base_appliance_sensor_settings
