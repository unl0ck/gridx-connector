...
T = TypeVar("T", bound="MeasurementsDataItemExtendedBatteryMeasurement")


@_attrs_define
class MeasurementsDataItemExtendedBatteryMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        measurements_data_item_extended_battery_measurement = cls(
            charge=charge,
            discharge=discharge,
        ...
        measurements_data_item_extended_battery_measurement.additional_properties = d
        return measurements_data_item_extended_battery_measurement
