...
T = TypeVar("T", bound="SetSystemTagsBodyItem")


@_attrs_define
class SetSystemTagsBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_system_tags_body_item = cls(
            name=name,
            value=value,
        )

        set_system_tags_body_item.additional_properties = d
        return set_system_tags_body_item
