...
T = TypeVar("T", bound="PostAccountsAccountIDScanconfigurationScanConfiguration")


@_attrs_define
class PostAccountsAccountIDScanconfigurationScanConfiguration:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_accounts_account_id_scanconfiguration_scan_configuration = cls(
        ...
        post_accounts_account_id_scanconfiguration_scan_configuration.additional_properties = d
        return post_accounts_account_id_scanconfiguration_scan_configuration
