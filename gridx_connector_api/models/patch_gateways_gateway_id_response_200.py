...
from ..models.patch_gateways_gateway_id_response_200_scanners_item import PatchGatewaysGatewayIDResponse200ScannersItem
from ..models.patch_gateways_gateway_id_response_200_type import PatchGatewaysGatewayIDResponse200Type
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.patch_gateways_gateway_id_response_200_additional_identifiers_of_the_grid_box import (
        PatchGatewaysGatewayIDResponse200AdditionalIdentifiersOfTheGridBox,
    )
    from ..models.patch_gateways_gateway_id_response_200_connection_status import (
        PatchGatewaysGatewayIDResponse200ConnectionStatus,
    )


T = TypeVar("T", bound="PatchGatewaysGatewayIDResponse200")


@_attrs_define
class PatchGatewaysGatewayIDResponse200:
    """
    Attributes:
        id (UUID): Unique identifier of a gateway. Example: 6dd0a658-5828-4d30-bc65-a03c6d6e425f.
        type_ (PatchGatewaysGatewayIDResponse200Type): Type of the gateway.
        ...
        connection_status (PatchGatewaysGatewayIDResponse200ConnectionStatus):
        ...
        additional_identifiers (list[PatchGatewaysGatewayIDResponse200AdditionalIdentifiersOfTheGridBox] | Unset):
            Additional identifiers used by the gateway.
        scanners (list[PatchGatewaysGatewayIDResponse200ScannersItem] | Unset): List of scanner names that are enabled
            for this gateway.
    ...
    id: UUID
    type_: PatchGatewaysGatewayIDResponse200Type
    ...
    additional_identifiers: list[PatchGatewaysGatewayIDResponse200AdditionalIdentifiersOfTheGridBox] | Unset = UNSET
    scanners: list[PatchGatewaysGatewayIDResponse200ScannersItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = PatchGatewaysGatewayIDResponse200Type(d.pop("type"))

        created_at = isoparse(d.pop("createdAt"))

        updated_at = isoparse(d.pop("updatedAt"))

        connection_status = PatchGatewaysGatewayIDResponse200ConnectionStatus.from_dict(d.pop("connectionStatus"))
        ...
        if _additional_identifiers is not UNSET:
            ...
            for additional_identifiers_item_data in _additional_identifiers:
                additional_identifiers_item = (
                    PatchGatewaysGatewayIDResponse200AdditionalIdentifiersOfTheGridBox.from_dict(
        ...
        if _scanners is not UNSET:
            ...
            for scanners_item_data in _scanners:
                scanners_item = PatchGatewaysGatewayIDResponse200ScannersItem(scanners_item_data)

                scanners.append(scanners_item)

        appliance_composition = cast(list[str], d.pop("applianceComposition", UNSET))

        patch_gateways_gateway_id_response_200 = cls(
            id=id,
            type_=type_,
        ...
        patch_gateways_gateway_id_response_200.additional_properties = d
        return patch_gateways_gateway_id_response_200
