...
T = TypeVar("T", bound="AccountCreateAddress")


@_attrs_define
class AccountCreateAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account_create_address.additional_properties = d
        return account_create_address
