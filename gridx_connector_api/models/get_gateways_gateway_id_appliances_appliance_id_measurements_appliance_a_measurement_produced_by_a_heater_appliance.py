...
T = TypeVar(
    "T", bound="GetGatewaysGatewayIDAppliancesApplianceIDMeasurementsApplianceAMeasurementProducedByAHeaterAppliance"
)


@_attrs_define
class GetGatewaysGatewayIDAppliancesApplianceIDMeasurementsApplianceAMeasurementProducedByAHeaterAppliance:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_gateways_gateway_id_appliances_appliance_id_measurements_appliance_a_measurement_produced_by_a_heater_appliance = cls(
        ...
        get_gateways_gateway_id_appliances_appliance_id_measurements_appliance_a_measurement_produced_by_a_heater_appliance.additional_properties = d
        return get_gateways_gateway_id_appliances_appliance_id_measurements_appliance_a_measurement_produced_by_a_heater_appliance
