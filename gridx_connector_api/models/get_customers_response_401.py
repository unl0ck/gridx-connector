...
T = TypeVar("T", bound="GetCustomersResponse401")


@_attrs_define
class GetCustomersResponse401:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_customers_response_401 = cls(
            message=message,
            details=details,
        )

        get_customers_response_401.additional_properties = d
        return get_customers_response_401
