...
if TYPE_CHECKING:
    from ..models.policy_document_update_policy_statement import PolicyDocumentUpdatePolicyStatement


T = TypeVar("T", bound="PolicyDocumentUpdate")


@_attrs_define
class PolicyDocumentUpdate:
    """
    Attributes:
        name (str): Name of the policy. Example: Default Policy.
        version (str): Version of the policy. Example: Default Policy.
        statements (list[PolicyDocumentUpdatePolicyStatement] | Unset):
    """

    name: str
    version: str
    statements: list[PolicyDocumentUpdatePolicyStatement] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _statements is not UNSET:
            ...
            for statements_item_data in _statements:
                statements_item = PolicyDocumentUpdatePolicyStatement.from_dict(statements_item_data)

                statements.append(statements_item)

        policy_document_update = cls(
            name=name,
            version=version,
            statements=statements,
        )

        policy_document_update.additional_properties = d
        return policy_document_update
