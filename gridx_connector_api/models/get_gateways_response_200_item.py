...
from ..models.get_gateways_response_200_item_scanners_item import GetGatewaysResponse200ItemScannersItem
from ..models.get_gateways_response_200_item_type import GetGatewaysResponse200ItemType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_gateways_response_200_item_additional_identifiers_of_the_grid_box import (
        GetGatewaysResponse200ItemAdditionalIdentifiersOfTheGridBox,
    )
    from ..models.get_gateways_response_200_item_connection_status import GetGatewaysResponse200ItemConnectionStatus


T = TypeVar("T", bound="GetGatewaysResponse200Item")


@_attrs_define
class GetGatewaysResponse200Item:
    """
    Attributes:
        id (UUID): Unique identifier of a gateway. Example: 6dd0a658-5828-4d30-bc65-a03c6d6e425f.
        type_ (GetGatewaysResponse200ItemType): Type of the gateway.
        ...
        connection_status (GetGatewaysResponse200ItemConnectionStatus):
        ...
        additional_identifiers (list[GetGatewaysResponse200ItemAdditionalIdentifiersOfTheGridBox] | Unset): Additional
            identifiers used by the gateway.
        scanners (list[GetGatewaysResponse200ItemScannersItem] | Unset): List of scanner names that are enabled for this
            gateway.
    ...
    id: UUID
    type_: GetGatewaysResponse200ItemType
    ...
    additional_identifiers: list[GetGatewaysResponse200ItemAdditionalIdentifiersOfTheGridBox] | Unset = UNSET
    scanners: list[GetGatewaysResponse200ItemScannersItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetGatewaysResponse200ItemType(d.pop("type"))

        created_at = isoparse(d.pop("createdAt"))

        updated_at = isoparse(d.pop("updatedAt"))

        connection_status = GetGatewaysResponse200ItemConnectionStatus.from_dict(d.pop("connectionStatus"))
        ...
        if _additional_identifiers is not UNSET:
            ...
            for additional_identifiers_item_data in _additional_identifiers:
                additional_identifiers_item = GetGatewaysResponse200ItemAdditionalIdentifiersOfTheGridBox.from_dict(
        ...
        if _scanners is not UNSET:
            ...
            for scanners_item_data in _scanners:
                scanners_item = GetGatewaysResponse200ItemScannersItem(scanners_item_data)

                scanners.append(scanners_item)

        appliance_composition = cast(list[str], d.pop("applianceComposition", UNSET))

        get_gateways_response_200_item = cls(
            id=id,
            type_=type_,
        ...
        get_gateways_response_200_item.additional_properties = d
        return get_gateways_response_200_item
