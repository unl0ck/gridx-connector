...
T = TypeVar("T", bound="PolicyGroupWithCustomersCustomerAddress")


@_attrs_define
class PolicyGroupWithCustomersCustomerAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        policy_group_with_customers_customer_address = cls(
            city=city,
            country=country,
        ...
        policy_group_with_customers_customer_address.additional_properties = d
        return policy_group_with_customers_customer_address
