...
T = TypeVar("T", bound="MeasurementsTotalExtendedBatteryMeasurement")


@_attrs_define
class MeasurementsTotalExtendedBatteryMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        measurements_total_extended_battery_measurement = cls(
            charge=charge,
            discharge=discharge,
        ...
        measurements_total_extended_battery_measurement.additional_properties = d
        return measurements_total_extended_battery_measurement
