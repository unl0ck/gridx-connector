...
T = TypeVar("T", bound="GetCustomersCustomerIDUsersResponse200ItemPolicyGroup")


@_attrs_define
class GetCustomersCustomerIDUsersResponse200ItemPolicyGroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_customers_customer_id_users_response_200_item_policy_group = cls(
            name=name,
            id=id,
        ...
        get_customers_customer_id_users_response_200_item_policy_group.additional_properties = d
        return get_customers_customer_id_users_response_200_item_policy_group
