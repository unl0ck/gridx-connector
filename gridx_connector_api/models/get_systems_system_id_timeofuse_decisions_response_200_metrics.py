...
T = TypeVar("T", bound="GetSystemsSystemIDTimeofuseDecisionsResponse200Metrics")


@_attrs_define
class GetSystemsSystemIDTimeofuseDecisionsResponse200Metrics:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_system_id_timeofuse_decisions_response_200_metrics = cls(
            percent_decision_taken=percent_decision_taken,
        )

        get_systems_system_id_timeofuse_decisions_response_200_metrics.additional_properties = d
        return get_systems_system_id_timeofuse_decisions_response_200_metrics
