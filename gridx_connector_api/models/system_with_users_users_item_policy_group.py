...
T = TypeVar("T", bound="SystemWithUsersUsersItemPolicyGroup")


@_attrs_define
class SystemWithUsersUsersItemPolicyGroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        system_with_users_users_item_policy_group = cls(
            name=name,
            id=id,
        ...
        system_with_users_users_item_policy_group.additional_properties = d
        return system_with_users_users_item_policy_group
