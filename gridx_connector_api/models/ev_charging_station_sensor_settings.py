...
T = TypeVar("T", bound="EVChargingStationSensorSettings")


@_attrs_define
class EVChargingStationSensorSettings:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ev_charging_station_sensor_settings = cls(
        ...
        ev_charging_station_sensor_settings.additional_properties = d
        return ev_charging_station_sensor_settings
