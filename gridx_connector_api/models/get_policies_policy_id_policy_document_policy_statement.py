...
from ..models.get_policies_policy_id_policy_document_policy_statement_effect import (
    GetPoliciesPolicyIDPolicyDocumentPolicyStatementEffect,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPoliciesPolicyIDPolicyDocumentPolicyStatement")


@_attrs_define
class GetPoliciesPolicyIDPolicyDocumentPolicyStatement:
    """
    Attributes:
        ...
        action (str): The action that this statement represents. An action is an operation on a resource. Example:
            groups:Create.
        effect (GetPoliciesPolicyIDPolicyDocumentPolicyStatementEffect): Whether this statement restricts or grants the
    ...
    name: str
    action: str
    effect: GetPoliciesPolicyIDPolicyDocumentPolicyStatementEffect
    fields: str
    resource: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        effect = GetPoliciesPolicyIDPolicyDocumentPolicyStatementEffect(d.pop("effect"))
        ...
        get_policies_policy_id_policy_document_policy_statement = cls(
            id=id,
            name=name,
            action=action,
            effect=effect,
        ...
        get_policies_policy_id_policy_document_policy_statement.additional_properties = d
        return get_policies_policy_id_policy_document_policy_statement
