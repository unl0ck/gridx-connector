...
T = TypeVar("T", bound="GetSystemsSystemIDHistoricalMeasurementsTotalHeaterMeasurement")


@_attrs_define
class GetSystemsSystemIDHistoricalMeasurementsTotalHeaterMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_system_id_historical_measurements_total_heater_measurement = cls(
        ...
        get_systems_system_id_historical_measurements_total_heater_measurement.additional_properties = d
        return get_systems_system_id_historical_measurements_total_heater_measurement
