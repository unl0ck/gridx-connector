...
T = TypeVar("T", bound="GetAccountTokensResponse500")


@_attrs_define
class GetAccountTokensResponse500:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_account_tokens_response_500 = cls(
            message=message,
            details=details,
        )

        get_account_tokens_response_500.additional_properties = d
        return get_account_tokens_response_500
