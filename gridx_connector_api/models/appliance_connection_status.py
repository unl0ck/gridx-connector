...
from ..models.appliance_connection_status_status import ApplianceConnectionStatusStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="ApplianceConnectionStatus")


@_attrs_define
class ApplianceConnectionStatus:
    """
    Attributes:
        status (ApplianceConnectionStatusStatus): Indicates the connection status of an appliance.
    ...
    status: ApplianceConnectionStatusStatus
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = ApplianceConnectionStatusStatus(d.pop("status"))
        ...
        appliance_connection_status = cls(
            status=status,
            contacted_at=contacted_at,
        )

        appliance_connection_status.additional_properties = d
        return appliance_connection_status
