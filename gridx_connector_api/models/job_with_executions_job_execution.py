...
T = TypeVar("T", bound="JobWithExecutionsJobExecution")


@_attrs_define
class JobWithExecutionsJobExecution:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        job_with_executions_job_execution = cls(
            id=id,
            job_id=job_id,
            succeeded=succeeded,
            error=error,
        ...
        job_with_executions_job_execution.additional_properties = d
        return job_with_executions_job_execution
