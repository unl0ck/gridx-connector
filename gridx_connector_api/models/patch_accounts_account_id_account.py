...
from ..models.patch_accounts_account_id_account_kind import PatchAccountsAccountIDAccountKind
from ..models.patch_accounts_account_id_account_solution import PatchAccountsAccountIDAccountSolution
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.patch_accounts_account_id_account_address import PatchAccountsAccountIDAccountAddress


T = TypeVar("T", bound="PatchAccountsAccountIDAccount")


@_attrs_define
class PatchAccountsAccountIDAccount:
    ...
    Attributes:
        ...
        solution (PatchAccountsAccountIDAccountSolution | Unset): Represents the supported solutions within the account:
        ...
        kind (PatchAccountsAccountIDAccountKind | Unset): If b2b, the account is a regular account. If end-user, the
            account is a customer account which contains just one user.
        main_address (PatchAccountsAccountIDAccountAddress | Unset): Represents a physical address of a customer.
    ...
    solution: PatchAccountsAccountIDAccountSolution | Unset = UNSET
    parent_id: UUID | Unset = UNSET
    systems_count: int | Unset = UNSET
    kind: PatchAccountsAccountIDAccountKind | Unset = UNSET
    main_address: PatchAccountsAccountIDAccountAddress | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        solution: PatchAccountsAccountIDAccountSolution | Unset
        if isinstance(_solution, Unset):
            solution = UNSET
        else:
            solution = PatchAccountsAccountIDAccountSolution(_solution)
        ...
        kind: PatchAccountsAccountIDAccountKind | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = PatchAccountsAccountIDAccountKind(_kind)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: PatchAccountsAccountIDAccountAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = PatchAccountsAccountIDAccountAddress.from_dict(_main_address)

        customization = d.pop("customization", UNSET)

        patch_accounts_account_id_account = cls(
            id=id,
        ...
        patch_accounts_account_id_account.additional_properties = d
        return patch_accounts_account_id_account
