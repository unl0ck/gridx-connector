...
T = TypeVar("T", bound="PatchAccountTokensTokenIDOrganizationalAPITokenUserAddress")


@_attrs_define
class PatchAccountTokensTokenIDOrganizationalAPITokenUserAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_account_tokens_token_id_organizational_api_token_user_address = cls(
            city=city,
            country=country,
        ...
        patch_account_tokens_token_id_organizational_api_token_user_address.additional_properties = d
        return patch_account_tokens_token_id_organizational_api_token_user_address
