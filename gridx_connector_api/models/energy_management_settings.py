...
T = TypeVar("T", bound="EnergyManagementSettings")


@_attrs_define
class EnergyManagementSettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        energy_management_settings = cls(
        ...
        energy_management_settings.additional_properties = d
