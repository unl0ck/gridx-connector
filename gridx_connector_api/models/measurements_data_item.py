...
if TYPE_CHECKING:
    from ..models.measurements_data_item_additional_meter_appliances import (
        MeasurementsDataItemAdditionalMeterAppliances,
    )
    from ..models.measurements_data_item_battery_measurement import MeasurementsDataItemBatteryMeasurement
    from ..models.measurements_data_item_extended_battery_measurement import (
        MeasurementsDataItemExtendedBatteryMeasurement,
    )
    from ..models.measurements_data_item_extended_ev_station_measurement import (
        MeasurementsDataItemExtendedEVStationMeasurement,
    )
    from ..models.measurements_data_item_heater_measurement import MeasurementsDataItemHeaterMeasurement
    from ..models.measurements_data_item_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station import (
        MeasurementsDataItemMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation,
    )
    from ..models.measurements_data_item_measurement_grid import MeasurementsDataItemMeasurementGrid


T = TypeVar("T", bound="MeasurementsDataItem")


@_attrs_define
class MeasurementsDataItem:
    """
    Attributes:
        ...
        batteries (list[MeasurementsDataItemBatteryMeasurement] | Unset):
        ...
        ev_charging_stations (list[MeasurementsDataItemMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredf
            romAEvChargingStation] | Unset):
        ...
        heaters (list[MeasurementsDataItemHeaterMeasurement] | Unset): Heating measurement for all heaters that are part
            of the system.
        appliance_power (float | Unset): AppliancePower is power of the appliances with misc location.
        appliances (list[MeasurementsDataItemAdditionalMeterAppliances] | Unset):
        ...
        fuse_protection_count (int | Unset): Number of times the fuse was protected, based on the curtailed power over
            all phases.
        grid (MeasurementsDataItemMeasurementGrid | Unset):
        battery (MeasurementsDataItemExtendedBatteryMeasurement | Unset):
        ev_charging_station (MeasurementsDataItemExtendedEVStationMeasurement | Unset):
    """
    ...
    batteries: list[MeasurementsDataItemBatteryMeasurement] | Unset = UNSET
    heat_pump: float | Unset = UNSET
    heat_pump_external: float | Unset = UNSET
    ev_charging_stations: (
        list[MeasurementsDataItemMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation]
        | Unset
    ) = UNSET
    ...
    heaters: list[MeasurementsDataItemHeaterMeasurement] | Unset = UNSET
    appliance_power: float | Unset = UNSET
    appliances: list[MeasurementsDataItemAdditionalMeterAppliances] | Unset = UNSET
    ...
    grid: MeasurementsDataItemMeasurementGrid | Unset = UNSET
    battery: MeasurementsDataItemExtendedBatteryMeasurement | Unset = UNSET
    ev_charging_station: MeasurementsDataItemExtendedEVStationMeasurement | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _batteries is not UNSET:
            ...
            for batteries_item_data in _batteries:
                batteries_item = MeasurementsDataItemBatteryMeasurement.from_dict(batteries_item_data)
        ...
        if _ev_charging_stations is not UNSET:
            ...
            for ev_charging_stations_item_data in _ev_charging_stations:
                ev_charging_stations_item = MeasurementsDataItemMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation.from_dict(
        ...
        if _heaters is not UNSET:
            ...
            for heaters_item_data in _heaters:
                heaters_item = MeasurementsDataItemHeaterMeasurement.from_dict(heaters_item_data)
        ...
        if _appliances is not UNSET:
            ...
            for appliances_item_data in _appliances:
                appliances_item = MeasurementsDataItemAdditionalMeterAppliances.from_dict(appliances_item_data)
        ...
        if isinstance(_grid, Unset):
            ...
            grid = MeasurementsDataItemMeasurementGrid.from_dict(_grid)
        ...
        if isinstance(_battery, Unset):
            ...
            battery = MeasurementsDataItemExtendedBatteryMeasurement.from_dict(_battery)
        ...
        if isinstance(_ev_charging_station, Unset):
            ...
            ev_charging_station = MeasurementsDataItemExtendedEVStationMeasurement.from_dict(_ev_charging_station)

        measurements_data_item = cls(
        ...
        measurements_data_item.additional_properties = d
        return measurements_data_item
