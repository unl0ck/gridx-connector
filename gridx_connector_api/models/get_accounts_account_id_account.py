...
from ..models.get_accounts_account_id_account_kind import GetAccountsAccountIDAccountKind
from ..models.get_accounts_account_id_account_solution import GetAccountsAccountIDAccountSolution
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_accounts_account_id_account_address import GetAccountsAccountIDAccountAddress


T = TypeVar("T", bound="GetAccountsAccountIDAccount")


@_attrs_define
class GetAccountsAccountIDAccount:
    ...
    Attributes:
        ...
        solution (GetAccountsAccountIDAccountSolution | Unset): Represents the supported solutions within the account:
        ...
        kind (GetAccountsAccountIDAccountKind | Unset): If b2b, the account is a regular account. If end-user, the
            account is a customer account which contains just one user.
        main_address (GetAccountsAccountIDAccountAddress | Unset): Represents a physical address of a customer.
    ...
    solution: GetAccountsAccountIDAccountSolution | Unset = UNSET
    parent_id: UUID | Unset = UNSET
    systems_count: int | Unset = UNSET
    kind: GetAccountsAccountIDAccountKind | Unset = UNSET
    main_address: GetAccountsAccountIDAccountAddress | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        solution: GetAccountsAccountIDAccountSolution | Unset
        if isinstance(_solution, Unset):
            solution = UNSET
        else:
            solution = GetAccountsAccountIDAccountSolution(_solution)
        ...
        kind: GetAccountsAccountIDAccountKind | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = GetAccountsAccountIDAccountKind(_kind)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: GetAccountsAccountIDAccountAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = GetAccountsAccountIDAccountAddress.from_dict(_main_address)

        customization = d.pop("customization", UNSET)

        get_accounts_account_id_account = cls(
            id=id,
        ...
        get_accounts_account_id_account.additional_properties = d
        return get_accounts_account_id_account
