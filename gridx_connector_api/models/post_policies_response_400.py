...
T = TypeVar("T", bound="PostPoliciesResponse400")


@_attrs_define
class PostPoliciesResponse400:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_policies_response_400 = cls(
            message=message,
            details=details,
        )

        post_policies_response_400.additional_properties = d
        return post_policies_response_400
