...
T = TypeVar("T", bound="GetSystemsResponse500")


@_attrs_define
class GetSystemsResponse500:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_response_500 = cls(
            message=message,
            details=details,
        )

        get_systems_response_500.additional_properties = d
        return get_systems_response_500
