...
T = TypeVar("T", bound="GetSystemsSystemIDHistoricalMeasurementsDataItemHeaterMeasurement")


@_attrs_define
class GetSystemsSystemIDHistoricalMeasurementsDataItemHeaterMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_system_id_historical_measurements_data_item_heater_measurement = cls(
        ...
        get_systems_system_id_historical_measurements_data_item_heater_measurement.additional_properties = d
        return get_systems_system_id_historical_measurements_data_item_heater_measurement
