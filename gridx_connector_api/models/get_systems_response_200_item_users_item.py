...
if TYPE_CHECKING:
    from ..models.get_systems_response_200_item_users_item_address import GetSystemsResponse200ItemUsersItemAddress
    from ..models.get_systems_response_200_item_users_item_language import GetSystemsResponse200ItemUsersItemLanguage
    from ..models.get_systems_response_200_item_users_item_policy_group import (
        GetSystemsResponse200ItemUsersItemPolicyGroup,
    )


T = TypeVar("T", bound="GetSystemsResponse200ItemUsersItem")


@_attrs_define
class GetSystemsResponse200ItemUsersItem:
    """
    Attributes:
        ...
        full_name (str | Unset): Full name of the user typically consisting of first name and last name. Example: John
            Doe.
        groups (list[GetSystemsResponse200ItemUsersItemPolicyGroup] | Unset): Policy groups attached to this user which
            determine the effective permissions through policies.
        main_address (GetSystemsResponse200ItemUsersItemAddress | Unset): Represents a physical address of a customer.
        language (GetSystemsResponse200ItemUsersItemLanguage | Unset): The language information of the user.
    """
    ...
    groups: list[GetSystemsResponse200ItemUsersItemPolicyGroup] | Unset = UNSET
    main_address: GetSystemsResponse200ItemUsersItemAddress | Unset = UNSET
    language: GetSystemsResponse200ItemUsersItemLanguage | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_systems_response_200_item_users_item_address import GetSystemsResponse200ItemUsersItemAddress
        from ..models.get_systems_response_200_item_users_item_language import (
        ...
        if _groups is not UNSET:
            ...
            for groups_item_data in _groups:
                groups_item = GetSystemsResponse200ItemUsersItemPolicyGroup.from_dict(groups_item_data)

                groups.append(groups_item)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: GetSystemsResponse200ItemUsersItemAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = GetSystemsResponse200ItemUsersItemAddress.from_dict(_main_address)

        _language = d.pop("language", UNSET)
        language: GetSystemsResponse200ItemUsersItemLanguage | Unset
        if isinstance(_language, Unset):
            language = UNSET
        else:
            language = GetSystemsResponse200ItemUsersItemLanguage.from_dict(_language)

        get_systems_response_200_item_users_item = cls(
            id=id,
        ...
        get_systems_response_200_item_users_item.additional_properties = d
        return get_systems_response_200_item_users_item
