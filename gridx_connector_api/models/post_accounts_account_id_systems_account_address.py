...
T = TypeVar("T", bound="PostAccountsAccountIDSystemsAccountAddress")


@_attrs_define
class PostAccountsAccountIDSystemsAccountAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_accounts_account_id_systems_account_address = cls(
            city=city,
            country=country,
        ...
        post_accounts_account_id_systems_account_address.additional_properties = d
        return post_accounts_account_id_systems_account_address
