...
T = TypeVar("T", bound="GetAccountTokensTokenIDOrganizationalAPITokenUserAddress")


@_attrs_define
class GetAccountTokensTokenIDOrganizationalAPITokenUserAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_account_tokens_token_id_organizational_api_token_user_address = cls(
            city=city,
            country=country,
        ...
        get_account_tokens_token_id_organizational_api_token_user_address.additional_properties = d
        return get_account_tokens_token_id_organizational_api_token_user_address
