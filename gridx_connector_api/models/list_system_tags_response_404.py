...
T = TypeVar("T", bound="ListSystemTagsResponse404")


@_attrs_define
class ListSystemTagsResponse404:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_system_tags_response_404 = cls(
            message=message,
            details=details,
        )

        list_system_tags_response_404.additional_properties = d
        return list_system_tags_response_404
