...
T = TypeVar("T", bound="PatchUserResponse200Address")


@_attrs_define
class PatchUserResponse200Address:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_user_response_200_address = cls(
            city=city,
            country=country,
        ...
        patch_user_response_200_address.additional_properties = d
        return patch_user_response_200_address
