...
from ..models.patch_spine_devices_device_id_powersequences_sequence_id_response_201_state import (
    PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201State,
)
from ..models.patch_spine_devices_device_id_powersequences_sequence_id_response_201_value_source import (
    PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201ValueSource,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.patch_spine_devices_device_id_powersequences_sequence_id_response_201_power_time_slots_item import (
        PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201PowerTimeSlotsItem,
    )


T = TypeVar("T", bound="PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201")


@_attrs_define
class PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201:
    """
    Attributes:
        ...
        power_time_slots (list[PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201PowerTimeSlotsItem]): List of
            power time slots for a power sequence. See EEBUS FSWG-060.
        sequence_id (int | Unset): Identifier of power sequence, must be unique in path. Example: 1.
        state (PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201State | Unset): EEBUS FSWG-025. See section
            3.2.1.2.2.1.1.4 Example: scheduled.
        ...
        is_stoppable (bool | Unset): If the sequence can be stopped by the CEM, this element SHALL be present and set to
            ...
            For more details, see EEBUS FSWG-027.
             Default: False.
        value_source (PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201ValueSource | Unset): If not set, the
            source of forecasted values is undefined.
        task_identifier (int | Unset): Identifier of the task.
    """

    earliest_start_time: datetime.datetime
    latest_end_time: datetime.datetime
    power_time_slots: list[PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201PowerTimeSlotsItem]
    sequence_id: int | Unset = UNSET
    state: PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201State | Unset = UNSET
    ...
    value_source: PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201ValueSource | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for power_time_slots_item_data in _power_time_slots:
            power_time_slots_item = (
                PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201PowerTimeSlotsItem.from_dict(
                    power_time_slots_item_data
                )
            )
        ...
        state: PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201State | Unset
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201State(_state)
        ...
        value_source: PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201ValueSource | Unset
        if isinstance(_value_source, Unset):
            value_source = UNSET
        else:
            value_source = PatchSpineDevicesDeviceIDPowersequencesSequenceIDResponse201ValueSource(_value_source)

        task_identifier = d.pop("taskIdentifier", UNSET)

        patch_spine_devices_device_id_powersequences_sequence_id_response_201 = cls(
        ...
        patch_spine_devices_device_id_powersequences_sequence_id_response_201.additional_properties = d
        return patch_spine_devices_device_id_powersequences_sequence_id_response_201
