...
from ..models.heat_pump_information_type import HeatPumpInformationType
from ..types import UNSET, Unset

T = TypeVar("T", bound="HeatPumpInformation")


@_attrs_define
class HeatPumpInformation:
    """The heat pump specific information.

    Attributes:
        type_ (HeatPumpInformationType | Unset): Describes the specific type of the heat pump.
    ...
    type_: HeatPumpInformationType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: HeatPumpInformationType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = HeatPumpInformationType(_type_)
        ...
        heat_pump_information.additional_properties = d
        return heat_pump_information
