...
T = TypeVar("T", bound="GetSystemsSystemIDHistoricalMeasurementsTotalExtendedEVStationMeasurement")


@_attrs_define
class GetSystemsSystemIDHistoricalMeasurementsTotalExtendedEVStationMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_system_id_historical_measurements_total_extended_ev_station_measurement = cls(
            charge=charge,
            discharge=discharge,
        ...
        get_systems_system_id_historical_measurements_total_extended_ev_station_measurement.additional_properties = d
        return get_systems_system_id_historical_measurements_total_extended_ev_station_measurement
