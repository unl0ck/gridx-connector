...
T = TypeVar("T", bound="PostAccountsAccountIDSystemsBody")


@_attrs_define
class PostAccountsAccountIDSystemsBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_accounts_account_id_systems_body = cls(
            uuids=uuids,
            move_systems_and_customers=move_systems_and_customers,
            move_vendor_id=move_vendor_id,
        )

        post_accounts_account_id_systems_body.additional_properties = d
        return post_accounts_account_id_systems_body
