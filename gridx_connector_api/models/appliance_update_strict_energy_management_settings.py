...
T = TypeVar("T", bound="ApplianceUpdateStrictEnergyManagementSettings")


@_attrs_define
class ApplianceUpdateStrictEnergyManagementSettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appliance_update_strict_energy_management_settings = cls(
        ...
        appliance_update_strict_energy_management_settings.additional_properties = d
        return appliance_update_strict_energy_management_settings
