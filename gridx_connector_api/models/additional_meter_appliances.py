...
T = TypeVar("T", bound="AdditionalMeterAppliances")


@_attrs_define
class AdditionalMeterAppliances:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        additional_meter_appliances = cls(
            appliance_id=appliance_id,
            power=power,
            kind=kind,
        )

        additional_meter_appliances.additional_properties = d
        return additional_meter_appliances
