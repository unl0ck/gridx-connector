...
T = TypeVar("T", bound="GetSystemsSystemIDEvProfilesEvProfileIDResponse200")


@_attrs_define
class GetSystemsSystemIDEvProfilesEvProfileIDResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_system_id_ev_profiles_ev_profile_id_response_200 = cls(
            id=id,
            system_id=system_id,
        ...
        get_systems_system_id_ev_profiles_ev_profile_id_response_200.additional_properties = d
        return get_systems_system_id_ev_profiles_ev_profile_id_response_200
