...
from ..models.abstract_cluster_strict_priorities_item import AbstractClusterStrictPrioritiesItem
from ..models.abstract_cluster_strict_strategy import AbstractClusterStrictStrategy
from ..types import UNSET, Unset

T = TypeVar("T", bound="AbstractClusterStrict")


@_attrs_define
class AbstractClusterStrict:
    """
    Attributes:
        ...
        strategy (AbstractClusterStrictStrategy | Unset): Identifies the specific curtailment approach within the
            cluster.
        priorities (list[AbstractClusterStrictPrioritiesItem] | Unset): Defines the priority for the EMS.
    ...
    strategy: AbstractClusterStrictStrategy | Unset = UNSET
    priorities: list[AbstractClusterStrictPrioritiesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        strategy: AbstractClusterStrictStrategy | Unset
        if isinstance(_strategy, Unset):
            strategy = UNSET
        else:
            strategy = AbstractClusterStrictStrategy(_strategy)
        ...
        if _priorities is not UNSET:
            ...
            for priorities_item_data in _priorities:
                priorities_item = AbstractClusterStrictPrioritiesItem(priorities_item_data)
        ...
        abstract_cluster_strict.additional_properties = d
        return abstract_cluster_strict
