...
T = TypeVar("T", bound="MeasurementsTotalAdditionalMeterAppliances")


@_attrs_define
class MeasurementsTotalAdditionalMeterAppliances:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        measurements_total_additional_meter_appliances = cls(
            appliance_id=appliance_id,
            power=power,
            kind=kind,
        )

        measurements_total_additional_meter_appliances.additional_properties = d
        return measurements_total_additional_meter_appliances
