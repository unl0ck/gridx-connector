...
T = TypeVar("T", bound="SystemAMSLocation")


@_attrs_define
class SystemAMSLocation:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        system_ams_location.additional_properties = d
        return system_ams_location
