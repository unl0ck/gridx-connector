...
T = TypeVar("T", bound="GetGatewaysResponse500")


@_attrs_define
class GetGatewaysResponse500:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_gateways_response_500 = cls(
            message=message,
            details=details,
        )

        get_gateways_response_500.additional_properties = d
        return get_gateways_response_500
