...
T = TypeVar("T", bound="DeleteSystemTagResponse500")


@_attrs_define
class DeleteSystemTagResponse500:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_system_tag_response_500 = cls(
            message=message,
            details=details,
        )

        delete_system_tag_response_500.additional_properties = d
        return delete_system_tag_response_500
