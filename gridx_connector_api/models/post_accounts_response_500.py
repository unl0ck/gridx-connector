...
T = TypeVar("T", bound="PostAccountsResponse500")


@_attrs_define
class PostAccountsResponse500:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_accounts_response_500 = cls(
            message=message,
            details=details,
        )

        post_accounts_response_500.additional_properties = d
        return post_accounts_response_500
