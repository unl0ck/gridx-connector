...
T = TypeVar("T", bound="PatchUserResponse200Language")


@_attrs_define
class PatchUserResponse200Language:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_user_response_200_language = cls(
            tag=tag,
            name=name,
            name_native=name_native,
        )

        patch_user_response_200_language.additional_properties = d
        return patch_user_response_200_language
