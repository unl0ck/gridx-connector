...
T = TypeVar("T", bound="DeleteSystemTagResponse403")


@_attrs_define
class DeleteSystemTagResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_system_tag_response_403 = cls(
            message=message,
            details=details,
        )

        delete_system_tag_response_403.additional_properties = d
        return delete_system_tag_response_403
