...
T = TypeVar("T", bound="EVChargingStationNetwork")


@_attrs_define
class EVChargingStationNetwork:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ev_charging_station_network = cls(
            interface=interface,
            address=address,
            port=port,
            protocol=protocol,
        ...
        ev_charging_station_network.additional_properties = d
        return ev_charging_station_network
