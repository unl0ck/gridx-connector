...
T = TypeVar("T", bound="GetUserStarsSystemsResponse200Item")


@_attrs_define
class GetUserStarsSystemsResponse200Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_stars_systems_response_200_item = cls(
            starred_at=starred_at,
        )

        get_user_stars_systems_response_200_item.additional_properties = d
        return get_user_stars_systems_response_200_item
