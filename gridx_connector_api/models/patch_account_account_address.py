...
T = TypeVar("T", bound="PatchAccountAccountAddress")


@_attrs_define
class PatchAccountAccountAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_account_account_address = cls(
            city=city,
            country=country,
        ...
        patch_account_account_address.additional_properties = d
        return patch_account_account_address
