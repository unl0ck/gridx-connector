...
T = TypeVar("T", bound="OrganizationalAPITokenUserLanguage")


@_attrs_define
class OrganizationalAPITokenUserLanguage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organizational_api_token_user_language = cls(
            tag=tag,
            name=name,
            name_native=name_native,
        )

        organizational_api_token_user_language.additional_properties = d
        return organizational_api_token_user_language
