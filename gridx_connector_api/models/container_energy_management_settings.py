...
T = TypeVar("T", bound="ContainerEnergyManagementSettings")


@_attrs_define
class ContainerEnergyManagementSettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        container_energy_management_settings = cls(
        ...
        container_energy_management_settings.additional_properties = d
        return container_energy_management_settings
