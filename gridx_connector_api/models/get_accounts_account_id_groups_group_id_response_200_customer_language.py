...
T = TypeVar("T", bound="GetAccountsAccountIDGroupsGroupIDResponse200CustomerLanguage")


@_attrs_define
class GetAccountsAccountIDGroupsGroupIDResponse200CustomerLanguage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_accounts_account_id_groups_group_id_response_200_customer_language = cls(
            tag=tag,
            name=name,
            name_native=name_native,
        )

        get_accounts_account_id_groups_group_id_response_200_customer_language.additional_properties = d
        return get_accounts_account_id_groups_group_id_response_200_customer_language
