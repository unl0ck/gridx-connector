...
if TYPE_CHECKING:
    from ..models.get_accounts_account_id_groups_group_id_response_200_customer_address import (
        GetAccountsAccountIDGroupsGroupIDResponse200CustomerAddress,
    )
    from ..models.get_accounts_account_id_groups_group_id_response_200_customer_language import (
        GetAccountsAccountIDGroupsGroupIDResponse200CustomerLanguage,
    )
    from ..models.get_accounts_account_id_groups_group_id_response_200_customer_policy_group import (
        GetAccountsAccountIDGroupsGroupIDResponse200CustomerPolicyGroup,
    )


T = TypeVar("T", bound="GetAccountsAccountIDGroupsGroupIDResponse200Customer")


@_attrs_define
class GetAccountsAccountIDGroupsGroupIDResponse200Customer:
    ...
    Attributes:
        ...
        full_name (str | Unset): Full name of the user typically consisting of first name and last name. Example: John
            Doe.
        groups (list[GetAccountsAccountIDGroupsGroupIDResponse200CustomerPolicyGroup] | Unset): Policy groups attached
            to this user which determine the effective permissions through policies.
        main_address (GetAccountsAccountIDGroupsGroupIDResponse200CustomerAddress | Unset): Represents a physical
            address of a customer.
        language (GetAccountsAccountIDGroupsGroupIDResponse200CustomerLanguage | Unset): The language information of the
            user.
    """
    ...
    groups: list[GetAccountsAccountIDGroupsGroupIDResponse200CustomerPolicyGroup] | Unset = UNSET
    main_address: GetAccountsAccountIDGroupsGroupIDResponse200CustomerAddress | Unset = UNSET
    language: GetAccountsAccountIDGroupsGroupIDResponse200CustomerLanguage | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _groups is not UNSET:
            ...
            for groups_item_data in _groups:
                groups_item = GetAccountsAccountIDGroupsGroupIDResponse200CustomerPolicyGroup.from_dict(
                    groups_item_data
                )
        ...
        main_address: GetAccountsAccountIDGroupsGroupIDResponse200CustomerAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = GetAccountsAccountIDGroupsGroupIDResponse200CustomerAddress.from_dict(_main_address)

        _language = d.pop("language", UNSET)
        language: GetAccountsAccountIDGroupsGroupIDResponse200CustomerLanguage | Unset
        if isinstance(_language, Unset):
            language = UNSET
        else:
            language = GetAccountsAccountIDGroupsGroupIDResponse200CustomerLanguage.from_dict(_language)

        get_accounts_account_id_groups_group_id_response_200_customer = cls(
            id=id,
        ...
        get_accounts_account_id_groups_group_id_response_200_customer.additional_properties = d
        return get_accounts_account_id_groups_group_id_response_200_customer
