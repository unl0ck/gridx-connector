...
T = TypeVar("T", bound="AbstractPowerSequencePowerTimeSlotsItem")


@_attrs_define
class AbstractPowerSequencePowerTimeSlotsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        abstract_power_sequence_power_time_slots_item = cls(
            slot_id=slot_id,
        ...
        abstract_power_sequence_power_time_slots_item.additional_properties = d
        return abstract_power_sequence_power_time_slots_item
