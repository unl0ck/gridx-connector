...
from ..models.put_systems_system_id_gateways_gateway_id_import_power_limit_body_number_of_phases import (
    PutSystemsSystemIDGatewaysGatewayIDImportPowerLimitBodyNumberOfPhases,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutSystemsSystemIDGatewaysGatewayIDImportPowerLimitBody")


@_attrs_define
class PutSystemsSystemIDGatewaysGatewayIDImportPowerLimitBody:
    """
    Attributes:
        number_of_phases (PutSystemsSystemIDGatewaysGatewayIDImportPowerLimitBodyNumberOfPhases | Unset): Number of
            phases the import power limit is set for. 1 or 3. Default is 3. Default:
            PutSystemsSystemIDGatewaysGatewayIDImportPowerLimitBodyNumberOfPhases.VALUE_3. Example: 3.
    ...
    number_of_phases: PutSystemsSystemIDGatewaysGatewayIDImportPowerLimitBodyNumberOfPhases | Unset = (
        PutSystemsSystemIDGatewaysGatewayIDImportPowerLimitBodyNumberOfPhases.VALUE_3
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_number_of_phases, Unset):
            ...
            number_of_phases = PutSystemsSystemIDGatewaysGatewayIDImportPowerLimitBodyNumberOfPhases(_number_of_phases)
        ...
        put_systems_system_id_gateways_gateway_id_import_power_limit_body = cls(
        ...
        put_systems_system_id_gateways_gateway_id_import_power_limit_body.additional_properties = d
        return put_systems_system_id_gateways_gateway_id_import_power_limit_body
