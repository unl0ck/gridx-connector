...
T = TypeVar("T", bound="MeasurementsTotalBatteryMeasurement")


@_attrs_define
class MeasurementsTotalBatteryMeasurement:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        measurements_total_battery_measurement = cls(
        ...
        measurements_total_battery_measurement.additional_properties = d
        return measurements_total_battery_measurement
