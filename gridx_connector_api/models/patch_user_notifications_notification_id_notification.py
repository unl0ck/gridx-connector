...
T = TypeVar("T", bound="PatchUserNotificationsNotificationIDNotification")


@_attrs_define
class PatchUserNotificationsNotificationIDNotification:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_user_notifications_notification_id_notification = cls(
        ...
        patch_user_notifications_notification_id_notification.additional_properties = d
        return patch_user_notifications_notification_id_notification
