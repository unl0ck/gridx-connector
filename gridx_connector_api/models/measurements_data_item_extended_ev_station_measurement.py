...
T = TypeVar("T", bound="MeasurementsDataItemExtendedEVStationMeasurement")


@_attrs_define
class MeasurementsDataItemExtendedEVStationMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        measurements_data_item_extended_ev_station_measurement = cls(
            charge=charge,
            discharge=discharge,
        ...
        measurements_data_item_extended_ev_station_measurement.additional_properties = d
        return measurements_data_item_extended_ev_station_measurement
