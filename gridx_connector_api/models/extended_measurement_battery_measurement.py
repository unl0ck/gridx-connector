...
T = TypeVar("T", bound="ExtendedMeasurementBatteryMeasurement")


@_attrs_define
class ExtendedMeasurementBatteryMeasurement:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        extended_measurement_battery_measurement = cls(
        ...
        extended_measurement_battery_measurement.additional_properties = d
        return extended_measurement_battery_measurement
