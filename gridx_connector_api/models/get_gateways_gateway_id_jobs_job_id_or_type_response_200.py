...
from ..models.get_gateways_gateway_id_jobs_job_id_or_type_response_200_state import (
    GetGatewaysGatewayIDJobsJobIDOrTypeResponse200State,
)
from ..models.get_gateways_gateway_id_jobs_job_id_or_type_response_200_type import (
    GetGatewaysGatewayIDJobsJobIDOrTypeResponse200Type,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_gateways_gateway_id_jobs_job_id_or_type_response_200_job_execution import (
        GetGatewaysGatewayIDJobsJobIDOrTypeResponse200JobExecution,
    )


T = TypeVar("T", bound="GetGatewaysGatewayIDJobsJobIDOrTypeResponse200")


@_attrs_define
class GetGatewaysGatewayIDJobsJobIDOrTypeResponse200:
    """
    Attributes:
        type_ (GetGatewaysGatewayIDJobsJobIDOrTypeResponse200Type): Represents the kind of the job. A job can be of
            type:
            - `UNKNOWN_TYPE`
            ...
            - `RESTART`: Indicates that the application should restart.
             Example: RESET.
        state (GetGatewaysGatewayIDJobsJobIDOrTypeResponse200State): Represents the current state of the job. It can be
            one of:
            * `UNKNOWN_STATE`
        ...
        executions (list[GetGatewaysGatewayIDJobsJobIDOrTypeResponse200JobExecution]): Represents a set of job
            executions.
    ...
    type_: GetGatewaysGatewayIDJobsJobIDOrTypeResponse200Type
    state: GetGatewaysGatewayIDJobsJobIDOrTypeResponse200State
    id: UUID
    executions: list[GetGatewaysGatewayIDJobsJobIDOrTypeResponse200JobExecution]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = GetGatewaysGatewayIDJobsJobIDOrTypeResponse200Type(d.pop("type"))

        state = GetGatewaysGatewayIDJobsJobIDOrTypeResponse200State(d.pop("state"))
        ...
        for executions_item_data in _executions:
            executions_item = GetGatewaysGatewayIDJobsJobIDOrTypeResponse200JobExecution.from_dict(executions_item_data)
        ...
        get_gateways_gateway_id_jobs_job_id_or_type_response_200 = cls(
            type_=type_,
            state=state,
            id=id,
            executions=executions,
        ...
        get_gateways_gateway_id_jobs_job_id_or_type_response_200.additional_properties = d
        return get_gateways_gateway_id_jobs_job_id_or_type_response_200
