...
T = TypeVar("T", bound="BaseApplianceNetwork")


@_attrs_define
class BaseApplianceNetwork:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        base_appliance_network.additional_properties = d
        return base_appliance_network
