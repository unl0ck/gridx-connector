...
T = TypeVar(
    "T", bound="GetGatewaysGatewayIDAppliancesApplianceIDMeasurementsEnergymanagementEnergyManagementMeasurement"
)


@_attrs_define
class GetGatewaysGatewayIDAppliancesApplianceIDMeasurementsEnergymanagementEnergyManagementMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_gateways_gateway_id_appliances_appliance_id_measurements_energymanagement_energy_management_measurement = (
            cls(
        ...
        get_gateways_gateway_id_appliances_appliance_id_measurements_energymanagement_energy_management_measurement.additional_properties = d
        return (
            get_gateways_gateway_id_appliances_appliance_id_measurements_energymanagement_energy_management_measurement
        )
