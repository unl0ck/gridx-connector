...
from ..models.decisions_decisions_item_insight_motives_item import DecisionsDecisionsItemInsightMotivesItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="DecisionsDecisionsItemInsight")


@_attrs_define
class DecisionsDecisionsItemInsight:
    """
    Attributes:
        motives (list[DecisionsDecisionsItemInsightMotivesItem] | Unset): Identifies the motivation behind a ToU
            decision. The following insights are implemented:
    ...
    motives: list[DecisionsDecisionsItemInsightMotivesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _motives is not UNSET:
            ...
            for motives_item_data in _motives:
                motives_item = DecisionsDecisionsItemInsightMotivesItem(motives_item_data)
        ...
        decisions_decisions_item_insight = cls(
            motives=motives,
        ...
        decisions_decisions_item_insight.additional_properties = d
        return decisions_decisions_item_insight
