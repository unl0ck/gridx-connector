...
T = TypeVar("T", bound="PostSystemsSystemIDTariffPricesResponse201EndPriceTariffV2Period")


@_attrs_define
class PostSystemsSystemIDTariffPricesResponse201EndPriceTariffV2Period:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_systems_system_id_tariff_prices_response_201_end_price_tariff_v2_period = cls(
            from_=from_,
            to=to,
        ...
        post_systems_system_id_tariff_prices_response_201_end_price_tariff_v2_period.additional_properties = d
        return post_systems_system_id_tariff_prices_response_201_end_price_tariff_v2_period
