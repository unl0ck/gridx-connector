...
T = TypeVar("T", bound="PatchSystemsSystemIDEvProfilesEvProfileIDBody")


@_attrs_define
class PatchSystemsSystemIDEvProfilesEvProfileIDBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_systems_system_id_ev_profiles_ev_profile_id_body = cls(
            name=name,
        ...
        patch_systems_system_id_ev_profiles_ev_profile_id_body.additional_properties = d
        return patch_systems_system_id_ev_profiles_ev_profile_id_body
