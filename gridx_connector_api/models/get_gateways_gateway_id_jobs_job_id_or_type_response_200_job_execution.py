...
T = TypeVar("T", bound="GetGatewaysGatewayIDJobsJobIDOrTypeResponse200JobExecution")


@_attrs_define
class GetGatewaysGatewayIDJobsJobIDOrTypeResponse200JobExecution:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_gateways_gateway_id_jobs_job_id_or_type_response_200_job_execution = cls(
            id=id,
            job_id=job_id,
            succeeded=succeeded,
            error=error,
        ...
        get_gateways_gateway_id_jobs_job_id_or_type_response_200_job_execution.additional_properties = d
        return get_gateways_gateway_id_jobs_job_id_or_type_response_200_job_execution
