...
T = TypeVar("T", bound="MeterEnergyManagementSettings")


@_attrs_define
class MeterEnergyManagementSettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meter_energy_management_settings = cls(
        ...
        meter_energy_management_settings.additional_properties = d
        return meter_energy_management_settings
