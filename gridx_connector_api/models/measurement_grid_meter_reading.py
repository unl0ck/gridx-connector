...
T = TypeVar("T", bound="MeasurementGridMeterReading")


@_attrs_define
class MeasurementGridMeterReading:
    """
    Attributes:
        feed_in (float | Unset):
        supply (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        measurement_grid_meter_reading = cls(
            feed_in=feed_in,
            supply=supply,
        )

        measurement_grid_meter_reading.additional_properties = d
        return measurement_grid_meter_reading
