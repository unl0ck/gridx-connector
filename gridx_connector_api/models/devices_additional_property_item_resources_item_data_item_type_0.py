...
from ..models.devices_additional_property_item_resources_item_data_item_type_0_state import (
    DevicesAdditionalPropertyItemResourcesItemDataItemType0State,
)
from ..models.devices_additional_property_item_resources_item_data_item_type_0_value_source import (
    DevicesAdditionalPropertyItemResourcesItemDataItemType0ValueSource,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.devices_additional_property_item_resources_item_data_item_type_0_power_time_slots_item import (
        DevicesAdditionalPropertyItemResourcesItemDataItemType0PowerTimeSlotsItem,
    )


T = TypeVar("T", bound="DevicesAdditionalPropertyItemResourcesItemDataItemType0")


@_attrs_define
class DevicesAdditionalPropertyItemResourcesItemDataItemType0:
    """
    Attributes:
        ...
        power_time_slots (list[DevicesAdditionalPropertyItemResourcesItemDataItemType0PowerTimeSlotsItem]): List of
        ...
        state (DevicesAdditionalPropertyItemResourcesItemDataItemType0State | Unset): EEBUS FSWG-025. See section
        ...
        is_stoppable (bool | Unset): If the sequence can be stopped by the CEM, this element SHALL be present and set to
            ...
            For more details, see EEBUS FSWG-027.
             Default: False.
        value_source (DevicesAdditionalPropertyItemResourcesItemDataItemType0ValueSource | Unset): If not set, the
    ...
    power_time_slots: list[DevicesAdditionalPropertyItemResourcesItemDataItemType0PowerTimeSlotsItem]
    sequence_id: int | Unset = UNSET
    state: DevicesAdditionalPropertyItemResourcesItemDataItemType0State | Unset = UNSET
    ...
    value_source: DevicesAdditionalPropertyItemResourcesItemDataItemType0ValueSource | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for power_time_slots_item_data in _power_time_slots:
            power_time_slots_item = DevicesAdditionalPropertyItemResourcesItemDataItemType0PowerTimeSlotsItem.from_dict(
        ...
        state: DevicesAdditionalPropertyItemResourcesItemDataItemType0State | Unset
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = DevicesAdditionalPropertyItemResourcesItemDataItemType0State(_state)
        ...
        value_source: DevicesAdditionalPropertyItemResourcesItemDataItemType0ValueSource | Unset
        if isinstance(_value_source, Unset):
            value_source = UNSET
        else:
            value_source = DevicesAdditionalPropertyItemResourcesItemDataItemType0ValueSource(_value_source)

        task_identifier = d.pop("taskIdentifier", UNSET)

        devices_additional_property_item_resources_item_data_item_type_0 = cls(
        ...
        devices_additional_property_item_resources_item_data_item_type_0.additional_properties = d
        return devices_additional_property_item_resources_item_data_item_type_0
