...
if TYPE_CHECKING:
    from ..models.grid_connection_point_forecasts_periods_item import GridConnectionPointForecastsPeriodsItem


T = TypeVar("T", bound="GridConnectionPointForecasts")


@_attrs_define
class GridConnectionPointForecasts:
    """
    Attributes:
        ...
        periods (list[GridConnectionPointForecastsPeriodsItem] | Unset):
    ...
    periods: list[GridConnectionPointForecastsPeriodsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _periods is not UNSET:
            ...
            for periods_item_data in _periods:
                periods_item = GridConnectionPointForecastsPeriodsItem.from_dict(periods_item_data)
        ...
        grid_connection_point_forecasts = cls(
            from_=from_,
            to=to,
            periods=periods,
        ...
        grid_connection_point_forecasts.additional_properties = d
        return grid_connection_point_forecasts
