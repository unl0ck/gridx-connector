...
T = TypeVar("T", bound="InvertersMeasurementsAMeasurementProducedByABatteryInverter")


@_attrs_define
class InvertersMeasurementsAMeasurementProducedByABatteryInverter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inverters_measurements_a_measurement_produced_by_a_battery_inverter = cls(
            present_charge=present_charge,
            present_discharge=present_discharge,
        )

        inverters_measurements_a_measurement_produced_by_a_battery_inverter.additional_properties = d
        return inverters_measurements_a_measurement_produced_by_a_battery_inverter
