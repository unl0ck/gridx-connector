...
from ..models.patch_accounts_account_id_parent_account_kind import PatchAccountsAccountIDParentAccountKind
from ..models.patch_accounts_account_id_parent_account_solution import PatchAccountsAccountIDParentAccountSolution
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.patch_accounts_account_id_parent_account_address import PatchAccountsAccountIDParentAccountAddress


T = TypeVar("T", bound="PatchAccountsAccountIDParentAccount")


@_attrs_define
class PatchAccountsAccountIDParentAccount:
    ...
    Attributes:
        ...
        solution (PatchAccountsAccountIDParentAccountSolution | Unset): Represents the supported solutions within the
            account:
        ...
        kind (PatchAccountsAccountIDParentAccountKind | Unset): If b2b, the account is a regular account. If end-user,
            the account is a customer account which contains just one user.
        main_address (PatchAccountsAccountIDParentAccountAddress | Unset): Represents a physical address of a customer.
    ...
    solution: PatchAccountsAccountIDParentAccountSolution | Unset = UNSET
    parent_id: UUID | Unset = UNSET
    systems_count: int | Unset = UNSET
    kind: PatchAccountsAccountIDParentAccountKind | Unset = UNSET
    main_address: PatchAccountsAccountIDParentAccountAddress | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        solution: PatchAccountsAccountIDParentAccountSolution | Unset
        if isinstance(_solution, Unset):
            solution = UNSET
        else:
            solution = PatchAccountsAccountIDParentAccountSolution(_solution)
        ...
        kind: PatchAccountsAccountIDParentAccountKind | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = PatchAccountsAccountIDParentAccountKind(_kind)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: PatchAccountsAccountIDParentAccountAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = PatchAccountsAccountIDParentAccountAddress.from_dict(_main_address)

        customization = d.pop("customization", UNSET)

        patch_accounts_account_id_parent_account = cls(
            id=id,
        ...
        patch_accounts_account_id_parent_account.additional_properties = d
        return patch_accounts_account_id_parent_account
