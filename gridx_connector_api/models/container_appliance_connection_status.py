...
from ..models.container_appliance_connection_status_status import ContainerApplianceConnectionStatusStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContainerApplianceConnectionStatus")


@_attrs_define
class ContainerApplianceConnectionStatus:
    """
    Attributes:
        status (ContainerApplianceConnectionStatusStatus): Indicates the connection status of an appliance.
    ...
    status: ContainerApplianceConnectionStatusStatus
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = ContainerApplianceConnectionStatusStatus(d.pop("status"))
        ...
        container_appliance_connection_status = cls(
            status=status,
            contacted_at=contacted_at,
        )

        container_appliance_connection_status.additional_properties = d
        return container_appliance_connection_status
