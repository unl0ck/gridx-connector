...
T = TypeVar("T", bound="AbstractTagsStrictItem")


@_attrs_define
class AbstractTagsStrictItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        abstract_tags_strict_item = cls(
            name=name,
            value=value,
        )

        abstract_tags_strict_item.additional_properties = d
        return abstract_tags_strict_item
