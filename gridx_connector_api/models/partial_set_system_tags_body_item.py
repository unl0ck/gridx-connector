...
T = TypeVar("T", bound="PartialSetSystemTagsBodyItem")


@_attrs_define
class PartialSetSystemTagsBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        partial_set_system_tags_body_item = cls(
            name=name,
            value=value,
        )

        partial_set_system_tags_body_item.additional_properties = d
        return partial_set_system_tags_body_item
