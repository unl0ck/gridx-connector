...
from ..models.get_gateways_gateway_id_appliances_appliance_id_ev_configuration_response_200_charge_mode import (
    GetGatewaysGatewayIDAppliancesApplianceIDEvConfigurationResponse200ChargeMode,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetGatewaysGatewayIDAppliancesApplianceIDEvConfigurationResponse200")


@_attrs_define
class GetGatewaysGatewayIDAppliancesApplianceIDEvConfigurationResponse200:
    """
    Attributes:
        ...
        charge_mode (GetGatewaysGatewayIDAppliancesApplianceIDEvConfigurationResponse200ChargeMode | Unset): Defines how
            the EV shall be charged.
    ...
    charge_mode: GetGatewaysGatewayIDAppliancesApplianceIDEvConfigurationResponse200ChargeMode | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        charge_mode: GetGatewaysGatewayIDAppliancesApplianceIDEvConfigurationResponse200ChargeMode | Unset
        if isinstance(_charge_mode, Unset):
            charge_mode = UNSET
        else:
            charge_mode = GetGatewaysGatewayIDAppliancesApplianceIDEvConfigurationResponse200ChargeMode(_charge_mode)
        ...
        get_gateways_gateway_id_appliances_appliance_id_ev_configuration_response_200 = cls(
        ...
        get_gateways_gateway_id_appliances_appliance_id_ev_configuration_response_200.additional_properties = d
        return get_gateways_gateway_id_appliances_appliance_id_ev_configuration_response_200
