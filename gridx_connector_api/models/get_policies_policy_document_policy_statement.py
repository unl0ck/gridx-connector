...
from ..models.get_policies_policy_document_policy_statement_effect import GetPoliciesPolicyDocumentPolicyStatementEffect
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPoliciesPolicyDocumentPolicyStatement")


@_attrs_define
class GetPoliciesPolicyDocumentPolicyStatement:
    """
    Attributes:
        ...
        action (str): The action that this statement represents. An action is an operation on a resource. Example:
            groups:Create.
        effect (GetPoliciesPolicyDocumentPolicyStatementEffect): Whether this statement restricts or grants the
    ...
    name: str
    action: str
    effect: GetPoliciesPolicyDocumentPolicyStatementEffect
    fields: str
    resource: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        effect = GetPoliciesPolicyDocumentPolicyStatementEffect(d.pop("effect"))
        ...
        get_policies_policy_document_policy_statement = cls(
            id=id,
            name=name,
            action=action,
            effect=effect,
        ...
        get_policies_policy_document_policy_statement.additional_properties = d
        return get_policies_policy_document_policy_statement
