...
T = TypeVar("T", bound="SetSystemTagsResponse403")


@_attrs_define
class SetSystemTagsResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_system_tags_response_403 = cls(
            message=message,
            details=details,
        )

        set_system_tags_response_403.additional_properties = d
        return set_system_tags_response_403
