...
from ..models.get_accounts_account_kind import GetAccountsAccountKind
from ..models.get_accounts_account_solution import GetAccountsAccountSolution
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_accounts_account_address import GetAccountsAccountAddress


T = TypeVar("T", bound="GetAccountsAccount")
...
class GetAccountsAccount:
    ...
    Attributes:
        ...
        solution (GetAccountsAccountSolution | Unset): Represents the supported solutions within the account:
        ...
        kind (GetAccountsAccountKind | Unset): If b2b, the account is a regular account. If end-user, the account is a
            customer account which contains just one user.
        main_address (GetAccountsAccountAddress | Unset): Represents a physical address of a customer.
    ...
    solution: GetAccountsAccountSolution | Unset = UNSET
    parent_id: UUID | Unset = UNSET
    systems_count: int | Unset = UNSET
    kind: GetAccountsAccountKind | Unset = UNSET
    main_address: GetAccountsAccountAddress | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        solution: GetAccountsAccountSolution | Unset
        if isinstance(_solution, Unset):
            solution = UNSET
        else:
            solution = GetAccountsAccountSolution(_solution)
        ...
        kind: GetAccountsAccountKind | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = GetAccountsAccountKind(_kind)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: GetAccountsAccountAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = GetAccountsAccountAddress.from_dict(_main_address)

        customization = d.pop("customization", UNSET)

        get_accounts_account = cls(
            id=id,
        ...
        get_accounts_account.additional_properties = d
        return get_accounts_account
