...
T = TypeVar("T", bound="ListSystemTagsResponse400")


@_attrs_define
class ListSystemTagsResponse400:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_system_tags_response_400 = cls(
            message=message,
            details=details,
        )

        list_system_tags_response_400.additional_properties = d
        return list_system_tags_response_400
