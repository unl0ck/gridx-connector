...
from ..models.devices_additional_property_item_bindings_item_type import DevicesAdditionalPropertyItemBindingsItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="DevicesAdditionalPropertyItemBindingsItem")


@_attrs_define
class DevicesAdditionalPropertyItemBindingsItem:
    """
    Attributes:
        type_ (DevicesAdditionalPropertyItemBindingsItemType): The resource type for which the binding is created.
    ...
    type_: DevicesAdditionalPropertyItemBindingsItemType
    name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = DevicesAdditionalPropertyItemBindingsItemType(d.pop("type"))
        ...
        devices_additional_property_item_bindings_item = cls(
            type_=type_,
            name=name,
        ...
        devices_additional_property_item_bindings_item.additional_properties = d
        return devices_additional_property_item_bindings_item
