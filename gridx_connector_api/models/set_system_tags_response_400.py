...
T = TypeVar("T", bound="SetSystemTagsResponse400")


@_attrs_define
class SetSystemTagsResponse400:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_system_tags_response_400 = cls(
            message=message,
            details=details,
        )

        set_system_tags_response_400.additional_properties = d
        return set_system_tags_response_400
