...
if TYPE_CHECKING:
    from ..models.measurement_grid_measurement_grid_meter_reading import MeasurementGridMeasurementGridMeterReading


T = TypeVar("T", bound="MeasurementGrid")
...
class MeasurementGrid:
    ...
    Attributes:
        ...
        meter_reading (MeasurementGridMeasurementGridMeterReading | Unset):
    """
    ...
    meter_reading: MeasurementGridMeasurementGridMeterReading | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meter_reading, Unset):
            ...
            meter_reading = MeasurementGridMeasurementGridMeterReading.from_dict(_meter_reading)

        measurement_grid = cls(
        ...
        measurement_grid.additional_properties = d
