...
T = TypeVar("T", bound="GetUserResponse200Language")


@_attrs_define
class GetUserResponse200Language:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_response_200_language = cls(
            tag=tag,
            name=name,
            name_native=name_native,
        )

        get_user_response_200_language.additional_properties = d
        return get_user_response_200_language
