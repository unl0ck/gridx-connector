...
from ..models.appliance_update_strict_appliance_state import ApplianceUpdateStrictApplianceState
from ..models.appliance_update_strict_kind import ApplianceUpdateStrictKind
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.appliance_update_strict_crypto_settings_item import ApplianceUpdateStrictCryptoSettingsItem
    from ..models.appliance_update_strict_energy_management_settings import (
        ApplianceUpdateStrictEnergyManagementSettings,
    )
    from ..models.appliance_update_strict_ev_load_management_parameters import (
        ApplianceUpdateStrictEvLoadManagementParameters,
    )
    from ..models.appliance_update_strict_heat_pump_information import ApplianceUpdateStrictHeatPumpInformation
    from ..models.appliance_update_strict_io_device_information import ApplianceUpdateStrictIODeviceInformation
    from ..models.appliance_update_strict_load_settings import ApplianceUpdateStrictLoadSettings


T = TypeVar("T", bound="ApplianceUpdateStrict")


@_attrs_define
class ApplianceUpdateStrict:
    """
    Attributes:
        inactive (bool | Unset):
        ...
        load_settings (ApplianceUpdateStrictLoadSettings | Unset): Configure load of appliance.
        kind (ApplianceUpdateStrictKind | Unset): Indicates the specific kind or role of the appliance.
            Only settable for appliances of type `INVERTER` or `METER`.
        energy_settings (ApplianceUpdateStrictEnergyManagementSettings | Unset): Contains energy management information
        crypto_settings (list[ApplianceUpdateStrictCryptoSettingsItem] | Unset): Contains a list of crypto setting keys
            that are associated with the appliance.
        ev_load_management_parameters (ApplianceUpdateStrictEvLoadManagementParameters | Unset): Load management
        ...
        desired_state (ApplianceUpdateStrictApplianceState | Unset): State an appliance can be in.
        heat_pump (ApplianceUpdateStrictHeatPumpInformation | Unset): The heat pump specific information.
        io_device (ApplianceUpdateStrictIODeviceInformation | Unset): The io device specific information.
    """
    ...
    load_settings: ApplianceUpdateStrictLoadSettings | Unset = UNSET
    kind: ApplianceUpdateStrictKind | Unset = UNSET
    energy_settings: ApplianceUpdateStrictEnergyManagementSettings | Unset = UNSET
    crypto_settings: list[ApplianceUpdateStrictCryptoSettingsItem] | Unset = UNSET
    ev_load_management_parameters: ApplianceUpdateStrictEvLoadManagementParameters | Unset = UNSET
    evse_id: str | Unset = UNSET
    desired_state: ApplianceUpdateStrictApplianceState | Unset = UNSET
    heat_pump: ApplianceUpdateStrictHeatPumpInformation | Unset = UNSET
    io_device: ApplianceUpdateStrictIODeviceInformation | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        load_settings: ApplianceUpdateStrictLoadSettings | Unset
        if isinstance(_load_settings, Unset):
            load_settings = UNSET
        else:
            load_settings = ApplianceUpdateStrictLoadSettings.from_dict(_load_settings)

        _kind = d.pop("kind", UNSET)
        kind: ApplianceUpdateStrictKind | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = ApplianceUpdateStrictKind(_kind)

        _energy_settings = d.pop("energySettings", UNSET)
        energy_settings: ApplianceUpdateStrictEnergyManagementSettings | Unset
        if isinstance(_energy_settings, Unset):
            energy_settings = UNSET
        else:
            energy_settings = ApplianceUpdateStrictEnergyManagementSettings.from_dict(_energy_settings)
        ...
        if _crypto_settings is not UNSET:
            ...
            for crypto_settings_item_data in _crypto_settings:
                crypto_settings_item = ApplianceUpdateStrictCryptoSettingsItem.from_dict(crypto_settings_item_data)

                crypto_settings.append(crypto_settings_item)

        _ev_load_management_parameters = d.pop("evLoadManagementParameters", UNSET)
        ev_load_management_parameters: ApplianceUpdateStrictEvLoadManagementParameters | Unset
        if isinstance(_ev_load_management_parameters, Unset):
            ev_load_management_parameters = UNSET
        else:
            ev_load_management_parameters = ApplianceUpdateStrictEvLoadManagementParameters.from_dict(
        ...
        desired_state: ApplianceUpdateStrictApplianceState | Unset
        if isinstance(_desired_state, Unset):
            desired_state = UNSET
        else:
            desired_state = ApplianceUpdateStrictApplianceState(_desired_state)

        _heat_pump = d.pop("heatPump", UNSET)
        heat_pump: ApplianceUpdateStrictHeatPumpInformation | Unset
        if isinstance(_heat_pump, Unset):
            heat_pump = UNSET
        else:
            heat_pump = ApplianceUpdateStrictHeatPumpInformation.from_dict(_heat_pump)

        _io_device = d.pop("ioDevice", UNSET)
        io_device: ApplianceUpdateStrictIODeviceInformation | Unset
        if isinstance(_io_device, Unset):
            io_device = UNSET
        else:
            io_device = ApplianceUpdateStrictIODeviceInformation.from_dict(_io_device)

        appliance_update_strict = cls(
            inactive=inactive,
            name=name,
        ...
        appliance_update_strict.additional_properties = d
        return appliance_update_strict
