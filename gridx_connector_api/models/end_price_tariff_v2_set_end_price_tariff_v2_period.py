...
T = TypeVar("T", bound="EndPriceTariffV2SetEndPriceTariffV2Period")


@_attrs_define
class EndPriceTariffV2SetEndPriceTariffV2Period:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        end_price_tariff_v2_set_end_price_tariff_v2_period = cls(
            from_=from_,
            to=to,
        ...
        end_price_tariff_v2_set_end_price_tariff_v2_period.additional_properties = d
        return end_price_tariff_v2_set_end_price_tariff_v2_period
