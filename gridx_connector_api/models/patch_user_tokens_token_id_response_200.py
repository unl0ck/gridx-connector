...
T = TypeVar("T", bound="PatchUserTokensTokenIDResponse200")


@_attrs_define
class PatchUserTokensTokenIDResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_user_tokens_token_id_response_200 = cls(
            id=id,
        ...
        patch_user_tokens_token_id_response_200.additional_properties = d
        return patch_user_tokens_token_id_response_200
