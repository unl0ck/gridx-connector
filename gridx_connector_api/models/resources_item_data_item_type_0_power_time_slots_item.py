...
T = TypeVar("T", bound="ResourcesItemDataItemType0PowerTimeSlotsItem")


@_attrs_define
class ResourcesItemDataItemType0PowerTimeSlotsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resources_item_data_item_type_0_power_time_slots_item = cls(
            slot_id=slot_id,
        ...
        resources_item_data_item_type_0_power_time_slots_item.additional_properties = d
        return resources_item_data_item_type_0_power_time_slots_item
