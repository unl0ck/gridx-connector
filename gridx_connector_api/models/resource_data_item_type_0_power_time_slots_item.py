...
T = TypeVar("T", bound="ResourceDataItemType0PowerTimeSlotsItem")


@_attrs_define
class ResourceDataItemType0PowerTimeSlotsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource_data_item_type_0_power_time_slots_item = cls(
            slot_id=slot_id,
        ...
        resource_data_item_type_0_power_time_slots_item.additional_properties = d
        return resource_data_item_type_0_power_time_slots_item
