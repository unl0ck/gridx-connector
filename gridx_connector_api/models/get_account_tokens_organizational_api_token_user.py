...
if TYPE_CHECKING:
    from ..models.get_account_tokens_organizational_api_token_user_address import (
        GetAccountTokensOrganizationalAPITokenUserAddress,
    )
    from ..models.get_account_tokens_organizational_api_token_user_language import (
        GetAccountTokensOrganizationalAPITokenUserLanguage,
    )
    from ..models.get_account_tokens_organizational_api_token_user_policy_group import (
        GetAccountTokensOrganizationalAPITokenUserPolicyGroup,
    )


T = TypeVar("T", bound="GetAccountTokensOrganizationalAPITokenUser")


@_attrs_define
class GetAccountTokensOrganizationalAPITokenUser:
    """
    Attributes:
        ...
        full_name (str | Unset): Full name of the user typically consisting of first name and last name. Example: John
            Doe.
        groups (list[GetAccountTokensOrganizationalAPITokenUserPolicyGroup] | Unset): Policy groups attached to this
            user which determine the effective permissions through policies.
        main_address (GetAccountTokensOrganizationalAPITokenUserAddress | Unset): Represents a physical address of a
            customer.
        language (GetAccountTokensOrganizationalAPITokenUserLanguage | Unset): The language information of the user.
    """
    ...
    groups: list[GetAccountTokensOrganizationalAPITokenUserPolicyGroup] | Unset = UNSET
    main_address: GetAccountTokensOrganizationalAPITokenUserAddress | Unset = UNSET
    language: GetAccountTokensOrganizationalAPITokenUserLanguage | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _groups is not UNSET:
            ...
            for groups_item_data in _groups:
                groups_item = GetAccountTokensOrganizationalAPITokenUserPolicyGroup.from_dict(groups_item_data)

                groups.append(groups_item)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: GetAccountTokensOrganizationalAPITokenUserAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = GetAccountTokensOrganizationalAPITokenUserAddress.from_dict(_main_address)

        _language = d.pop("language", UNSET)
        language: GetAccountTokensOrganizationalAPITokenUserLanguage | Unset
        if isinstance(_language, Unset):
            language = UNSET
        else:
            language = GetAccountTokensOrganizationalAPITokenUserLanguage.from_dict(_language)

        get_account_tokens_organizational_api_token_user = cls(
            id=id,
        ...
        get_account_tokens_organizational_api_token_user.additional_properties = d
        return get_account_tokens_organizational_api_token_user
