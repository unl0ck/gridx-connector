...
T = TypeVar("T", bound="ElectricVehicleProfile")


@_attrs_define
class ElectricVehicleProfile:
    """Represents data related to an EV Profile.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        electric_vehicle_profile.additional_properties = d
