...
T = TypeVar("T", bound="GetUserTokensResponse200Item")


@_attrs_define
class GetUserTokensResponse200Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_tokens_response_200_item = cls(
            id=id,
        ...
        get_user_tokens_response_200_item.additional_properties = d
        return get_user_tokens_response_200_item
