...
from ..models.ev_charging_station_configuration_update_charge_mode import EVChargingStationConfigurationUpdateChargeMode
from ..types import UNSET, Unset

T = TypeVar("T", bound="EVChargingStationConfigurationUpdate")


@_attrs_define
class EVChargingStationConfigurationUpdate:
    """
    Attributes:
        ...
        user_total_capacity (float | None | Unset): The size of the EV's battery in Wh.
            ...
            The value is needed to calculate the energy that needs to be charged to fulfill the `minRequestedSoc`.
             Example: 82000.
        charge_mode (EVChargingStationConfigurationUpdateChargeMode | Unset): Defines how the EV shall be charged.
    ...
    charge_mode: EVChargingStationConfigurationUpdateChargeMode | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        charge_mode: EVChargingStationConfigurationUpdateChargeMode | Unset
        if isinstance(_charge_mode, Unset):
            charge_mode = UNSET
        else:
            charge_mode = EVChargingStationConfigurationUpdateChargeMode(_charge_mode)
        ...
        ev_charging_station_configuration_update = cls(
        ...
        ev_charging_station_configuration_update.additional_properties = d
        return ev_charging_station_configuration_update
