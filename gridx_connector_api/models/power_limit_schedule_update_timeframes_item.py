...
T = TypeVar("T", bound="PowerLimitScheduleUpdateTimeframesItem")


@_attrs_define
class PowerLimitScheduleUpdateTimeframesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        power_limit_schedule_update_timeframes_item = cls(
            from_=from_,
            to=to,
            max_power=max_power,
        )

        power_limit_schedule_update_timeframes_item.additional_properties = d
        return power_limit_schedule_update_timeframes_item
