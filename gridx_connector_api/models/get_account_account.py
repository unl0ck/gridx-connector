...
from ..models.get_account_account_kind import GetAccountAccountKind
from ..models.get_account_account_solution import GetAccountAccountSolution
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_account_account_address import GetAccountAccountAddress


T = TypeVar("T", bound="GetAccountAccount")


@_attrs_define
class GetAccountAccount:
    ...
    Attributes:
        ...
        solution (GetAccountAccountSolution | Unset): Represents the supported solutions within the account:
        ...
        kind (GetAccountAccountKind | Unset): If b2b, the account is a regular account. If end-user, the account is a
            customer account which contains just one user.
        main_address (GetAccountAccountAddress | Unset): Represents a physical address of a customer.
    ...
    solution: GetAccountAccountSolution | Unset = UNSET
    parent_id: UUID | Unset = UNSET
    systems_count: int | Unset = UNSET
    kind: GetAccountAccountKind | Unset = UNSET
    main_address: GetAccountAccountAddress | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        solution: GetAccountAccountSolution | Unset
        if isinstance(_solution, Unset):
            solution = UNSET
        else:
            solution = GetAccountAccountSolution(_solution)
        ...
        kind: GetAccountAccountKind | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = GetAccountAccountKind(_kind)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: GetAccountAccountAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = GetAccountAccountAddress.from_dict(_main_address)

        customization = d.pop("customization", UNSET)

        get_account_account = cls(
            id=id,
        ...
        get_account_account.additional_properties = d
        return get_account_account
