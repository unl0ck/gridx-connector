...
T = TypeVar("T", bound="PatchAccountResponse403")


@_attrs_define
class PatchAccountResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_account_response_403 = cls(
            message=message,
            details=details,
        )

        patch_account_response_403.additional_properties = d
        return patch_account_response_403
