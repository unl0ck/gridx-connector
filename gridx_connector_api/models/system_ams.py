...
from ..models.system_ams_gateway_status import SystemAMSGatewayStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.system_ams_location import SystemAMSLocation


T = TypeVar("T", bound="SystemAMS")
...
class SystemAMS:
    ...
    Attributes:
        ...
        location (SystemAMSLocation): The Location where the System is located at. The first time it is created and on
            any subsequent updates, the
        ...
        gateway_status (SystemAMSGatewayStatus | Unset):
    ...
    name: str
    gateway_sn: str
    location: SystemAMSLocation
    id: UUID | Unset = UNSET
    gateway_status: SystemAMSGatewayStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        location = SystemAMSLocation.from_dict(d.pop("location"))
        ...
        if isinstance(_gateway_status, Unset):
            ...
            gateway_status = SystemAMSGatewayStatus(_gateway_status)
        ...
        system_ams.additional_properties = d
        return system_ams
