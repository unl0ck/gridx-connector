...
class EndpriceTariffV2EndPriceTariffV2Period:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        endprice_tariff_v2_end_price_tariff_v2_period = cls(
            from_=from_,
            to=to,
        ...
        endprice_tariff_v2_end_price_tariff_v2_period.additional_properties = d
        return endprice_tariff_v2_end_price_tariff_v2_period
