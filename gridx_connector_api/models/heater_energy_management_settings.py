...
T = TypeVar("T", bound="HeaterEnergyManagementSettings")


@_attrs_define
class HeaterEnergyManagementSettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        heater_energy_management_settings = cls(
        ...
        heater_energy_management_settings.additional_properties = d
        return heater_energy_management_settings
