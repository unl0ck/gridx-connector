...
from ..models.abstract_io_device_io_device_information_type import AbstractIODeviceIODeviceInformationType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.abstract_io_device_io_device_information_io_device_input_channel import (
        AbstractIODeviceIODeviceInformationIODeviceInputChannel,
    )
    from ..models.abstract_io_device_io_device_information_io_device_output_channel import (
        AbstractIODeviceIODeviceInformationIODeviceOutputChannel,
    )


T = TypeVar("T", bound="AbstractIODeviceIODeviceInformation")


@_attrs_define
class AbstractIODeviceIODeviceInformation:
    """The io device specific information.

    Attributes:
        type_ (AbstractIODeviceIODeviceInformationType | Unset): Describes the specific type of the device.
        ...
        out_channels_count (int | Unset): The number of output ports on the device, real physical ports you can connect
            a cable to.
        input_channels (list[AbstractIODeviceIODeviceInformationIODeviceInputChannel] | Unset): Input channels of the
            fieldbus coupler, containing actions.
        output_channels (list[AbstractIODeviceIODeviceInformationIODeviceOutputChannel] | Unset): Output channels of the
            IODevice, containing actions. An output channel must not always use exactly one port, but can use multiple
            physical connections.
            SGReady heat pumps for example are connected using two output ports (which are grouped in one OutputChannel).
    """

    type_: AbstractIODeviceIODeviceInformationType | Unset = UNSET
    in_channels_count: int | Unset = UNSET
    out_channels_count: int | Unset = UNSET
    input_channels: list[AbstractIODeviceIODeviceInformationIODeviceInputChannel] | Unset = UNSET
    output_channels: list[AbstractIODeviceIODeviceInformationIODeviceOutputChannel] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: AbstractIODeviceIODeviceInformationType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = AbstractIODeviceIODeviceInformationType(_type_)
        ...
        if _input_channels is not UNSET:
            ...
            for input_channels_item_data in _input_channels:
                input_channels_item = AbstractIODeviceIODeviceInformationIODeviceInputChannel.from_dict(
        ...
        if _output_channels is not UNSET:
            ...
            for output_channels_item_data in _output_channels:
                output_channels_item = AbstractIODeviceIODeviceInformationIODeviceOutputChannel.from_dict(
                    output_channels_item_data
                )

                output_channels.append(output_channels_item)

        abstract_io_device_io_device_information = cls(
            type_=type_,
        ...
        abstract_io_device_io_device_information.additional_properties = d
        return abstract_io_device_io_device_information
