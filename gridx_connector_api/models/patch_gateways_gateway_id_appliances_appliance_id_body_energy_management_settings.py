...
T = TypeVar("T", bound="PatchGatewaysGatewayIDAppliancesApplianceIDBodyEnergyManagementSettings")


@_attrs_define
class PatchGatewaysGatewayIDAppliancesApplianceIDBodyEnergyManagementSettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_gateways_gateway_id_appliances_appliance_id_body_energy_management_settings = cls(
        ...
        patch_gateways_gateway_id_appliances_appliance_id_body_energy_management_settings.additional_properties = d
        return patch_gateways_gateway_id_appliances_appliance_id_body_energy_management_settings
