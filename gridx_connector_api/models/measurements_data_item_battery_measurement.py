...
T = TypeVar("T", bound="MeasurementsDataItemBatteryMeasurement")


@_attrs_define
class MeasurementsDataItemBatteryMeasurement:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        measurements_data_item_battery_measurement = cls(
        ...
        measurements_data_item_battery_measurement.additional_properties = d
        return measurements_data_item_battery_measurement
