...
T = TypeVar("T", bound="GetAccountTokensOrganizationalAPITokenUserLanguage")


@_attrs_define
class GetAccountTokensOrganizationalAPITokenUserLanguage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_account_tokens_organizational_api_token_user_language = cls(
            tag=tag,
            name=name,
            name_native=name_native,
        )

        get_account_tokens_organizational_api_token_user_language.additional_properties = d
        return get_account_tokens_organizational_api_token_user_language
