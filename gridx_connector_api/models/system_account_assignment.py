...
T = TypeVar("T", bound="SystemAccountAssignment")


@_attrs_define
class SystemAccountAssignment:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        system_account_assignment = cls(
            uuids=uuids,
            move_systems_and_customers=move_systems_and_customers,
            move_vendor_id=move_vendor_id,
        )

        system_account_assignment.additional_properties = d
        return system_account_assignment
