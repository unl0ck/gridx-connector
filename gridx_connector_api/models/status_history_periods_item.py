...
from ..models.status_history_periods_item_error_code import StatusHistoryPeriodsItemErrorCode
from ..models.status_history_periods_item_status import StatusHistoryPeriodsItemStatus
from ..models.status_history_periods_item_warnings_item import StatusHistoryPeriodsItemWarningsItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="StatusHistoryPeriodsItem")


@_attrs_define
class StatusHistoryPeriodsItem:
    """
    Attributes:
        ...
        status (StatusHistoryPeriodsItemStatus | Unset): Operational status of Time-of-Use for a specific run.
            ...
            * `INITIALIZING` - Time-of-Use optimization is initializing, it may take up to 48h.
             Example: ONLINE.
        error_code (StatusHistoryPeriodsItemErrorCode | Unset): Most recent error causing a failure of Time-of-Use
            specific run.
        ...
        warnings (list[StatusHistoryPeriodsItemWarningsItem] | Unset): All the relevant warnings that occurred during a
    ...
    status: StatusHistoryPeriodsItemStatus | Unset = UNSET
    error_code: StatusHistoryPeriodsItemErrorCode | Unset = UNSET
    warnings: list[StatusHistoryPeriodsItemWarningsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: StatusHistoryPeriodsItemStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = StatusHistoryPeriodsItemStatus(_status)

        _error_code = d.pop("error_code", UNSET)
        error_code: StatusHistoryPeriodsItemErrorCode | Unset
        if isinstance(_error_code, Unset):
            error_code = UNSET
        else:
            error_code = StatusHistoryPeriodsItemErrorCode(_error_code)
        ...
        if _warnings is not UNSET:
            ...
            for warnings_item_data in _warnings:
                warnings_item = StatusHistoryPeriodsItemWarningsItem(warnings_item_data)

                warnings.append(warnings_item)

        status_history_periods_item = cls(
            from_=from_,
            to=to,
            status=status,
        ...
        status_history_periods_item.additional_properties = d
        return status_history_periods_item
