...
T = TypeVar("T", bound="GetAccountsAccountIDSystemsResponse200ItemUsersItemPolicyGroup")


@_attrs_define
class GetAccountsAccountIDSystemsResponse200ItemUsersItemPolicyGroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_accounts_account_id_systems_response_200_item_users_item_policy_group = cls(
            name=name,
            id=id,
        ...
        get_accounts_account_id_systems_response_200_item_users_item_policy_group.additional_properties = d
        return get_accounts_account_id_systems_response_200_item_users_item_policy_group
