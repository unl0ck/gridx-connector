...
if TYPE_CHECKING:
    from ..models.resource_data_item_type_0 import ResourceDataItemType0
...
class Resource:
    ...
    Attributes:
        ...
        data (list[ResourceDataItemType0]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for data_item_data in self.data:
            ...
            if isinstance(data_item_data, ResourceDataItemType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            ...
            def _parse_data_item(data: object) -> ResourceDataItemType0:
                if not isinstance(data, dict):
                    raise TypeError()
                data_item_type_0 = ResourceDataItemType0.from_dict(data)
