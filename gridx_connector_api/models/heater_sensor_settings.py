...
T = TypeVar("T", bound="HeaterSensorSettings")


@_attrs_define
class HeaterSensorSettings:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        heater_sensor_settings.additional_properties = d
        return heater_sensor_settings
