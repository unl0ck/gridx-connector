...
T = TypeVar("T", bound="GetCustomersResponse403")


@_attrs_define
class GetCustomersResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_customers_response_403 = cls(
            message=message,
            details=details,
        )

        get_customers_response_403.additional_properties = d
        return get_customers_response_403
