...
T = TypeVar("T", bound="PatchSystemsSystemIDTimeofuseSettingsResponse200")


@_attrs_define
class PatchSystemsSystemIDTimeofuseSettingsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_systems_system_id_timeofuse_settings_response_200 = cls(
            enabled=enabled,
        ...
        patch_systems_system_id_timeofuse_settings_response_200.additional_properties = d
        return patch_systems_system_id_timeofuse_settings_response_200
