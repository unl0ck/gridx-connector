...
T = TypeVar("T", bound="ExtendedBatteryMeasurement")


@_attrs_define
class ExtendedBatteryMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        extended_battery_measurement = cls(
            charge=charge,
            discharge=discharge,
        ...
        extended_battery_measurement.additional_properties = d
        return extended_battery_measurement
