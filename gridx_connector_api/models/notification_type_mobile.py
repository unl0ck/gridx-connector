...
T = TypeVar("T", bound="NotificationTypeMobile")


@_attrs_define
class NotificationTypeMobile:
    """
    Attributes:
        app_name (str | Unset):
        os (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        notification_type_mobile = cls(
            app_name=app_name,
            os=os,
            device_token=device_token,
        )

        notification_type_mobile.additional_properties = d
        return notification_type_mobile
