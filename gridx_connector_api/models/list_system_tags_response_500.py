...
T = TypeVar("T", bound="ListSystemTagsResponse500")


@_attrs_define
class ListSystemTagsResponse500:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_system_tags_response_500 = cls(
            message=message,
            details=details,
        )

        list_system_tags_response_500.additional_properties = d
        return list_system_tags_response_500
