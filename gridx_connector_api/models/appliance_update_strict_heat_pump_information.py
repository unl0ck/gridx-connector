...
from ..models.appliance_update_strict_heat_pump_information_type import ApplianceUpdateStrictHeatPumpInformationType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ApplianceUpdateStrictHeatPumpInformation")


@_attrs_define
class ApplianceUpdateStrictHeatPumpInformation:
    """The heat pump specific information.

    Attributes:
        type_ (ApplianceUpdateStrictHeatPumpInformationType | Unset): Describes the specific type of the heat pump.
    ...
    type_: ApplianceUpdateStrictHeatPumpInformationType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: ApplianceUpdateStrictHeatPumpInformationType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = ApplianceUpdateStrictHeatPumpInformationType(_type_)
        ...
        appliance_update_strict_heat_pump_information = cls(
            type_=type_,
        ...
        appliance_update_strict_heat_pump_information.additional_properties = d
        return appliance_update_strict_heat_pump_information
