...
T = TypeVar("T", bound="GetAccountsAccountIDAccountAddress")


@_attrs_define
class GetAccountsAccountIDAccountAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_accounts_account_id_account_address = cls(
            city=city,
            country=country,
        ...
        get_accounts_account_id_account_address.additional_properties = d
        return get_accounts_account_id_account_address
