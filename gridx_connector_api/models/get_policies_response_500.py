...
T = TypeVar("T", bound="GetPoliciesResponse500")


@_attrs_define
class GetPoliciesResponse500:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_policies_response_500 = cls(
            message=message,
            details=details,
        )

        get_policies_response_500.additional_properties = d
        return get_policies_response_500
