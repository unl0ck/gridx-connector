...
if TYPE_CHECKING:
    from ..models.extended_measurement_measurement_grid_measurement_grid_meter_reading import (
        ExtendedMeasurementMeasurementGridMeasurementGridMeterReading,
    )


T = TypeVar("T", bound="ExtendedMeasurementMeasurementGrid")


@_attrs_define
class ExtendedMeasurementMeasurementGrid:
    """
    Attributes:
        ...
        meter_reading (ExtendedMeasurementMeasurementGridMeasurementGridMeterReading | Unset):
    """
    ...
    meter_reading: ExtendedMeasurementMeasurementGridMeasurementGridMeterReading | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meter_reading, Unset):
            ...
            meter_reading = ExtendedMeasurementMeasurementGridMeasurementGridMeterReading.from_dict(_meter_reading)

        extended_measurement_measurement_grid = cls(
        ...
        extended_measurement_measurement_grid.additional_properties = d
        return extended_measurement_measurement_grid
