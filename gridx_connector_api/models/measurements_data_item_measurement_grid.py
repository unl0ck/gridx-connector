...
if TYPE_CHECKING:
    from ..models.measurements_data_item_measurement_grid_measurement_grid_meter_reading import (
        MeasurementsDataItemMeasurementGridMeasurementGridMeterReading,
    )


T = TypeVar("T", bound="MeasurementsDataItemMeasurementGrid")


@_attrs_define
class MeasurementsDataItemMeasurementGrid:
    """
    Attributes:
        ...
        meter_reading (MeasurementsDataItemMeasurementGridMeasurementGridMeterReading | Unset):
    """
    ...
    meter_reading: MeasurementsDataItemMeasurementGridMeasurementGridMeterReading | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meter_reading, Unset):
            ...
            meter_reading = MeasurementsDataItemMeasurementGridMeasurementGridMeterReading.from_dict(_meter_reading)

        measurements_data_item_measurement_grid = cls(
        ...
        measurements_data_item_measurement_grid.additional_properties = d
        return measurements_data_item_measurement_grid
