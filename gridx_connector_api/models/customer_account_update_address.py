...
T = TypeVar("T", bound="CustomerAccountUpdateAddress")


@_attrs_define
class CustomerAccountUpdateAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        customer_account_update_address = cls(
            city=city,
            country=country,
        ...
        customer_account_update_address.additional_properties = d
        return customer_account_update_address
