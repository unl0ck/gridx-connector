...
T = TypeVar("T", bound="GetAccountsAccountIDScanconfigurationScanConfiguration")


@_attrs_define
class GetAccountsAccountIDScanconfigurationScanConfiguration:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_accounts_account_id_scanconfiguration_scan_configuration = cls(
        ...
        get_accounts_account_id_scanconfiguration_scan_configuration.additional_properties = d
        return get_accounts_account_id_scanconfiguration_scan_configuration
