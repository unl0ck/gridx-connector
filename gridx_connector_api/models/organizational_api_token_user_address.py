...
T = TypeVar("T", bound="OrganizationalAPITokenUserAddress")


@_attrs_define
class OrganizationalAPITokenUserAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organizational_api_token_user_address = cls(
            city=city,
            country=country,
        ...
        organizational_api_token_user_address.additional_properties = d
        return organizational_api_token_user_address
