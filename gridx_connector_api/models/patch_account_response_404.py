...
T = TypeVar("T", bound="PatchAccountResponse404")


@_attrs_define
class PatchAccountResponse404:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_account_response_404 = cls(
            message=message,
            details=details,
        )

        patch_account_response_404.additional_properties = d
        return patch_account_response_404
