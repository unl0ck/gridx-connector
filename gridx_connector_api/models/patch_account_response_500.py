...
T = TypeVar("T", bound="PatchAccountResponse500")


@_attrs_define
class PatchAccountResponse500:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_account_response_500 = cls(
            message=message,
            details=details,
        )

        patch_account_response_500.additional_properties = d
        return patch_account_response_500
