...
T = TypeVar("T", bound="TimeOfUseSettingsPut")


@_attrs_define
class TimeOfUseSettingsPut:
    """
    Attributes:
    ...
    enabled: bool
    enabled_battery_charge_from_grid: bool | Unset = True
    enabled_discharge_flexibility_to_grid: bool | Unset = False
    enabled_pv_curtailment: bool | Unset = False
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_of_use_settings_put.additional_properties = d
        return time_of_use_settings_put
