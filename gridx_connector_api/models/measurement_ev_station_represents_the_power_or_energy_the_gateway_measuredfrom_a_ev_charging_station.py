...
from ..models.measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station_plug_state import (
    MeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation")


@_attrs_define
class MeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation:
    """
    Attributes:
        ...
        plug_state (MeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState |
            Unset): Defines whether this EV is currently plugged in the charging station and whether it's charging. Default:
            MeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState.UNPLUGGED.
    ...
    plug_state: (
        MeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState | Unset
    ) = MeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState.UNPLUGGED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station = cls(
        ...
        measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station.additional_properties = d
        return measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station
