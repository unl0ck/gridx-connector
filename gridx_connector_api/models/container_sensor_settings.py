...
T = TypeVar("T", bound="ContainerSensorSettings")


@_attrs_define
class ContainerSensorSettings:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        container_sensor_settings.additional_properties = d
        return container_sensor_settings
