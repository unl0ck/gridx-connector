...
T = TypeVar("T", bound="EVChargingStationEnergyManagementSettings")


@_attrs_define
class EVChargingStationEnergyManagementSettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ev_charging_station_energy_management_settings = cls(
        ...
        ev_charging_station_energy_management_settings.additional_properties = d
        return ev_charging_station_energy_management_settings
