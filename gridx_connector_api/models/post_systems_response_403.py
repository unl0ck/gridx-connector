...
T = TypeVar("T", bound="PostSystemsResponse403")


@_attrs_define
class PostSystemsResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_systems_response_403 = cls(
            message=message,
            details=details,
        )

        post_systems_response_403.additional_properties = d
        return post_systems_response_403
