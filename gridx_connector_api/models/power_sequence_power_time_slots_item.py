...
T = TypeVar("T", bound="PowerSequencePowerTimeSlotsItem")


@_attrs_define
class PowerSequencePowerTimeSlotsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        power_sequence_power_time_slots_item = cls(
            slot_id=slot_id,
        ...
        power_sequence_power_time_slots_item.additional_properties = d
        return power_sequence_power_time_slots_item
