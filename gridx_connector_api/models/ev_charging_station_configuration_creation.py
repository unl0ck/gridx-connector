...
from ..models.ev_charging_station_configuration_creation_charge_mode import (
    EVChargingStationConfigurationCreationChargeMode,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="EVChargingStationConfigurationCreation")


@_attrs_define
class EVChargingStationConfigurationCreation:
    """
    Attributes:
        ...
        user_total_capacity (float | None | Unset): The size of the EV's battery in Wh.
            ...
            The value is needed to calculate the energy that needs to be charged to fulfill the `minRequestedSoc`.
             Example: 82000.
        charge_mode (EVChargingStationConfigurationCreationChargeMode | Unset): Defines how the EV shall be charged.
    ...
    charge_mode: EVChargingStationConfigurationCreationChargeMode | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        charge_mode: EVChargingStationConfigurationCreationChargeMode | Unset
        if isinstance(_charge_mode, Unset):
            charge_mode = UNSET
        else:
            charge_mode = EVChargingStationConfigurationCreationChargeMode(_charge_mode)
        ...
        ev_charging_station_configuration_creation = cls(
        ...
        ev_charging_station_configuration_creation.additional_properties = d
        return ev_charging_station_configuration_creation
