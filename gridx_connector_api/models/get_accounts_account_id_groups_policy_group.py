...
T = TypeVar("T", bound="GetAccountsAccountIDGroupsPolicyGroup")


@_attrs_define
class GetAccountsAccountIDGroupsPolicyGroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_accounts_account_id_groups_policy_group = cls(
            name=name,
            id=id,
        ...
        get_accounts_account_id_groups_policy_group.additional_properties = d
        return get_accounts_account_id_groups_policy_group
