...
T = TypeVar("T", bound="MeasurementsDataItemHeaterMeasurement")


@_attrs_define
class MeasurementsDataItemHeaterMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        measurements_data_item_heater_measurement = cls(
        ...
        measurements_data_item_heater_measurement.additional_properties = d
        return measurements_data_item_heater_measurement
