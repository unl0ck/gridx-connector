...
if TYPE_CHECKING:
    from ..models.organizational_api_token_user_address import OrganizationalAPITokenUserAddress
    from ..models.organizational_api_token_user_language import OrganizationalAPITokenUserLanguage
    from ..models.organizational_api_token_user_policy_group import OrganizationalAPITokenUserPolicyGroup


T = TypeVar("T", bound="OrganizationalAPITokenUser")


@_attrs_define
class OrganizationalAPITokenUser:
    """
    Attributes:
        ...
        full_name (str | Unset): Full name of the user typically consisting of first name and last name. Example: John
            Doe.
        groups (list[OrganizationalAPITokenUserPolicyGroup] | Unset): Policy groups attached to this user which
            determine the effective permissions through policies.
        main_address (OrganizationalAPITokenUserAddress | Unset): Represents a physical address of a customer.
        language (OrganizationalAPITokenUserLanguage | Unset): The language information of the user.
    """
    ...
    groups: list[OrganizationalAPITokenUserPolicyGroup] | Unset = UNSET
    main_address: OrganizationalAPITokenUserAddress | Unset = UNSET
    language: OrganizationalAPITokenUserLanguage | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _groups is not UNSET:
            ...
            for groups_item_data in _groups:
                groups_item = OrganizationalAPITokenUserPolicyGroup.from_dict(groups_item_data)

                groups.append(groups_item)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: OrganizationalAPITokenUserAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = OrganizationalAPITokenUserAddress.from_dict(_main_address)

        _language = d.pop("language", UNSET)
        language: OrganizationalAPITokenUserLanguage | Unset
        if isinstance(_language, Unset):
            language = UNSET
        else:
            language = OrganizationalAPITokenUserLanguage.from_dict(_language)

        organizational_api_token_user = cls(
            id=id,
        ...
        organizational_api_token_user.additional_properties = d
        return organizational_api_token_user
