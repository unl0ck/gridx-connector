...
T = TypeVar("T", bound="MoveAccountStrict")


@_attrs_define
class MoveAccountStrict:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        move_account_strict = cls(
            target_id=target_id,
        )

        move_account_strict.additional_properties = d
        return move_account_strict
