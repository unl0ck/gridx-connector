...
from ..models.get_user_policies_policy_document_policy_statement_effect import (
    GetUserPoliciesPolicyDocumentPolicyStatementEffect,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetUserPoliciesPolicyDocumentPolicyStatement")


@_attrs_define
class GetUserPoliciesPolicyDocumentPolicyStatement:
    """
    Attributes:
        ...
        action (str): The action that this statement represents. An action is an operation on a resource. Example:
            groups:Create.
        effect (GetUserPoliciesPolicyDocumentPolicyStatementEffect): Whether this statement restricts or grants the
    ...
    name: str
    action: str
    effect: GetUserPoliciesPolicyDocumentPolicyStatementEffect
    fields: str
    resource: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        effect = GetUserPoliciesPolicyDocumentPolicyStatementEffect(d.pop("effect"))
        ...
        get_user_policies_policy_document_policy_statement = cls(
            id=id,
            name=name,
            action=action,
            effect=effect,
        ...
        get_user_policies_policy_document_policy_statement.additional_properties = d
        return get_user_policies_policy_document_policy_statement
