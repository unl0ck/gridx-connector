...
T = TypeVar("T", bound="APITokenCreationStrict")


@_attrs_define
class APITokenCreationStrict:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_token_creation_strict = cls(
            description=description,
            expires_at=expires_at,
        )

        api_token_creation_strict.additional_properties = d
        return api_token_creation_strict
