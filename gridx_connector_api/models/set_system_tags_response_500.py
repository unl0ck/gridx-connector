...
T = TypeVar("T", bound="SetSystemTagsResponse500")


@_attrs_define
class SetSystemTagsResponse500:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_system_tags_response_500 = cls(
            message=message,
            details=details,
        )

        set_system_tags_response_500.additional_properties = d
        return set_system_tags_response_500
