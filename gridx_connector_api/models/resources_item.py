...
if TYPE_CHECKING:
    from ..models.resources_item_data_item_type_0 import ResourcesItemDataItemType0
...
class ResourcesItem:
    ...
    Attributes:
        ...
        data (list[ResourcesItemDataItemType0]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for data_item_data in self.data:
            ...
            if isinstance(data_item_data, ResourcesItemDataItemType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            ...
            def _parse_data_item(data: object) -> ResourcesItemDataItemType0:
                if not isinstance(data, dict):
                    raise TypeError()
                data_item_type_0 = ResourcesItemDataItemType0.from_dict(data)
