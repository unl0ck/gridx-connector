...
from ..models.abstract_power_sequence_state import AbstractPowerSequenceState
from ..models.abstract_power_sequence_value_source import AbstractPowerSequenceValueSource
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.abstract_power_sequence_power_time_slots_item import AbstractPowerSequencePowerTimeSlotsItem


T = TypeVar("T", bound="AbstractPowerSequence")


@_attrs_define
class AbstractPowerSequence:
    """
    Attributes:
        sequence_id (int | Unset): Identifier of power sequence, must be unique in path. Example: 1.
        state (AbstractPowerSequenceState | Unset): EEBUS FSWG-025. See section 3.2.1.2.2.1.1.4 Example: scheduled.
        ...
        is_stoppable (bool | Unset): If the sequence can be stopped by the CEM, this element SHALL be present and set to
            ...
            For more details, see EEBUS FSWG-027.
             Default: False.
        value_source (AbstractPowerSequenceValueSource | Unset): If not set, the source of forecasted values is
            undefined.
        task_identifier (int | Unset): Identifier of the task.
        power_time_slots (list[AbstractPowerSequencePowerTimeSlotsItem] | Unset): List of power time slots for a power
            sequence. See EEBUS FSWG-060.
    """

    sequence_id: int | Unset = UNSET
    state: AbstractPowerSequenceState | Unset = UNSET
    ...
    value_source: AbstractPowerSequenceValueSource | Unset = UNSET
    task_identifier: int | Unset = UNSET
    power_time_slots: list[AbstractPowerSequencePowerTimeSlotsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        state: AbstractPowerSequenceState | Unset
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = AbstractPowerSequenceState(_state)
        ...
        value_source: AbstractPowerSequenceValueSource | Unset
        if isinstance(_value_source, Unset):
            value_source = UNSET
        else:
            value_source = AbstractPowerSequenceValueSource(_value_source)
        ...
        if _power_time_slots is not UNSET:
            ...
            for power_time_slots_item_data in _power_time_slots:
                power_time_slots_item = AbstractPowerSequencePowerTimeSlotsItem.from_dict(power_time_slots_item_data)

                power_time_slots.append(power_time_slots_item)

        abstract_power_sequence = cls(
        ...
        abstract_power_sequence.additional_properties = d
        return abstract_power_sequence
