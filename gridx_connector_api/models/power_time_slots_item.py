...
T = TypeVar("T", bound="PowerTimeSlotsItem")


@_attrs_define
class PowerTimeSlotsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        power_time_slots_item.additional_properties = d
        return power_time_slots_item
