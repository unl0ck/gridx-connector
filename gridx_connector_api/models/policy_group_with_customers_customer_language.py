...
T = TypeVar("T", bound="PolicyGroupWithCustomersCustomerLanguage")


@_attrs_define
class PolicyGroupWithCustomersCustomerLanguage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        policy_group_with_customers_customer_language = cls(
            tag=tag,
            name=name,
            name_native=name_native,
        )

        policy_group_with_customers_customer_language.additional_properties = d
        return policy_group_with_customers_customer_language
