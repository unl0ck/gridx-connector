...
from ..models.ev_charging_station_configuration_charge_mode import EVChargingStationConfigurationChargeMode
from ..types import UNSET, Unset

T = TypeVar("T", bound="EVChargingStationConfiguration")


@_attrs_define
class EVChargingStationConfiguration:
    """Configure the charge mode and other settings considered by the EMS and applied to the EV charging station.
    ...
    Attributes:
        ...
        charging_enabled (bool | None | Unset): Specifies whether charging is allowed.
        charging_remote_controllable (bool | None | Unset): Specifies whether charging may be controlled via network
            connection.
        lock_enabled (bool | None | Unset): Specifies whether the plug is locked.
        min_requested_soc (float | None | Unset): The minimum SoC the EV shall have and keep to guarantee the range for
            the next usage.
            ...
            Value is between 0.0 - 100.0 in %.
             Example: 30.
        departure_timestamp (datetime.datetime | None | Unset): The departure time of the EV for the `DEPARTURE_TIME_EV`
            charge mode.
        ...
        user_soc (float | None | Unset): The State of Charge (SoC) level read and set by the user for the connected EV.

            This is needed in cases where the SoC cannot be determined automatically.
            Value is between 0.0 - 100.0 in %.
             Example: 50.
        user_total_capacity (float | None | Unset): The size of the EV's battery in Wh.
            ...
            The value is needed to calculate the energy that needs to be charged to fulfill the `minRequestedSoc`.
             Example: 82000.
        charge_mode (EVChargingStationConfigurationChargeMode | Unset): Defines how the EV shall be charged.
        ...
        max_power_calculated (float | None | Unset): The maximum potential total charge power in Watt is calculated by
            ...
            It considers the maximum power supported by the EV and that the power can be curtailed by the DLM.
             Example: 8000.
        max_charge_power (float | None | Unset): The maximum total power that the EV should be charged with in Watt.

            The total power is defined as sum of all phases' power.
            EV charging power will not exceed the specified value.
             Example: 8000.
        min_charge_power (float | None | Unset): The minimum total power that the EV should be charged with in Watt.
    ...
    charging_enabled: bool | None | Unset = UNSET
    charging_remote_controllable: bool | None | Unset = UNSET
    lock_enabled: bool | None | Unset = UNSET
    min_requested_soc: float | None | Unset = UNSET
    departure_timestamp: datetime.datetime | None | Unset = UNSET
    estimated_departure_timestamp: datetime.datetime | Unset = UNSET
    user_soc: float | None | Unset = UNSET
    user_total_capacity: float | None | Unset = UNSET
    charge_mode: EVChargingStationConfigurationChargeMode | Unset = UNSET
    max_power_calculated: float | None | Unset = UNSET
    max_charge_power: float | None | Unset = UNSET
    min_charge_power: float | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        charging_enabled: bool | None | Unset
        if isinstance(self.charging_enabled, Unset):
            charging_enabled = UNSET
        else:
            charging_enabled = self.charging_enabled

        charging_remote_controllable: bool | None | Unset
        if isinstance(self.charging_remote_controllable, Unset):
            charging_remote_controllable = UNSET
        else:
            charging_remote_controllable = self.charging_remote_controllable

        lock_enabled: bool | None | Unset
        if isinstance(self.lock_enabled, Unset):
            lock_enabled = UNSET
        else:
            lock_enabled = self.lock_enabled

        min_requested_soc: float | None | Unset
        if isinstance(self.min_requested_soc, Unset):
            min_requested_soc = UNSET
        else:
            min_requested_soc = self.min_requested_soc

        departure_timestamp: None | str | Unset
        if isinstance(self.departure_timestamp, Unset):
            departure_timestamp = UNSET
        elif isinstance(self.departure_timestamp, datetime.datetime):
        ...
        user_soc: float | None | Unset
        if isinstance(self.user_soc, Unset):
            user_soc = UNSET
        else:
            user_soc = self.user_soc

        user_total_capacity: float | None | Unset
        if isinstance(self.user_total_capacity, Unset):
            user_total_capacity = UNSET
        else:
        ...
        max_power_calculated: float | None | Unset
        if isinstance(self.max_power_calculated, Unset):
            max_power_calculated = UNSET
        else:
        ...
        min_charge_power: float | None | Unset
        if isinstance(self.min_charge_power, Unset):
            min_charge_power = UNSET
        else:
        ...
        if charging_enabled is not UNSET:
            field_dict["chargingEnabled"] = charging_enabled
        if charging_remote_controllable is not UNSET:
            field_dict["chargingRemoteControllable"] = charging_remote_controllable
        if lock_enabled is not UNSET:
            field_dict["lockEnabled"] = lock_enabled
        if min_requested_soc is not UNSET:
            field_dict["minRequestedSoc"] = min_requested_soc
        if departure_timestamp is not UNSET:
            field_dict["departureTimestamp"] = departure_timestamp
        ...
        if user_total_capacity is not UNSET:
            field_dict["userTotalCapacity"] = user_total_capacity
        if charge_mode is not UNSET:
            field_dict["chargeMode"] = charge_mode
        if max_power_calculated is not UNSET:
            field_dict["maxPowerCalculated"] = max_power_calculated
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_charging_enabled(data: object) -> bool | None | Unset:
            if data is None:
                return data
        ...
        charging_enabled = _parse_charging_enabled(d.pop("chargingEnabled", UNSET))

        def _parse_charging_remote_controllable(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        charging_remote_controllable = _parse_charging_remote_controllable(d.pop("chargingRemoteControllable", UNSET))

        def _parse_lock_enabled(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        lock_enabled = _parse_lock_enabled(d.pop("lockEnabled", UNSET))

        def _parse_min_requested_soc(data: object) -> float | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        min_requested_soc = _parse_min_requested_soc(d.pop("minRequestedSoc", UNSET))

        def _parse_departure_timestamp(data: object) -> datetime.datetime | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        departure_timestamp = _parse_departure_timestamp(d.pop("departureTimestamp", UNSET))
        ...
        def _parse_user_soc(data: object) -> float | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        user_soc = _parse_user_soc(d.pop("userSoc", UNSET))

        def _parse_user_total_capacity(data: object) -> float | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        user_total_capacity = _parse_user_total_capacity(d.pop("userTotalCapacity", UNSET))

        _charge_mode = d.pop("chargeMode", UNSET)
        charge_mode: EVChargingStationConfigurationChargeMode | Unset
        if isinstance(_charge_mode, Unset):
            charge_mode = UNSET
        else:
            charge_mode = EVChargingStationConfigurationChargeMode(_charge_mode)

        def _parse_max_power_calculated(data: object) -> float | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        max_power_calculated = _parse_max_power_calculated(d.pop("maxPowerCalculated", UNSET))
        ...
        def _parse_min_charge_power(data: object) -> float | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        min_charge_power = _parse_min_charge_power(d.pop("minChargePower", UNSET))
        ...
        ev_charging_station_configuration = cls(
        ...
        ev_charging_station_configuration.additional_properties = d
        return ev_charging_station_configuration
