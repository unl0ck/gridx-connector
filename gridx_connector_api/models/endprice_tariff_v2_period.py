...
T = TypeVar("T", bound="EndpriceTariffV2Period")


@_attrs_define
class EndpriceTariffV2Period:
    """
    Attributes:
        ...
        offtake_price (float): Price including offset, VAT and provider fee per kWh for consumed energy in the period
            [from, to). Example: 0.4.
        market_price (float | None): Raw market price (Day-Ahead EPEX Spot price with 60min resolution) per kWh at the
            time of this period in the bidding zone of the system.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_market_price(data: object) -> float | None:
            if data is None:
                return data
            return cast(float | None, data)

        market_price = _parse_market_price(d.pop("marketPrice"))

        endprice_tariff_v2_period = cls(
            from_=from_,
            to=to,
        ...
        endprice_tariff_v2_period.additional_properties = d
        return endprice_tariff_v2_period
