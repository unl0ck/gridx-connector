...
T = TypeVar("T", bound="SetSystemTagResponse200")


@_attrs_define
class SetSystemTagResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_system_tag_response_200 = cls(
            name=name,
            value=value,
        ...
        set_system_tag_response_200.additional_properties = d
        return set_system_tag_response_200
