...
T = TypeVar("T", bound="EvLoadManagementParameters")


@_attrs_define
class EvLoadManagementParameters:
    ...
    **Deprecated** - Use the system's EV charging station configuration instead.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ev_load_management_parameters = cls(
            enabled=enabled,
            max_power=max_power,
        )

        ev_load_management_parameters.additional_properties = d
        return ev_load_management_parameters
