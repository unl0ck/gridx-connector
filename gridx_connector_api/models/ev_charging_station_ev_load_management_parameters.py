...
T = TypeVar("T", bound="EVChargingStationEvLoadManagementParameters")


@_attrs_define
class EVChargingStationEvLoadManagementParameters:
    ...
    **Deprecated** - Use the system's EV charging station configuration instead.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ev_charging_station_ev_load_management_parameters = cls(
            enabled=enabled,
            max_power=max_power,
        )

        ev_charging_station_ev_load_management_parameters.additional_properties = d
        return ev_charging_station_ev_load_management_parameters
