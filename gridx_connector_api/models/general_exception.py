...
T = TypeVar("T", bound="GeneralException")


@_attrs_define
class GeneralException:
    """Represents a general error structure returned by our REST API.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        general_exception = cls(
            message=message,
            details=details,
        )

        general_exception.additional_properties = d
