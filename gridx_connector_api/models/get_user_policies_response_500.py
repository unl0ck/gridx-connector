...
T = TypeVar("T", bound="GetUserPoliciesResponse500")


@_attrs_define
class GetUserPoliciesResponse500:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_policies_response_500 = cls(
            message=message,
            details=details,
        )

        get_user_policies_response_500.additional_properties = d
        return get_user_policies_response_500
