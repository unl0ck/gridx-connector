...
from ..models.get_systems_system_id_timeofuse_status_current_response_200_status_error_code import (
    GetSystemsSystemIDTimeofuseStatusCurrentResponse200StatusErrorCode,
)
from ..models.get_systems_system_id_timeofuse_status_current_response_200_status_status import (
    GetSystemsSystemIDTimeofuseStatusCurrentResponse200StatusStatus,
)
from ..models.get_systems_system_id_timeofuse_status_current_response_200_status_warnings_item import (
    GetSystemsSystemIDTimeofuseStatusCurrentResponse200StatusWarningsItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSystemsSystemIDTimeofuseStatusCurrentResponse200Status")


@_attrs_define
class GetSystemsSystemIDTimeofuseStatusCurrentResponse200Status:
    """
    Attributes:
        ...
        status (GetSystemsSystemIDTimeofuseStatusCurrentResponse200StatusStatus | Unset): Operational status of Time-of-
            ...
            * `INITIALIZING` - Time-of-Use optimization is initializing, it may take up to 48h.
             Example: ONLINE.
        error_code (GetSystemsSystemIDTimeofuseStatusCurrentResponse200StatusErrorCode | Unset): Most recent error
            causing a failure of Time-of-Use specific run.
        ...
        warnings (list[GetSystemsSystemIDTimeofuseStatusCurrentResponse200StatusWarningsItem] | Unset): All the relevant
            warnings that occurred during a Time-of-Use specific run.
    ...
    status: GetSystemsSystemIDTimeofuseStatusCurrentResponse200StatusStatus | Unset = UNSET
    error_code: GetSystemsSystemIDTimeofuseStatusCurrentResponse200StatusErrorCode | Unset = UNSET
    warnings: list[GetSystemsSystemIDTimeofuseStatusCurrentResponse200StatusWarningsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: GetSystemsSystemIDTimeofuseStatusCurrentResponse200StatusStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = GetSystemsSystemIDTimeofuseStatusCurrentResponse200StatusStatus(_status)

        _error_code = d.pop("error_code", UNSET)
        error_code: GetSystemsSystemIDTimeofuseStatusCurrentResponse200StatusErrorCode | Unset
        if isinstance(_error_code, Unset):
            error_code = UNSET
        else:
            error_code = GetSystemsSystemIDTimeofuseStatusCurrentResponse200StatusErrorCode(_error_code)
        ...
        if _warnings is not UNSET:
            ...
            for warnings_item_data in _warnings:
                warnings_item = GetSystemsSystemIDTimeofuseStatusCurrentResponse200StatusWarningsItem(
                    warnings_item_data
                )

                warnings.append(warnings_item)

        get_systems_system_id_timeofuse_status_current_response_200_status = cls(
            from_=from_,
            to=to,
            status=status,
        ...
        get_systems_system_id_timeofuse_status_current_response_200_status.additional_properties = d
        return get_systems_system_id_timeofuse_status_current_response_200_status
