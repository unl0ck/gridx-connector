...
T = TypeVar("T", bound="GetSystemsSystemIDTimeofuseForecastsMeterResponse200PeriodsItem")


@_attrs_define
class GetSystemsSystemIDTimeofuseForecastsMeterResponse200PeriodsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_system_id_timeofuse_forecasts_meter_response_200_periods_item = cls(
            from_=from_,
            to=to,
        ...
        get_systems_system_id_timeofuse_forecasts_meter_response_200_periods_item.additional_properties = d
        return get_systems_system_id_timeofuse_forecasts_meter_response_200_periods_item
