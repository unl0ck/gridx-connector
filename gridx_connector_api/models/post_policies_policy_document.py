...
if TYPE_CHECKING:
    from ..models.post_policies_policy_document_policy_statement import PostPoliciesPolicyDocumentPolicyStatement


T = TypeVar("T", bound="PostPoliciesPolicyDocument")


@_attrs_define
class PostPoliciesPolicyDocument:
    """
    Attributes:
        ...
        statements (list[PostPoliciesPolicyDocumentPolicyStatement]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for statements_item_data in _statements:
            statements_item = PostPoliciesPolicyDocumentPolicyStatement.from_dict(statements_item_data)

            statements.append(statements_item)

        post_policies_policy_document = cls(
            name=name,
            version=version,
            id=id,
        ...
        post_policies_policy_document.additional_properties = d
        return post_policies_policy_document
