...
T = TypeVar("T", bound="GetUserResponse200Address")


@_attrs_define
class GetUserResponse200Address:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_response_200_address = cls(
            city=city,
            country=country,
        ...
        get_user_response_200_address.additional_properties = d
        return get_user_response_200_address
