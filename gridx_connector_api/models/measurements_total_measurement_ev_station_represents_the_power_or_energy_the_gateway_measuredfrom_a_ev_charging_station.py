...
from ..models.measurements_total_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station_plug_state import (
    MeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState,
)
from ..types import UNSET, Unset

T = TypeVar(
    "T", bound="MeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation"
)


@_attrs_define
class MeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation:
    """
    Attributes:
        ...
        plug_state (MeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStat
            ionPlugState | Unset): Defines whether this EV is currently plugged in the charging station and whether it's
            charging. Default: MeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvCharg
            ingStationPlugState.UNPLUGGED.
    ...
    plug_state: (
        MeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState
        | Unset
    ) = MeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState.UNPLUGGED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_plug_state, Unset):
            ...
            plug_state = MeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState(
                _plug_state
            )
        ...
        measurements_total_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station = cls(
        ...
        measurements_total_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station.additional_properties = d
        return measurements_total_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station
