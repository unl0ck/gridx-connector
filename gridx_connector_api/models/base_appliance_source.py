...
from ..models.base_appliance_source_origin import BaseApplianceSourceOrigin
from ..types import UNSET, Unset

T = TypeVar("T", bound="BaseApplianceSource")


@_attrs_define
class BaseApplianceSource:
    """
    Attributes:
        origin (BaseApplianceSourceOrigin): Specifies who created the appliance. This can be one of:
    ...
    origin: BaseApplianceSourceOrigin
    uri: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        origin = BaseApplianceSourceOrigin(d.pop("origin"))

        uri = d.pop("uri", UNSET)

        base_appliance_source = cls(
            origin=origin,
            uri=uri,
        )

        base_appliance_source.additional_properties = d
        return base_appliance_source
