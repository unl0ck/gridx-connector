...
T = TypeVar("T", bound="SetSystemTagResponse404")


@_attrs_define
class SetSystemTagResponse404:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_system_tag_response_404 = cls(
            message=message,
            details=details,
        )

        set_system_tag_response_404.additional_properties = d
        return set_system_tag_response_404
