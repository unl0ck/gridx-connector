...
if TYPE_CHECKING:
    from ..models.battery_information_control_settings import BatteryInformationControlSettings


T = TypeVar("T", bound="BatteryInformation")
...
class BatteryInformation:
    ...
    Attributes:
        ...
        control_settings (BatteryInformationControlSettings | Unset): Indicates the currently desired control settings
            for the battery.
    """
    ...
    control_settings: BatteryInformationControlSettings | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        control_settings: BatteryInformationControlSettings | Unset
        if isinstance(_control_settings, Unset):
            control_settings = UNSET
        else:
            control_settings = BatteryInformationControlSettings.from_dict(_control_settings)

        battery_information = cls(
        ...
        battery_information.additional_properties = d
