...
from ..models.get_systems_system_id_timeofuse_status_response_200_periods_item_error_code import (
    GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItemErrorCode,
)
from ..models.get_systems_system_id_timeofuse_status_response_200_periods_item_status import (
    GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItemStatus,
)
from ..models.get_systems_system_id_timeofuse_status_response_200_periods_item_warnings_item import (
    GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItemWarningsItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItem")


@_attrs_define
class GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItem:
    """
    Attributes:
        ...
        status (GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItemStatus | Unset): Operational status of Time-of-
            ...
            * `INITIALIZING` - Time-of-Use optimization is initializing, it may take up to 48h.
             Example: ONLINE.
        error_code (GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItemErrorCode | Unset): Most recent error causing
            a failure of Time-of-Use specific run.
        ...
        warnings (list[GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItemWarningsItem] | Unset): All the relevant
    ...
    status: GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItemStatus | Unset = UNSET
    error_code: GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItemErrorCode | Unset = UNSET
    warnings: list[GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItemWarningsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItemStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItemStatus(_status)

        _error_code = d.pop("error_code", UNSET)
        error_code: GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItemErrorCode | Unset
        if isinstance(_error_code, Unset):
            error_code = UNSET
        else:
            error_code = GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItemErrorCode(_error_code)
        ...
        if _warnings is not UNSET:
            ...
            for warnings_item_data in _warnings:
                warnings_item = GetSystemsSystemIDTimeofuseStatusResponse200PeriodsItemWarningsItem(warnings_item_data)

                warnings.append(warnings_item)

        get_systems_system_id_timeofuse_status_response_200_periods_item = cls(
            from_=from_,
            to=to,
            status=status,
        ...
        get_systems_system_id_timeofuse_status_response_200_periods_item.additional_properties = d
        return get_systems_system_id_timeofuse_status_response_200_periods_item
