...
T = TypeVar("T", bound="PostUserTokensBody")


@_attrs_define
class PostUserTokensBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_user_tokens_body = cls(
            description=description,
            expires_at=expires_at,
        )

        post_user_tokens_body.additional_properties = d
        return post_user_tokens_body
