...
T = TypeVar("T", bound="SetSystemTagsResponse200Item")


@_attrs_define
class SetSystemTagsResponse200Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_system_tags_response_200_item = cls(
            name=name,
            value=value,
        ...
        set_system_tags_response_200_item.additional_properties = d
        return set_system_tags_response_200_item
