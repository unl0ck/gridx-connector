...
T = TypeVar("T", bound="PersonalAPITokenWithSecret")


@_attrs_define
class PersonalAPITokenWithSecret:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        personal_api_token_with_secret = cls(
            token=token,
        )

        personal_api_token_with_secret.additional_properties = d
        return personal_api_token_with_secret
