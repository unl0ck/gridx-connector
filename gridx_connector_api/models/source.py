...
from ..models.source_origin import SourceOrigin
...
class Source:
    """
    Attributes:
        origin (SourceOrigin): Specifies who created the appliance. This can be one of:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        origin = SourceOrigin(d.pop("origin"))
