...
from ..models.device_bindings_item_type import DeviceBindingsItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeviceBindingsItem")


@_attrs_define
class DeviceBindingsItem:
    """
    Attributes:
        type_ (DeviceBindingsItemType): The resource type for which the binding is created. Example: powerSequence.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = DeviceBindingsItemType(d.pop("type"))
        ...
        device_bindings_item.additional_properties = d
        return device_bindings_item
