...
from ..models.run_statuses_item_error_code import RunStatusesItemErrorCode
from ..models.run_statuses_item_status import RunStatusesItemStatus
from ..models.run_statuses_item_warnings_item import RunStatusesItemWarningsItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="RunStatusesItem")


@_attrs_define
class RunStatusesItem:
    """
    Attributes:
        ...
        status (RunStatusesItemStatus | Unset): Operational status of Time-of-Use for a specific run.
            ...
            * `INITIALIZING` - Time-of-Use optimization is initializing, it may take up to 48h.
             Example: ONLINE.
        error_code (RunStatusesItemErrorCode | Unset): Most recent error causing a failure of Time-of-Use specific run.
        ...
        warnings (list[RunStatusesItemWarningsItem] | Unset): All the relevant warnings that occurred during a Time-of-
            Use specific run.
    ...
    status: RunStatusesItemStatus | Unset = UNSET
    error_code: RunStatusesItemErrorCode | Unset = UNSET
    warnings: list[RunStatusesItemWarningsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: RunStatusesItemStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = RunStatusesItemStatus(_status)

        _error_code = d.pop("error_code", UNSET)
        error_code: RunStatusesItemErrorCode | Unset
        if isinstance(_error_code, Unset):
            error_code = UNSET
        else:
            error_code = RunStatusesItemErrorCode(_error_code)
        ...
        if _warnings is not UNSET:
            ...
            for warnings_item_data in _warnings:
                warnings_item = RunStatusesItemWarningsItem(warnings_item_data)

                warnings.append(warnings_item)

        run_statuses_item = cls(
            from_=from_,
            to=to,
            status=status,
        ...
        run_statuses_item.additional_properties = d
        return run_statuses_item
