...
T = TypeVar("T", bound="PatchAccountTokensTokenIDOrganizationalAPITokenUserPolicyGroup")


@_attrs_define
class PatchAccountTokensTokenIDOrganizationalAPITokenUserPolicyGroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_account_tokens_token_id_organizational_api_token_user_policy_group = cls(
            name=name,
            id=id,
        ...
        patch_account_tokens_token_id_organizational_api_token_user_policy_group.additional_properties = d
        return patch_account_tokens_token_id_organizational_api_token_user_policy_group
