...
T = TypeVar("T", bound="PatchSystemsSystemIDTimeofuseSettingsBody")


@_attrs_define
class PatchSystemsSystemIDTimeofuseSettingsBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_systems_system_id_timeofuse_settings_body = cls(
            enabled=enabled,
        ...
        patch_systems_system_id_timeofuse_settings_body.additional_properties = d
        return patch_systems_system_id_timeofuse_settings_body
