...
if TYPE_CHECKING:
    from ..models.get_account_tokens_token_id_organizational_api_token_user_address import (
        GetAccountTokensTokenIDOrganizationalAPITokenUserAddress,
    )
    from ..models.get_account_tokens_token_id_organizational_api_token_user_language import (
        GetAccountTokensTokenIDOrganizationalAPITokenUserLanguage,
    )
    from ..models.get_account_tokens_token_id_organizational_api_token_user_policy_group import (
        GetAccountTokensTokenIDOrganizationalAPITokenUserPolicyGroup,
    )


T = TypeVar("T", bound="GetAccountTokensTokenIDOrganizationalAPITokenUser")


@_attrs_define
class GetAccountTokensTokenIDOrganizationalAPITokenUser:
    """
    Attributes:
        ...
        full_name (str | Unset): Full name of the user typically consisting of first name and last name. Example: John
            Doe.
        groups (list[GetAccountTokensTokenIDOrganizationalAPITokenUserPolicyGroup] | Unset): Policy groups attached to
            this user which determine the effective permissions through policies.
        main_address (GetAccountTokensTokenIDOrganizationalAPITokenUserAddress | Unset): Represents a physical address
            of a customer.
        language (GetAccountTokensTokenIDOrganizationalAPITokenUserLanguage | Unset): The language information of the
            user.
    """
    ...
    groups: list[GetAccountTokensTokenIDOrganizationalAPITokenUserPolicyGroup] | Unset = UNSET
    main_address: GetAccountTokensTokenIDOrganizationalAPITokenUserAddress | Unset = UNSET
    language: GetAccountTokensTokenIDOrganizationalAPITokenUserLanguage | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _groups is not UNSET:
            ...
            for groups_item_data in _groups:
                groups_item = GetAccountTokensTokenIDOrganizationalAPITokenUserPolicyGroup.from_dict(groups_item_data)

                groups.append(groups_item)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: GetAccountTokensTokenIDOrganizationalAPITokenUserAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = GetAccountTokensTokenIDOrganizationalAPITokenUserAddress.from_dict(_main_address)

        _language = d.pop("language", UNSET)
        language: GetAccountTokensTokenIDOrganizationalAPITokenUserLanguage | Unset
        if isinstance(_language, Unset):
            language = UNSET
        else:
            language = GetAccountTokensTokenIDOrganizationalAPITokenUserLanguage.from_dict(_language)

        get_account_tokens_token_id_organizational_api_token_user = cls(
            id=id,
        ...
        get_account_tokens_token_id_organizational_api_token_user.additional_properties = d
        return get_account_tokens_token_id_organizational_api_token_user
