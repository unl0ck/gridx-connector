...
from ..models.appliance_update_io_device_information_type import ApplianceUpdateIODeviceInformationType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.appliance_update_io_device_information_io_device_input_channel import (
        ApplianceUpdateIODeviceInformationIODeviceInputChannel,
    )
    from ..models.appliance_update_io_device_information_io_device_output_channel import (
        ApplianceUpdateIODeviceInformationIODeviceOutputChannel,
    )


T = TypeVar("T", bound="ApplianceUpdateIODeviceInformation")


@_attrs_define
class ApplianceUpdateIODeviceInformation:
    """The io device specific information.

    Attributes:
        type_ (ApplianceUpdateIODeviceInformationType | Unset): Describes the specific type of the device.
        ...
        out_channels_count (int | Unset): The number of output ports on the device, real physical ports you can connect
            a cable to.
        input_channels (list[ApplianceUpdateIODeviceInformationIODeviceInputChannel] | Unset): Input channels of the
            fieldbus coupler, containing actions.
        output_channels (list[ApplianceUpdateIODeviceInformationIODeviceOutputChannel] | Unset): Output channels of the
    ...
    type_: ApplianceUpdateIODeviceInformationType | Unset = UNSET
    in_channels_count: int | Unset = UNSET
    out_channels_count: int | Unset = UNSET
    input_channels: list[ApplianceUpdateIODeviceInformationIODeviceInputChannel] | Unset = UNSET
    output_channels: list[ApplianceUpdateIODeviceInformationIODeviceOutputChannel] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: ApplianceUpdateIODeviceInformationType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = ApplianceUpdateIODeviceInformationType(_type_)
        ...
        if _input_channels is not UNSET:
            ...
            for input_channels_item_data in _input_channels:
                input_channels_item = ApplianceUpdateIODeviceInformationIODeviceInputChannel.from_dict(
        ...
        if _output_channels is not UNSET:
            ...
            for output_channels_item_data in _output_channels:
                output_channels_item = ApplianceUpdateIODeviceInformationIODeviceOutputChannel.from_dict(
                    output_channels_item_data
                )

                output_channels.append(output_channels_item)

        appliance_update_io_device_information = cls(
            type_=type_,
        ...
        appliance_update_io_device_information.additional_properties = d
        return appliance_update_io_device_information
