...
T = TypeVar("T", bound="GetAccountTokensOrganizationalAPITokenUserPolicyGroup")


@_attrs_define
class GetAccountTokensOrganizationalAPITokenUserPolicyGroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_account_tokens_organizational_api_token_user_policy_group = cls(
            name=name,
            id=id,
        ...
        get_account_tokens_organizational_api_token_user_policy_group.additional_properties = d
        return get_account_tokens_organizational_api_token_user_policy_group
