...
T = TypeVar("T", bound="GetSystemsSystemIDTimeofuseKpiResponse200PeriodsItem")


@_attrs_define
class GetSystemsSystemIDTimeofuseKpiResponse200PeriodsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_system_id_timeofuse_kpi_response_200_periods_item = cls(
            from_=from_,
            to=to,
            tou_cost=tou_cost,
        ...
        get_systems_system_id_timeofuse_kpi_response_200_periods_item.additional_properties = d
        return get_systems_system_id_timeofuse_kpi_response_200_periods_item
