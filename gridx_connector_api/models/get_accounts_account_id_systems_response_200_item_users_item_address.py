...
T = TypeVar("T", bound="GetAccountsAccountIDSystemsResponse200ItemUsersItemAddress")


@_attrs_define
class GetAccountsAccountIDSystemsResponse200ItemUsersItemAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_accounts_account_id_systems_response_200_item_users_item_address = cls(
            city=city,
            country=country,
        ...
        get_accounts_account_id_systems_response_200_item_users_item_address.additional_properties = d
        return get_accounts_account_id_systems_response_200_item_users_item_address
