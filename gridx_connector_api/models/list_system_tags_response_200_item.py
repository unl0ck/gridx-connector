...
T = TypeVar("T", bound="ListSystemTagsResponse200Item")


@_attrs_define
class ListSystemTagsResponse200Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_system_tags_response_200_item = cls(
            name=name,
            value=value,
        ...
        list_system_tags_response_200_item.additional_properties = d
        return list_system_tags_response_200_item
