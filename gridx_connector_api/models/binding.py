...
from ..models.binding_type import BindingType
from ..types import UNSET, Unset

T = TypeVar("T", bound="Binding")
...
class Binding:
    """
    Attributes:
        type_ (BindingType): The resource type for which the binding is created. Example: powerSequence.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        binding.additional_properties = d
        return binding
