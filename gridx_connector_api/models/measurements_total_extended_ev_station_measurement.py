...
T = TypeVar("T", bound="MeasurementsTotalExtendedEVStationMeasurement")


@_attrs_define
class MeasurementsTotalExtendedEVStationMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        measurements_total_extended_ev_station_measurement = cls(
            charge=charge,
            discharge=discharge,
        ...
        measurements_total_extended_ev_station_measurement.additional_properties = d
        return measurements_total_extended_ev_station_measurement
