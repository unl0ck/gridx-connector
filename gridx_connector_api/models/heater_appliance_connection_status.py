...
from ..models.heater_appliance_connection_status_status import HeaterApplianceConnectionStatusStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="HeaterApplianceConnectionStatus")


@_attrs_define
class HeaterApplianceConnectionStatus:
    """
    Attributes:
        status (HeaterApplianceConnectionStatusStatus): Indicates the connection status of an appliance.
    ...
    status: HeaterApplianceConnectionStatusStatus
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = HeaterApplianceConnectionStatusStatus(d.pop("status"))
        ...
        heater_appliance_connection_status = cls(
            status=status,
            contacted_at=contacted_at,
        )

        heater_appliance_connection_status.additional_properties = d
        return heater_appliance_connection_status
