...
T = TypeVar("T", bound="ExtendedMeasurementAdditionalMeterAppliances")


@_attrs_define
class ExtendedMeasurementAdditionalMeterAppliances:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        extended_measurement_additional_meter_appliances = cls(
            appliance_id=appliance_id,
            power=power,
            kind=kind,
        )

        extended_measurement_additional_meter_appliances.additional_properties = d
        return extended_measurement_additional_meter_appliances
