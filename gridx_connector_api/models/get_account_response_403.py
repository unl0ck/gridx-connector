...
T = TypeVar("T", bound="GetAccountResponse403")


@_attrs_define
class GetAccountResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_account_response_403 = cls(
            message=message,
            details=details,
        )

        get_account_response_403.additional_properties = d
        return get_account_response_403
