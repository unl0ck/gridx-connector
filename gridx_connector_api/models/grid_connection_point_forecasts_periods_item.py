...
T = TypeVar("T", bound="GridConnectionPointForecastsPeriodsItem")


@_attrs_define
class GridConnectionPointForecastsPeriodsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grid_connection_point_forecasts_periods_item = cls(
            from_=from_,
            to=to,
        ...
        grid_connection_point_forecasts_periods_item.additional_properties = d
        return grid_connection_point_forecasts_periods_item
