...
from ..models.import_power_limit_number_of_phases import ImportPowerLimitNumberOfPhases
from ..types import UNSET, Unset

T = TypeVar("T", bound="ImportPowerLimit")


@_attrs_define
class ImportPowerLimit:
    """
    Attributes:
        number_of_phases (ImportPowerLimitNumberOfPhases | Unset): Number of phases the import power limit is set for. 1
            or 3. Default is 3. Default: ImportPowerLimitNumberOfPhases.VALUE_3. Example: 3.
    ...
    number_of_phases: ImportPowerLimitNumberOfPhases | Unset = ImportPowerLimitNumberOfPhases.VALUE_3
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        number_of_phases: ImportPowerLimitNumberOfPhases | Unset
        if isinstance(_number_of_phases, Unset):
            number_of_phases = UNSET
        else:
            number_of_phases = ImportPowerLimitNumberOfPhases(_number_of_phases)
        ...
        import_power_limit.additional_properties = d
        return import_power_limit
