...
from ..models.meter_appliance_connection_status_status import MeterApplianceConnectionStatusStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="MeterApplianceConnectionStatus")


@_attrs_define
class MeterApplianceConnectionStatus:
    """
    Attributes:
        status (MeterApplianceConnectionStatusStatus): Indicates the connection status of an appliance.
    ...
    status: MeterApplianceConnectionStatusStatus
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = MeterApplianceConnectionStatusStatus(d.pop("status"))
        ...
        meter_appliance_connection_status = cls(
            status=status,
            contacted_at=contacted_at,
        )

        meter_appliance_connection_status.additional_properties = d
        return meter_appliance_connection_status
