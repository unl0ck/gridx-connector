...
T = TypeVar("T", bound="DeleteAccountsAccountIDSystemsAccountAddress")


@_attrs_define
class DeleteAccountsAccountIDSystemsAccountAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_accounts_account_id_systems_account_address = cls(
            city=city,
            country=country,
        ...
        delete_accounts_account_id_systems_account_address.additional_properties = d
        return delete_accounts_account_id_systems_account_address
