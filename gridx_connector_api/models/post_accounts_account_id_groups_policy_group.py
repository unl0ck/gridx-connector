...
T = TypeVar("T", bound="PostAccountsAccountIDGroupsPolicyGroup")


@_attrs_define
class PostAccountsAccountIDGroupsPolicyGroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_accounts_account_id_groups_policy_group = cls(
            name=name,
            id=id,
        ...
        post_accounts_account_id_groups_policy_group.additional_properties = d
        return post_accounts_account_id_groups_policy_group
