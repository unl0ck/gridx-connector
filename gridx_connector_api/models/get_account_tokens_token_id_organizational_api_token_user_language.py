...
T = TypeVar("T", bound="GetAccountTokensTokenIDOrganizationalAPITokenUserLanguage")


@_attrs_define
class GetAccountTokensTokenIDOrganizationalAPITokenUserLanguage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_account_tokens_token_id_organizational_api_token_user_language = cls(
            tag=tag,
            name=name,
            name_native=name_native,
        )

        get_account_tokens_token_id_organizational_api_token_user_language.additional_properties = d
        return get_account_tokens_token_id_organizational_api_token_user_language
