...
from ..models.get_systems_system_id_historical_measurements_total_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station_plug_state import (
...
T = TypeVar(
    "T",
    bound="GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation",
)


@_attrs_define
class GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation:
    """
    Attributes:
        ...
        plug_state (GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewa
            yMeasuredfromAEvChargingStationPlugState | Unset): Defines whether this EV is currently plugged in the charging
            station and whether it's charging. Default: GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementEVStationRep
            resentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState.UNPLUGGED.
    ...
    plug_state: (
        GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState
        | Unset
    ) = GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState.UNPLUGGED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_plug_state, Unset):
            ...
            plug_state = GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState(
                _plug_state
            )
        ...
        get_systems_system_id_historical_measurements_total_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station = cls(
        ...
        get_systems_system_id_historical_measurements_total_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station.additional_properties = d
        return get_systems_system_id_historical_measurements_total_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station
