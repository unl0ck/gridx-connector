...
T = TypeVar("T", bound="PostPoliciesResponse500")


@_attrs_define
class PostPoliciesResponse500:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_policies_response_500 = cls(
            message=message,
            details=details,
        )

        post_policies_response_500.additional_properties = d
        return post_policies_response_500
