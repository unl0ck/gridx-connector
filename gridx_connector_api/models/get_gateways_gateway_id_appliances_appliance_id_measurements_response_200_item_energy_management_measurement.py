...
T = TypeVar(
    "T", bound="GetGatewaysGatewayIDAppliancesApplianceIDMeasurementsResponse200ItemEnergyManagementMeasurement"
)


@_attrs_define
class GetGatewaysGatewayIDAppliancesApplianceIDMeasurementsResponse200ItemEnergyManagementMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_gateways_gateway_id_appliances_appliance_id_measurements_response_200_item_energy_management_measurement = (
            cls(
        ...
        get_gateways_gateway_id_appliances_appliance_id_measurements_response_200_item_energy_management_measurement.additional_properties = d
        return (
            get_gateways_gateway_id_appliances_appliance_id_measurements_response_200_item_energy_management_measurement
        )
