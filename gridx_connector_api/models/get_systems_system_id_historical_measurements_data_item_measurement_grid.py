...
if TYPE_CHECKING:
    from ..models.get_systems_system_id_historical_measurements_data_item_measurement_grid_measurement_grid_meter_reading import (
        GetSystemsSystemIDHistoricalMeasurementsDataItemMeasurementGridMeasurementGridMeterReading,
    )


T = TypeVar("T", bound="GetSystemsSystemIDHistoricalMeasurementsDataItemMeasurementGrid")


@_attrs_define
class GetSystemsSystemIDHistoricalMeasurementsDataItemMeasurementGrid:
    """
    Attributes:
        ...
        meter_reading (GetSystemsSystemIDHistoricalMeasurementsDataItemMeasurementGridMeasurementGridMeterReading |
            Unset):
    """
    ...
    meter_reading: (
        GetSystemsSystemIDHistoricalMeasurementsDataItemMeasurementGridMeasurementGridMeterReading | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meter_reading, Unset):
            ...
            meter_reading = (
                GetSystemsSystemIDHistoricalMeasurementsDataItemMeasurementGridMeasurementGridMeterReading.from_dict(
                    _meter_reading
                )
            )

        get_systems_system_id_historical_measurements_data_item_measurement_grid = cls(
        ...
        get_systems_system_id_historical_measurements_data_item_measurement_grid.additional_properties = d
        return get_systems_system_id_historical_measurements_data_item_measurement_grid
