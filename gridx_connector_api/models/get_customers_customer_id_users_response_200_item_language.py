...
T = TypeVar("T", bound="GetCustomersCustomerIDUsersResponse200ItemLanguage")


@_attrs_define
class GetCustomersCustomerIDUsersResponse200ItemLanguage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_customers_customer_id_users_response_200_item_language = cls(
            tag=tag,
            name=name,
            name_native=name_native,
        )

        get_customers_customer_id_users_response_200_item_language.additional_properties = d
        return get_customers_customer_id_users_response_200_item_language
