...
T = TypeVar("T", bound="GetAccountsAccountIDGroupsGroupIDResponse200CustomerAddress")


@_attrs_define
class GetAccountsAccountIDGroupsGroupIDResponse200CustomerAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_accounts_account_id_groups_group_id_response_200_customer_address = cls(
            city=city,
            country=country,
        ...
        get_accounts_account_id_groups_group_id_response_200_customer_address.additional_properties = d
        return get_accounts_account_id_groups_group_id_response_200_customer_address
