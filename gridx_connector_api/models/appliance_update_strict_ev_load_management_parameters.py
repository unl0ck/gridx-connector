...
T = TypeVar("T", bound="ApplianceUpdateStrictEvLoadManagementParameters")


@_attrs_define
class ApplianceUpdateStrictEvLoadManagementParameters:
    ...
    **Deprecated** - Use the system's EV charging station configuration instead.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appliance_update_strict_ev_load_management_parameters = cls(
            enabled=enabled,
            max_power=max_power,
        )

        appliance_update_strict_ev_load_management_parameters.additional_properties = d
        return appliance_update_strict_ev_load_management_parameters
