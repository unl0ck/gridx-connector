...
if TYPE_CHECKING:
    from ..models.measurements_total_additional_meter_appliances import MeasurementsTotalAdditionalMeterAppliances
    from ..models.measurements_total_battery_measurement import MeasurementsTotalBatteryMeasurement
    from ..models.measurements_total_extended_battery_measurement import MeasurementsTotalExtendedBatteryMeasurement
    from ..models.measurements_total_extended_ev_station_measurement import (
        MeasurementsTotalExtendedEVStationMeasurement,
    )
    from ..models.measurements_total_heater_measurement import MeasurementsTotalHeaterMeasurement
    from ..models.measurements_total_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station import (
        MeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation,
    )
    from ..models.measurements_total_measurement_grid import MeasurementsTotalMeasurementGrid


T = TypeVar("T", bound="MeasurementsTotal")


@_attrs_define
class MeasurementsTotal:
    """
    Attributes:
        ...
        batteries (list[MeasurementsTotalBatteryMeasurement] | Unset):
        ...
        ev_charging_stations
            (list[MeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation] |
            Unset):
        ...
        heaters (list[MeasurementsTotalHeaterMeasurement] | Unset): Heating measurement for all heaters that are part of
            the system.
        appliance_power (float | Unset): AppliancePower is power of the appliances with misc location.
        appliances (list[MeasurementsTotalAdditionalMeterAppliances] | Unset):
        ...
        fuse_protection_count (int | Unset): Number of times the fuse was protected, based on the curtailed power over
            all phases.
        grid (MeasurementsTotalMeasurementGrid | Unset):
        battery (MeasurementsTotalExtendedBatteryMeasurement | Unset):
        ev_charging_station (MeasurementsTotalExtendedEVStationMeasurement | Unset):
    """
    ...
    batteries: list[MeasurementsTotalBatteryMeasurement] | Unset = UNSET
    ...
    heaters: list[MeasurementsTotalHeaterMeasurement] | Unset = UNSET
    appliance_power: float | Unset = UNSET
    appliances: list[MeasurementsTotalAdditionalMeterAppliances] | Unset = UNSET
    ...
    grid: MeasurementsTotalMeasurementGrid | Unset = UNSET
    battery: MeasurementsTotalExtendedBatteryMeasurement | Unset = UNSET
    ev_charging_station: MeasurementsTotalExtendedEVStationMeasurement | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _batteries is not UNSET:
            ...
            for batteries_item_data in _batteries:
                batteries_item = MeasurementsTotalBatteryMeasurement.from_dict(batteries_item_data)
        ...
        if _ev_charging_stations is not UNSET:
            ...
            for ev_charging_stations_item_data in _ev_charging_stations:
                ev_charging_stations_item = MeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation.from_dict(
        ...
        if _heaters is not UNSET:
            ...
            for heaters_item_data in _heaters:
                heaters_item = MeasurementsTotalHeaterMeasurement.from_dict(heaters_item_data)
        ...
        if _appliances is not UNSET:
            ...
            for appliances_item_data in _appliances:
                appliances_item = MeasurementsTotalAdditionalMeterAppliances.from_dict(appliances_item_data)
        ...
        if isinstance(_grid, Unset):
            ...
            grid = MeasurementsTotalMeasurementGrid.from_dict(_grid)
        ...
        if isinstance(_battery, Unset):
            ...
            battery = MeasurementsTotalExtendedBatteryMeasurement.from_dict(_battery)
        ...
        if isinstance(_ev_charging_station, Unset):
            ...
            ev_charging_station = MeasurementsTotalExtendedEVStationMeasurement.from_dict(_ev_charging_station)

        measurements_total = cls(
        ...
        measurements_total.additional_properties = d
