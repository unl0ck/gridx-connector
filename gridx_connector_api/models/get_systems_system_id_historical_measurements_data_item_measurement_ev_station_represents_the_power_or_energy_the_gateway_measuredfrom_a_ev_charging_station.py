...
from ..models.get_systems_system_id_historical_measurements_data_item_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station_plug_state import (
...
T = TypeVar(
    "T",
    bound="GetSystemsSystemIDHistoricalMeasurementsDataItemMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation",
)


@_attrs_define
class GetSystemsSystemIDHistoricalMeasurementsDataItemMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation:
    """
    Attributes:
        ...
        plug_state (GetSystemsSystemIDHistoricalMeasurementsDataItemMeasurementEVStationRepresentsThePowerOrEnergyTheGat
            ewayMeasuredfromAEvChargingStationPlugState | Unset): Defines whether this EV is currently plugged in the
            charging station and whether it's charging. Default: GetSystemsSystemIDHistoricalMeasurementsDataItemMeasurement
            EVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState.UNPLUGGED.
    ...
    plug_state: (
        GetSystemsSystemIDHistoricalMeasurementsDataItemMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState
        | Unset
    ) = GetSystemsSystemIDHistoricalMeasurementsDataItemMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState.UNPLUGGED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_plug_state, Unset):
            ...
            plug_state = GetSystemsSystemIDHistoricalMeasurementsDataItemMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStationPlugState(
                _plug_state
            )
        ...
        get_systems_system_id_historical_measurements_data_item_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station = cls(
        ...
        get_systems_system_id_historical_measurements_data_item_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station.additional_properties = d
        return get_systems_system_id_historical_measurements_data_item_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station
