...
T = TypeVar("T", bound="DeviceResourcesItemDataItemType0PowerTimeSlotsItem")


@_attrs_define
class DeviceResourcesItemDataItemType0PowerTimeSlotsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        device_resources_item_data_item_type_0_power_time_slots_item = cls(
            slot_id=slot_id,
        ...
        device_resources_item_data_item_type_0_power_time_slots_item.additional_properties = d
        return device_resources_item_data_item_type_0_power_time_slots_item
