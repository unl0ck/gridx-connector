...
from ..models.post_gateways_gateway_id_appliances_appliance_id_ev_configuration_response_201_charge_mode import (
    PostGatewaysGatewayIDAppliancesApplianceIDEvConfigurationResponse201ChargeMode,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostGatewaysGatewayIDAppliancesApplianceIDEvConfigurationResponse201")


@_attrs_define
class PostGatewaysGatewayIDAppliancesApplianceIDEvConfigurationResponse201:
    """
    Attributes:
        ...
        charge_mode (PostGatewaysGatewayIDAppliancesApplianceIDEvConfigurationResponse201ChargeMode | Unset): Defines
    ...
    charge_mode: PostGatewaysGatewayIDAppliancesApplianceIDEvConfigurationResponse201ChargeMode | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        charge_mode: PostGatewaysGatewayIDAppliancesApplianceIDEvConfigurationResponse201ChargeMode | Unset
        if isinstance(_charge_mode, Unset):
            charge_mode = UNSET
        else:
            charge_mode = PostGatewaysGatewayIDAppliancesApplianceIDEvConfigurationResponse201ChargeMode(_charge_mode)
        ...
        post_gateways_gateway_id_appliances_appliance_id_ev_configuration_response_201 = cls(
        ...
        post_gateways_gateway_id_appliances_appliance_id_ev_configuration_response_201.additional_properties = d
        return post_gateways_gateway_id_appliances_appliance_id_ev_configuration_response_201
