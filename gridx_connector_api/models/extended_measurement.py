...
if TYPE_CHECKING:
    from ..models.extended_measurement_additional_meter_appliances import ExtendedMeasurementAdditionalMeterAppliances
    from ..models.extended_measurement_battery_measurement import ExtendedMeasurementBatteryMeasurement
    from ..models.extended_measurement_extended_battery_measurement import ExtendedMeasurementExtendedBatteryMeasurement
    from ..models.extended_measurement_extended_ev_station_measurement import (
        ExtendedMeasurementExtendedEVStationMeasurement,
    )
    from ..models.extended_measurement_heater_measurement import ExtendedMeasurementHeaterMeasurement
    from ..models.extended_measurement_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station import (
        ExtendedMeasurementMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation,
    )
    from ..models.extended_measurement_measurement_grid import ExtendedMeasurementMeasurementGrid


T = TypeVar("T", bound="ExtendedMeasurement")


@_attrs_define
class ExtendedMeasurement:
    """
    Attributes:
        ...
        batteries (list[ExtendedMeasurementBatteryMeasurement] | Unset):
        ...
        ev_charging_stations
            (list[ExtendedMeasurementMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation]
            | Unset):
        ...
        heaters (list[ExtendedMeasurementHeaterMeasurement] | Unset): Heating measurement for all heaters that are part
            of the system.
        appliance_power (float | Unset): AppliancePower is power of the appliances with misc location.
        appliances (list[ExtendedMeasurementAdditionalMeterAppliances] | Unset):
        ...
        fuse_protection_count (int | Unset): Number of times the fuse was protected, based on the curtailed power over
            all phases.
        grid (ExtendedMeasurementMeasurementGrid | Unset):
        battery (ExtendedMeasurementExtendedBatteryMeasurement | Unset):
        ev_charging_station (ExtendedMeasurementExtendedEVStationMeasurement | Unset):
    """
    ...
    batteries: list[ExtendedMeasurementBatteryMeasurement] | Unset = UNSET
    ...
    heaters: list[ExtendedMeasurementHeaterMeasurement] | Unset = UNSET
    appliance_power: float | Unset = UNSET
    appliances: list[ExtendedMeasurementAdditionalMeterAppliances] | Unset = UNSET
    ...
    grid: ExtendedMeasurementMeasurementGrid | Unset = UNSET
    battery: ExtendedMeasurementExtendedBatteryMeasurement | Unset = UNSET
    ev_charging_station: ExtendedMeasurementExtendedEVStationMeasurement | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.extended_measurement_additional_meter_appliances import (
            ExtendedMeasurementAdditionalMeterAppliances,
        )
        from ..models.extended_measurement_battery_measurement import ExtendedMeasurementBatteryMeasurement
        from ..models.extended_measurement_extended_battery_measurement import (
        ...
        if _batteries is not UNSET:
            ...
            for batteries_item_data in _batteries:
                batteries_item = ExtendedMeasurementBatteryMeasurement.from_dict(batteries_item_data)
        ...
        if _ev_charging_stations is not UNSET:
            ...
            for ev_charging_stations_item_data in _ev_charging_stations:
                ev_charging_stations_item = ExtendedMeasurementMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation.from_dict(
        ...
        if _heaters is not UNSET:
            ...
            for heaters_item_data in _heaters:
                heaters_item = ExtendedMeasurementHeaterMeasurement.from_dict(heaters_item_data)
        ...
        if _appliances is not UNSET:
            ...
            for appliances_item_data in _appliances:
                appliances_item = ExtendedMeasurementAdditionalMeterAppliances.from_dict(appliances_item_data)
        ...
        if isinstance(_grid, Unset):
            ...
            grid = ExtendedMeasurementMeasurementGrid.from_dict(_grid)
        ...
        if isinstance(_battery, Unset):
            ...
            battery = ExtendedMeasurementExtendedBatteryMeasurement.from_dict(_battery)
        ...
        if isinstance(_ev_charging_station, Unset):
            ...
            ev_charging_station = ExtendedMeasurementExtendedEVStationMeasurement.from_dict(_ev_charging_station)

        extended_measurement = cls(
        ...
        extended_measurement.additional_properties = d
        return extended_measurement
