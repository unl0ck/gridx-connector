...
T = TypeVar("T", bound="SystemWithUsersUsersItemLanguage")


@_attrs_define
class SystemWithUsersUsersItemLanguage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        system_with_users_users_item_language = cls(
            tag=tag,
            name=name,
            name_native=name_native,
        )

        system_with_users_users_item_language.additional_properties = d
        return system_with_users_users_item_language
