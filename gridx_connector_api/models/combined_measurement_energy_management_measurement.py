...
T = TypeVar("T", bound="CombinedMeasurementEnergyManagementMeasurement")


@_attrs_define
class CombinedMeasurementEnergyManagementMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        combined_measurement_energy_management_measurement = cls(
        ...
        combined_measurement_energy_management_measurement.additional_properties = d
        return combined_measurement_energy_management_measurement
