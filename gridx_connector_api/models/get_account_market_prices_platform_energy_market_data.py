...
T = TypeVar("T", bound="GetAccountMarketPricesPlatformEnergyMarketData")


@_attrs_define
class GetAccountMarketPricesPlatformEnergyMarketData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_account_market_prices_platform_energy_market_data = cls(
        ...
        get_account_market_prices_platform_energy_market_data.additional_properties = d
        return get_account_market_prices_platform_energy_market_data
