...
T = TypeVar("T", bound="GetAccountResponse404")


@_attrs_define
class GetAccountResponse404:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_account_response_404 = cls(
            message=message,
            details=details,
        )

        get_account_response_404.additional_properties = d
        return get_account_response_404
