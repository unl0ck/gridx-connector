...
T = TypeVar("T", bound="GetSystemsSystemIDHistoricalMeasurementsDataItemExtendedBatteryMeasurement")


@_attrs_define
class GetSystemsSystemIDHistoricalMeasurementsDataItemExtendedBatteryMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_system_id_historical_measurements_data_item_extended_battery_measurement = cls(
            charge=charge,
            discharge=discharge,
        ...
        get_systems_system_id_historical_measurements_data_item_extended_battery_measurement.additional_properties = d
        return get_systems_system_id_historical_measurements_data_item_extended_battery_measurement
