...
T = TypeVar("T", bound="TimeOfUseSettings")


@_attrs_define
class TimeOfUseSettings:
    """Settings for the Time-of-Use (ToU) optimization feature.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_of_use_settings.additional_properties = d
        return time_of_use_settings
