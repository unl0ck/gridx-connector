...
T = TypeVar("T", bound="OrganizationalAPITokenUserPolicyGroup")


@_attrs_define
class OrganizationalAPITokenUserPolicyGroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organizational_api_token_user_policy_group = cls(
            name=name,
            id=id,
        ...
        organizational_api_token_user_policy_group.additional_properties = d
        return organizational_api_token_user_policy_group
