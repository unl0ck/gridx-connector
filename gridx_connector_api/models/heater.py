...
from ..models.heater_commissioning_kind import HeaterCommissioningKind
from ..models.heater_protocol import HeaterProtocol
from ..models.heater_status import HeaterStatus
from ..models.heater_type import HeaterType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.heater_appliance_connection_status import HeaterApplianceConnectionStatus
    from ..models.heater_crypto_settings_item import HeaterCryptoSettingsItem
    from ..models.heater_energy_management_settings import HeaterEnergyManagementSettings
    from ..models.heater_heater import HeaterHeater
    from ..models.heater_load_settings import HeaterLoadSettings
    from ..models.heater_network import HeaterNetwork
    from ..models.heater_sensor_settings import HeaterSensorSettings
    from ..models.heater_source import HeaterSource
    from ..models.heater_state import HeaterState


T = TypeVar("T", bound="Heater")
...
class Heater:
    ...
    Attributes:
        ...
        connection_status (HeaterApplianceConnectionStatus):
        type_ (HeaterType): Describes the 'physical' type of the appliance.
        ...
        state (HeaterState): Contains information about the appliance's state.
        heater (HeaterHeater): The heater specific information.
        status (HeaterStatus | Unset): Status of the appliance. This field is set dynamically in the appliance handler.
        ...
        network (HeaterNetwork | Unset): Represents a network connection.
        ...
        load_settings (HeaterLoadSettings | Unset): Configure load of appliance.
        sensor_settings (HeaterSensorSettings | Unset):
        source (HeaterSource | Unset):
        commissioning_kind (HeaterCommissioningKind | Unset): Indicates special requirements to be fulfilled during the
        ...
        energy_settings (HeaterEnergyManagementSettings | Unset): Contains energy management information
        crypto_settings (list[HeaterCryptoSettingsItem] | Unset): Contains a list of crypto setting keys that are
            associated with the appliance.
        protocol (HeaterProtocol | Unset): Network protocol supported by the appliance Example: EEBUS.
        firmware (str | Unset): Firmware version of the heater. Example: 101.3.
        manufacturer (str | Unset): Manufacturer of the heater. Example: my-PV.
    """
    ...
    state: HeaterState
    heater: HeaterHeater
    status: HeaterStatus | Unset = UNSET
    name: str | Unset = UNSET
    room: str | Unset = UNSET
    serialnumber: str | Unset = UNSET
    network: HeaterNetwork | Unset = UNSET
    parent: UUID | Unset = UNSET
    load_settings: HeaterLoadSettings | Unset = UNSET
    sensor_settings: HeaterSensorSettings | Unset = UNSET
    source: HeaterSource | Unset = UNSET
    commissioning_kind: HeaterCommissioningKind | Unset = UNSET
    energy_settings: HeaterEnergyManagementSettings | Unset = UNSET
    crypto_settings: list[HeaterCryptoSettingsItem] | Unset = UNSET
    protocol: HeaterProtocol | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        connection_status = HeaterApplianceConnectionStatus.from_dict(d.pop("connectionStatus"))

        type_ = HeaterType(d.pop("type"))

        inactive = d.pop("inactive")

        reverse_flow = d.pop("reverseFlow")

        state = HeaterState.from_dict(d.pop("state"))

        heater = HeaterHeater.from_dict(d.pop("heater"))

        _status = d.pop("status", UNSET)
        status: HeaterStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = HeaterStatus(_status)
        ...
        network: HeaterNetwork | Unset
        if isinstance(_network, Unset):
            network = UNSET
        else:
            network = HeaterNetwork.from_dict(_network)
        ...
        load_settings: HeaterLoadSettings | Unset
        if isinstance(_load_settings, Unset):
            load_settings = UNSET
        else:
            load_settings = HeaterLoadSettings.from_dict(_load_settings)
        ...
        if isinstance(_sensor_settings, Unset):
            ...
            sensor_settings = HeaterSensorSettings.from_dict(_sensor_settings)
        ...
        if isinstance(_source, Unset):
            ...
            source = HeaterSource.from_dict(_source)

        _commissioning_kind = d.pop("commissioningKind", UNSET)
        commissioning_kind: HeaterCommissioningKind | Unset
        if isinstance(_commissioning_kind, Unset):
            commissioning_kind = UNSET
        else:
            commissioning_kind = HeaterCommissioningKind(_commissioning_kind)

        _energy_settings = d.pop("energySettings", UNSET)
        energy_settings: HeaterEnergyManagementSettings | Unset
        if isinstance(_energy_settings, Unset):
            energy_settings = UNSET
        else:
            energy_settings = HeaterEnergyManagementSettings.from_dict(_energy_settings)
        ...
        if _crypto_settings is not UNSET:
            ...
            for crypto_settings_item_data in _crypto_settings:
                crypto_settings_item = HeaterCryptoSettingsItem.from_dict(crypto_settings_item_data)

                crypto_settings.append(crypto_settings_item)

        _protocol = d.pop("protocol", UNSET)
        protocol: HeaterProtocol | Unset
        if isinstance(_protocol, Unset):
            protocol = UNSET
        else:
            protocol = HeaterProtocol(_protocol)
        ...
        heater.additional_properties = d
        return heater
