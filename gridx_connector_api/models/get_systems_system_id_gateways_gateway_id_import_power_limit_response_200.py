...
from ..models.get_systems_system_id_gateways_gateway_id_import_power_limit_response_200_number_of_phases import (
    GetSystemsSystemIDGatewaysGatewayIDImportPowerLimitResponse200NumberOfPhases,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSystemsSystemIDGatewaysGatewayIDImportPowerLimitResponse200")


@_attrs_define
class GetSystemsSystemIDGatewaysGatewayIDImportPowerLimitResponse200:
    """
    Attributes:
        number_of_phases (GetSystemsSystemIDGatewaysGatewayIDImportPowerLimitResponse200NumberOfPhases): Number of
            phases the import power limit is set for. 1 or 3. Default is 3. Default:
            GetSystemsSystemIDGatewaysGatewayIDImportPowerLimitResponse200NumberOfPhases.VALUE_3. Example: 3.
    ...
    number_of_phases: GetSystemsSystemIDGatewaysGatewayIDImportPowerLimitResponse200NumberOfPhases = (
        GetSystemsSystemIDGatewaysGatewayIDImportPowerLimitResponse200NumberOfPhases.VALUE_3
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_system_id_gateways_gateway_id_import_power_limit_response_200 = cls(
        ...
        get_systems_system_id_gateways_gateway_id_import_power_limit_response_200.additional_properties = d
        return get_systems_system_id_gateways_gateway_id_import_power_limit_response_200
