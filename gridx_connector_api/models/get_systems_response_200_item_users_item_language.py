...
T = TypeVar("T", bound="GetSystemsResponse200ItemUsersItemLanguage")


@_attrs_define
class GetSystemsResponse200ItemUsersItemLanguage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_response_200_item_users_item_language = cls(
            tag=tag,
            name=name,
            name_native=name_native,
        )

        get_systems_response_200_item_users_item_language.additional_properties = d
        return get_systems_response_200_item_users_item_language
