...
T = TypeVar("T", bound="DeleteAccountsAccountIDSystemsSystemAccountUnassignment")


@_attrs_define
class DeleteAccountsAccountIDSystemsSystemAccountUnassignment:
    """
    Attributes:
        uuids (list[str]): System IDs that will be removed from the target account.
        move_systems_and_customers (bool | Unset): - `true`: Unassigns the system from the given account (accountID
            parameter). Moves the customer account to the parent account of the account the system is unassigned from
            (accountID parameter).
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_accounts_account_id_systems_system_account_unassignment = cls(
            uuids=uuids,
            move_systems_and_customers=move_systems_and_customers,
            move_vendor_id=move_vendor_id,
        )

        delete_accounts_account_id_systems_system_account_unassignment.additional_properties = d
        return delete_accounts_account_id_systems_system_account_unassignment
