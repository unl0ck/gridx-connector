...
T = TypeVar("T", bound="GetSystemsResponse403")


@_attrs_define
class GetSystemsResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_response_403 = cls(
            message=message,
            details=details,
        )

        get_systems_response_403.additional_properties = d
        return get_systems_response_403
