...
T = TypeVar("T", bound="GetAccountTokensOrganizationalAPITokenUserAddress")


@_attrs_define
class GetAccountTokensOrganizationalAPITokenUserAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_account_tokens_organizational_api_token_user_address = cls(
            city=city,
            country=country,
        ...
        get_account_tokens_organizational_api_token_user_address.additional_properties = d
        return get_account_tokens_organizational_api_token_user_address
