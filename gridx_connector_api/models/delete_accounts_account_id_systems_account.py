...
from ..models.delete_accounts_account_id_systems_account_kind import DeleteAccountsAccountIDSystemsAccountKind
from ..models.delete_accounts_account_id_systems_account_solution import DeleteAccountsAccountIDSystemsAccountSolution
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.delete_accounts_account_id_systems_account_address import DeleteAccountsAccountIDSystemsAccountAddress


T = TypeVar("T", bound="DeleteAccountsAccountIDSystemsAccount")


@_attrs_define
class DeleteAccountsAccountIDSystemsAccount:
    ...
    Attributes:
        ...
        solution (DeleteAccountsAccountIDSystemsAccountSolution | Unset): Represents the supported solutions within the
            account:
        ...
        kind (DeleteAccountsAccountIDSystemsAccountKind | Unset): If b2b, the account is a regular account. If end-user,
            the account is a customer account which contains just one user.
        main_address (DeleteAccountsAccountIDSystemsAccountAddress | Unset): Represents a physical address of a
            customer.
    ...
    solution: DeleteAccountsAccountIDSystemsAccountSolution | Unset = UNSET
    parent_id: UUID | Unset = UNSET
    systems_count: int | Unset = UNSET
    kind: DeleteAccountsAccountIDSystemsAccountKind | Unset = UNSET
    main_address: DeleteAccountsAccountIDSystemsAccountAddress | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.delete_accounts_account_id_systems_account_address import (
        ...
        solution: DeleteAccountsAccountIDSystemsAccountSolution | Unset
        if isinstance(_solution, Unset):
            solution = UNSET
        else:
            solution = DeleteAccountsAccountIDSystemsAccountSolution(_solution)
        ...
        kind: DeleteAccountsAccountIDSystemsAccountKind | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = DeleteAccountsAccountIDSystemsAccountKind(_kind)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: DeleteAccountsAccountIDSystemsAccountAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = DeleteAccountsAccountIDSystemsAccountAddress.from_dict(_main_address)

        customization = d.pop("customization", UNSET)

        delete_accounts_account_id_systems_account = cls(
            id=id,
        ...
        delete_accounts_account_id_systems_account.additional_properties = d
        return delete_accounts_account_id_systems_account
