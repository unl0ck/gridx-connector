...
from ..models.patch_gateways_gateway_id_appliances_appliance_id_body_heat_pump_information_type import (
    PatchGatewaysGatewayIDAppliancesApplianceIDBodyHeatPumpInformationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PatchGatewaysGatewayIDAppliancesApplianceIDBodyHeatPumpInformation")


@_attrs_define
class PatchGatewaysGatewayIDAppliancesApplianceIDBodyHeatPumpInformation:
    """The heat pump specific information.

    Attributes:
        type_ (PatchGatewaysGatewayIDAppliancesApplianceIDBodyHeatPumpInformationType | Unset): Describes the specific
    ...
    type_: PatchGatewaysGatewayIDAppliancesApplianceIDBodyHeatPumpInformationType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: PatchGatewaysGatewayIDAppliancesApplianceIDBodyHeatPumpInformationType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = PatchGatewaysGatewayIDAppliancesApplianceIDBodyHeatPumpInformationType(_type_)
        ...
        patch_gateways_gateway_id_appliances_appliance_id_body_heat_pump_information = cls(
            type_=type_,
        ...
        patch_gateways_gateway_id_appliances_appliance_id_body_heat_pump_information.additional_properties = d
        return patch_gateways_gateway_id_appliances_appliance_id_body_heat_pump_information
