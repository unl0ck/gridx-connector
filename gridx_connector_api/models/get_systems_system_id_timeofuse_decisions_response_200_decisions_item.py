...
from ..models.get_systems_system_id_timeofuse_decisions_response_200_decisions_item_case_name import (
    GetSystemsSystemIDTimeofuseDecisionsResponse200DecisionsItemCaseName,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_systems_system_id_timeofuse_decisions_response_200_decisions_item_insight import (
        GetSystemsSystemIDTimeofuseDecisionsResponse200DecisionsItemInsight,
    )


T = TypeVar("T", bound="GetSystemsSystemIDTimeofuseDecisionsResponse200DecisionsItem")


@_attrs_define
class GetSystemsSystemIDTimeofuseDecisionsResponse200DecisionsItem:
    """
    Attributes:
        from_ (datetime.datetime):
        to (datetime.datetime):
        case_name (GetSystemsSystemIDTimeofuseDecisionsResponse200DecisionsItemCaseName): Identifies underlying the
            decision case that this decision is based on.
        ...
        insight (GetSystemsSystemIDTimeofuseDecisionsResponse200DecisionsItemInsight | Unset):
    """

    from_: datetime.datetime
    to: datetime.datetime
    case_name: GetSystemsSystemIDTimeofuseDecisionsResponse200DecisionsItemCaseName
    is_price_based_optimization: bool
    insight: GetSystemsSystemIDTimeofuseDecisionsResponse200DecisionsItemInsight | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        case_name = GetSystemsSystemIDTimeofuseDecisionsResponse200DecisionsItemCaseName(d.pop("case_name"))
        ...
        if isinstance(_insight, Unset):
            ...
            insight = GetSystemsSystemIDTimeofuseDecisionsResponse200DecisionsItemInsight.from_dict(_insight)

        get_systems_system_id_timeofuse_decisions_response_200_decisions_item = cls(
            from_=from_,
            to=to,
            case_name=case_name,
        ...
        get_systems_system_id_timeofuse_decisions_response_200_decisions_item.additional_properties = d
        return get_systems_system_id_timeofuse_decisions_response_200_decisions_item
