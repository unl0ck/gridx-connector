...
T = TypeVar("T", bound="MeasurementsTotalHeaterMeasurement")


@_attrs_define
class MeasurementsTotalHeaterMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        measurements_total_heater_measurement = cls(
        ...
        measurements_total_heater_measurement.additional_properties = d
        return measurements_total_heater_measurement
