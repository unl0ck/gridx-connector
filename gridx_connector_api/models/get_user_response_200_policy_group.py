...
T = TypeVar("T", bound="GetUserResponse200PolicyGroup")


@_attrs_define
class GetUserResponse200PolicyGroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_response_200_policy_group = cls(
            name=name,
            id=id,
        ...
        get_user_response_200_policy_group.additional_properties = d
        return get_user_response_200_policy_group
