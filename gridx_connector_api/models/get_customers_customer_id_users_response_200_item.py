...
if TYPE_CHECKING:
    from ..models.get_customers_customer_id_users_response_200_item_address import (
        GetCustomersCustomerIDUsersResponse200ItemAddress,
    )
    from ..models.get_customers_customer_id_users_response_200_item_language import (
        GetCustomersCustomerIDUsersResponse200ItemLanguage,
    )
    from ..models.get_customers_customer_id_users_response_200_item_policy_group import (
        GetCustomersCustomerIDUsersResponse200ItemPolicyGroup,
    )


T = TypeVar("T", bound="GetCustomersCustomerIDUsersResponse200Item")


@_attrs_define
class GetCustomersCustomerIDUsersResponse200Item:
    """
    Attributes:
        ...
        full_name (str | Unset): Full name of the user typically consisting of first name and last name. Example: John
            Doe.
        groups (list[GetCustomersCustomerIDUsersResponse200ItemPolicyGroup] | Unset): Policy groups attached to this
            user which determine the effective permissions through policies.
        main_address (GetCustomersCustomerIDUsersResponse200ItemAddress | Unset): Represents a physical address of a
            customer.
        language (GetCustomersCustomerIDUsersResponse200ItemLanguage | Unset): The language information of the user.
    """
    ...
    groups: list[GetCustomersCustomerIDUsersResponse200ItemPolicyGroup] | Unset = UNSET
    main_address: GetCustomersCustomerIDUsersResponse200ItemAddress | Unset = UNSET
    language: GetCustomersCustomerIDUsersResponse200ItemLanguage | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _groups is not UNSET:
            ...
            for groups_item_data in _groups:
                groups_item = GetCustomersCustomerIDUsersResponse200ItemPolicyGroup.from_dict(groups_item_data)

                groups.append(groups_item)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: GetCustomersCustomerIDUsersResponse200ItemAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = GetCustomersCustomerIDUsersResponse200ItemAddress.from_dict(_main_address)

        _language = d.pop("language", UNSET)
        language: GetCustomersCustomerIDUsersResponse200ItemLanguage | Unset
        if isinstance(_language, Unset):
            language = UNSET
        else:
            language = GetCustomersCustomerIDUsersResponse200ItemLanguage.from_dict(_language)

        get_customers_customer_id_users_response_200_item = cls(
            id=id,
        ...
        get_customers_customer_id_users_response_200_item.additional_properties = d
        return get_customers_customer_id_users_response_200_item
