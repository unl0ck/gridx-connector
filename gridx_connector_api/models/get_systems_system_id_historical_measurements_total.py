...
if TYPE_CHECKING:
    from ..models.get_systems_system_id_historical_measurements_total_additional_meter_appliances import (
        GetSystemsSystemIDHistoricalMeasurementsTotalAdditionalMeterAppliances,
    )
    from ..models.get_systems_system_id_historical_measurements_total_battery_measurement import (
        GetSystemsSystemIDHistoricalMeasurementsTotalBatteryMeasurement,
    )
    from ..models.get_systems_system_id_historical_measurements_total_extended_battery_measurement import (
        GetSystemsSystemIDHistoricalMeasurementsTotalExtendedBatteryMeasurement,
    )
    from ..models.get_systems_system_id_historical_measurements_total_extended_ev_station_measurement import (
        GetSystemsSystemIDHistoricalMeasurementsTotalExtendedEVStationMeasurement,
    )
    from ..models.get_systems_system_id_historical_measurements_total_heater_measurement import (
        GetSystemsSystemIDHistoricalMeasurementsTotalHeaterMeasurement,
    )
    from ..models.get_systems_system_id_historical_measurements_total_measurement_ev_station_represents_the_power_or_energy_the_gateway_measuredfrom_a_ev_charging_station import (
    ...
    from ..models.get_systems_system_id_historical_measurements_total_measurement_grid import (
        GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementGrid,
    )


T = TypeVar("T", bound="GetSystemsSystemIDHistoricalMeasurementsTotal")


@_attrs_define
class GetSystemsSystemIDHistoricalMeasurementsTotal:
    """
    Attributes:
        measured_at (str | Unset): Interval containing all data points in the requested interval formatted in ISO8601.
        ...
        batteries (list[GetSystemsSystemIDHistoricalMeasurementsTotalBatteryMeasurement] | Unset):
        ...
        ev_charging_stations (list[GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementEVStationRepresentsThePowerOr
            EnergyTheGatewayMeasuredfromAEvChargingStation] | Unset):
        ...
        heaters (list[GetSystemsSystemIDHistoricalMeasurementsTotalHeaterMeasurement] | Unset): Heating measurement for
            all heaters that are part of the system.
        appliance_power (float | Unset): AppliancePower is power of the appliances with misc location.
        appliances (list[GetSystemsSystemIDHistoricalMeasurementsTotalAdditionalMeterAppliances] | Unset):
        ...
        fuse_protection_count (int | Unset): Number of times the fuse was protected, based on the curtailed power over
            all phases.
        grid (GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementGrid | Unset):
        battery (GetSystemsSystemIDHistoricalMeasurementsTotalExtendedBatteryMeasurement | Unset):
        ev_charging_station (GetSystemsSystemIDHistoricalMeasurementsTotalExtendedEVStationMeasurement | Unset):
    """
    ...
    batteries: list[GetSystemsSystemIDHistoricalMeasurementsTotalBatteryMeasurement] | Unset = UNSET
    ...
    heaters: list[GetSystemsSystemIDHistoricalMeasurementsTotalHeaterMeasurement] | Unset = UNSET
    appliance_power: float | Unset = UNSET
    appliances: list[GetSystemsSystemIDHistoricalMeasurementsTotalAdditionalMeterAppliances] | Unset = UNSET
    ...
    grid: GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementGrid | Unset = UNSET
    battery: GetSystemsSystemIDHistoricalMeasurementsTotalExtendedBatteryMeasurement | Unset = UNSET
    ev_charging_station: GetSystemsSystemIDHistoricalMeasurementsTotalExtendedEVStationMeasurement | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _batteries is not UNSET:
            ...
            for batteries_item_data in _batteries:
                batteries_item = GetSystemsSystemIDHistoricalMeasurementsTotalBatteryMeasurement.from_dict(
                    batteries_item_data
                )
        ...
        if _ev_charging_stations is not UNSET:
            ...
            for ev_charging_stations_item_data in _ev_charging_stations:
                ev_charging_stations_item = GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementEVStationRepresentsThePowerOrEnergyTheGatewayMeasuredfromAEvChargingStation.from_dict(
        ...
        if _heaters is not UNSET:
            ...
            for heaters_item_data in _heaters:
                heaters_item = GetSystemsSystemIDHistoricalMeasurementsTotalHeaterMeasurement.from_dict(
                    heaters_item_data
                )
        ...
        if _appliances is not UNSET:
            ...
            for appliances_item_data in _appliances:
                appliances_item = GetSystemsSystemIDHistoricalMeasurementsTotalAdditionalMeterAppliances.from_dict(
        ...
        if isinstance(_grid, Unset):
            ...
            grid = GetSystemsSystemIDHistoricalMeasurementsTotalMeasurementGrid.from_dict(_grid)
        ...
        if isinstance(_battery, Unset):
            ...
            battery = GetSystemsSystemIDHistoricalMeasurementsTotalExtendedBatteryMeasurement.from_dict(_battery)
        ...
        if isinstance(_ev_charging_station, Unset):
            ...
            ev_charging_station = GetSystemsSystemIDHistoricalMeasurementsTotalExtendedEVStationMeasurement.from_dict(
                _ev_charging_station
            )

        get_systems_system_id_historical_measurements_total = cls(
        ...
        get_systems_system_id_historical_measurements_total.additional_properties = d
        return get_systems_system_id_historical_measurements_total
