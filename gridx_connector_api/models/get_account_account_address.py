...
T = TypeVar("T", bound="GetAccountAccountAddress")


@_attrs_define
class GetAccountAccountAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_account_account_address = cls(
            city=city,
            country=country,
        ...
        get_account_account_address.additional_properties = d
        return get_account_account_address
