...
from ..models.delete_gateways_gateway_id_jobs_job_id_or_type_response_200_state import (
    DeleteGatewaysGatewayIDJobsJobIDOrTypeResponse200State,
)
from ..models.delete_gateways_gateway_id_jobs_job_id_or_type_response_200_type import (
    DeleteGatewaysGatewayIDJobsJobIDOrTypeResponse200Type,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.delete_gateways_gateway_id_jobs_job_id_or_type_response_200_job_execution import (
        DeleteGatewaysGatewayIDJobsJobIDOrTypeResponse200JobExecution,
    )


T = TypeVar("T", bound="DeleteGatewaysGatewayIDJobsJobIDOrTypeResponse200")


@_attrs_define
class DeleteGatewaysGatewayIDJobsJobIDOrTypeResponse200:
    """
    Attributes:
        type_ (DeleteGatewaysGatewayIDJobsJobIDOrTypeResponse200Type): Represents the kind of the job. A job can be of
            type:
            - `UNKNOWN_TYPE`
            ...
            - `RESTART`: Indicates that the application should restart.
             Example: RESET.
        state (DeleteGatewaysGatewayIDJobsJobIDOrTypeResponse200State): Represents the current state of the job. It can
            be one of:
            * `UNKNOWN_STATE`
        ...
        executions (list[DeleteGatewaysGatewayIDJobsJobIDOrTypeResponse200JobExecution]): Represents a set of job
            executions.
    ...
    type_: DeleteGatewaysGatewayIDJobsJobIDOrTypeResponse200Type
    state: DeleteGatewaysGatewayIDJobsJobIDOrTypeResponse200State
    id: UUID
    executions: list[DeleteGatewaysGatewayIDJobsJobIDOrTypeResponse200JobExecution]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = DeleteGatewaysGatewayIDJobsJobIDOrTypeResponse200Type(d.pop("type"))

        state = DeleteGatewaysGatewayIDJobsJobIDOrTypeResponse200State(d.pop("state"))
        ...
        for executions_item_data in _executions:
            executions_item = DeleteGatewaysGatewayIDJobsJobIDOrTypeResponse200JobExecution.from_dict(
        ...
        delete_gateways_gateway_id_jobs_job_id_or_type_response_200 = cls(
            type_=type_,
            state=state,
            id=id,
            executions=executions,
        ...
        delete_gateways_gateway_id_jobs_job_id_or_type_response_200.additional_properties = d
        return delete_gateways_gateway_id_jobs_job_id_or_type_response_200
