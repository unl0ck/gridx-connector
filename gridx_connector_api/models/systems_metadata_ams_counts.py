...
T = TypeVar("T", bound="SystemsMetadataAMSCounts")


@_attrs_define
class SystemsMetadataAMSCounts:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        systems_metadata_ams_counts = cls(
            total=total,
            filtered=filtered,
        )

        systems_metadata_ams_counts.additional_properties = d
        return systems_metadata_ams_counts
