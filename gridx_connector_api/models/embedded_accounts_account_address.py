...
T = TypeVar("T", bound="EmbeddedAccountsAccountAddress")


@_attrs_define
class EmbeddedAccountsAccountAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        embedded_accounts_account_address = cls(
            city=city,
            country=country,
        ...
        embedded_accounts_account_address.additional_properties = d
        return embedded_accounts_account_address
