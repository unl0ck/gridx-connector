...
from ..models.get_gateways_response_200_item_connection_status_status import (
    GetGatewaysResponse200ItemConnectionStatusStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetGatewaysResponse200ItemConnectionStatus")


@_attrs_define
class GetGatewaysResponse200ItemConnectionStatus:
    """
    Attributes:
        status (GetGatewaysResponse200ItemConnectionStatusStatus): Indicates the connection status. Is one of:
    ...
    status: GetGatewaysResponse200ItemConnectionStatusStatus
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = GetGatewaysResponse200ItemConnectionStatusStatus(d.pop("status"))
        ...
        get_gateways_response_200_item_connection_status = cls(
            status=status,
            contacted_at=contacted_at,
        )

        get_gateways_response_200_item_connection_status.additional_properties = d
        return get_gateways_response_200_item_connection_status
