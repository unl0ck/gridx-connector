...
T = TypeVar("T", bound="PostAccountsResponse403")


@_attrs_define
class PostAccountsResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_accounts_response_403 = cls(
            message=message,
            details=details,
        )

        post_accounts_response_403.additional_properties = d
        return post_accounts_response_403
