...
T = TypeVar("T", bound="ApplianceUpdateEnergyManagementSettings")


@_attrs_define
class ApplianceUpdateEnergyManagementSettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appliance_update_energy_management_settings = cls(
        ...
        appliance_update_energy_management_settings.additional_properties = d
        return appliance_update_energy_management_settings
