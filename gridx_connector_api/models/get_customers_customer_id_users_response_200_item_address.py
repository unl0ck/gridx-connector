...
T = TypeVar("T", bound="GetCustomersCustomerIDUsersResponse200ItemAddress")


@_attrs_define
class GetCustomersCustomerIDUsersResponse200ItemAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_customers_customer_id_users_response_200_item_address = cls(
            city=city,
            country=country,
        ...
        get_customers_customer_id_users_response_200_item_address.additional_properties = d
        return get_customers_customer_id_users_response_200_item_address
