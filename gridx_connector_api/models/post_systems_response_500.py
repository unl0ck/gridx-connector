...
T = TypeVar("T", bound="PostSystemsResponse500")


@_attrs_define
class PostSystemsResponse500:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_systems_response_500 = cls(
            message=message,
            details=details,
        )

        post_systems_response_500.additional_properties = d
        return post_systems_response_500
