...
T = TypeVar("T", bound="GetSystemsSystemIDHistoricalMeasurementsDataItemExtendedEVStationMeasurement")


@_attrs_define
class GetSystemsSystemIDHistoricalMeasurementsDataItemExtendedEVStationMeasurement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_system_id_historical_measurements_data_item_extended_ev_station_measurement = cls(
            charge=charge,
            discharge=discharge,
        ...
        get_systems_system_id_historical_measurements_data_item_extended_ev_station_measurement.additional_properties = d
        return get_systems_system_id_historical_measurements_data_item_extended_ev_station_measurement
