...
if TYPE_CHECKING:
    from ..models.patch_account_tokens_token_id_organizational_api_token_user_address import (
        PatchAccountTokensTokenIDOrganizationalAPITokenUserAddress,
    )
    from ..models.patch_account_tokens_token_id_organizational_api_token_user_language import (
        PatchAccountTokensTokenIDOrganizationalAPITokenUserLanguage,
    )
    from ..models.patch_account_tokens_token_id_organizational_api_token_user_policy_group import (
        PatchAccountTokensTokenIDOrganizationalAPITokenUserPolicyGroup,
    )


T = TypeVar("T", bound="PatchAccountTokensTokenIDOrganizationalAPITokenUser")


@_attrs_define
class PatchAccountTokensTokenIDOrganizationalAPITokenUser:
    """
    Attributes:
        ...
        full_name (str | Unset): Full name of the user typically consisting of first name and last name. Example: John
            Doe.
        groups (list[PatchAccountTokensTokenIDOrganizationalAPITokenUserPolicyGroup] | Unset): Policy groups attached to
            this user which determine the effective permissions through policies.
        main_address (PatchAccountTokensTokenIDOrganizationalAPITokenUserAddress | Unset): Represents a physical address
            of a customer.
        language (PatchAccountTokensTokenIDOrganizationalAPITokenUserLanguage | Unset): The language information of the
            user.
    """
    ...
    groups: list[PatchAccountTokensTokenIDOrganizationalAPITokenUserPolicyGroup] | Unset = UNSET
    main_address: PatchAccountTokensTokenIDOrganizationalAPITokenUserAddress | Unset = UNSET
    language: PatchAccountTokensTokenIDOrganizationalAPITokenUserLanguage | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _groups is not UNSET:
            ...
            for groups_item_data in _groups:
                groups_item = PatchAccountTokensTokenIDOrganizationalAPITokenUserPolicyGroup.from_dict(groups_item_data)

                groups.append(groups_item)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: PatchAccountTokensTokenIDOrganizationalAPITokenUserAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = PatchAccountTokensTokenIDOrganizationalAPITokenUserAddress.from_dict(_main_address)

        _language = d.pop("language", UNSET)
        language: PatchAccountTokensTokenIDOrganizationalAPITokenUserLanguage | Unset
        if isinstance(_language, Unset):
            language = UNSET
        else:
            language = PatchAccountTokensTokenIDOrganizationalAPITokenUserLanguage.from_dict(_language)

        patch_account_tokens_token_id_organizational_api_token_user = cls(
            id=id,
        ...
        patch_account_tokens_token_id_organizational_api_token_user.additional_properties = d
        return patch_account_tokens_token_id_organizational_api_token_user
