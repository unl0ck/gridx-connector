...
from ..models.job_with_executions_state import JobWithExecutionsState
from ..models.job_with_executions_type import JobWithExecutionsType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.job_with_executions_job_execution import JobWithExecutionsJobExecution


T = TypeVar("T", bound="JobWithExecutions")


@_attrs_define
class JobWithExecutions:
    """
    Attributes:
        type_ (JobWithExecutionsType): Represents the kind of the job. A job can be of type:
            - `UNKNOWN_TYPE`
            ...
            - `RESTART`: Indicates that the application should restart.
             Example: RESET.
        state (JobWithExecutionsState): Represents the current state of the job. It can be one of:
            * `UNKNOWN_STATE`
        ...
        executions (list[JobWithExecutionsJobExecution]): Represents a set of job executions.
    ...
    type_: JobWithExecutionsType
    state: JobWithExecutionsState
    id: UUID
    executions: list[JobWithExecutionsJobExecution]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = JobWithExecutionsType(d.pop("type"))

        state = JobWithExecutionsState(d.pop("state"))
        ...
        for executions_item_data in _executions:
            executions_item = JobWithExecutionsJobExecution.from_dict(executions_item_data)
        ...
        job_with_executions.additional_properties = d
        return job_with_executions
