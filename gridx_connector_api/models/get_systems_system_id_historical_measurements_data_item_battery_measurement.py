...
T = TypeVar("T", bound="GetSystemsSystemIDHistoricalMeasurementsDataItemBatteryMeasurement")


@_attrs_define
class GetSystemsSystemIDHistoricalMeasurementsDataItemBatteryMeasurement:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_system_id_historical_measurements_data_item_battery_measurement = cls(
        ...
        get_systems_system_id_historical_measurements_data_item_battery_measurement.additional_properties = d
        return get_systems_system_id_historical_measurements_data_item_battery_measurement
