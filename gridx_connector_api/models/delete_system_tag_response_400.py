...
T = TypeVar("T", bound="DeleteSystemTagResponse400")


@_attrs_define
class DeleteSystemTagResponse400:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_system_tag_response_400 = cls(
            message=message,
            details=details,
        )

        delete_system_tag_response_400.additional_properties = d
        return delete_system_tag_response_400
