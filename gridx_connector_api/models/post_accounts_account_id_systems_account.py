...
from ..models.post_accounts_account_id_systems_account_kind import PostAccountsAccountIDSystemsAccountKind
from ..models.post_accounts_account_id_systems_account_solution import PostAccountsAccountIDSystemsAccountSolution
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_accounts_account_id_systems_account_address import PostAccountsAccountIDSystemsAccountAddress


T = TypeVar("T", bound="PostAccountsAccountIDSystemsAccount")


@_attrs_define
class PostAccountsAccountIDSystemsAccount:
    ...
    Attributes:
        ...
        solution (PostAccountsAccountIDSystemsAccountSolution | Unset): Represents the supported solutions within the
            account:
        ...
        kind (PostAccountsAccountIDSystemsAccountKind | Unset): If b2b, the account is a regular account. If end-user,
            the account is a customer account which contains just one user.
        main_address (PostAccountsAccountIDSystemsAccountAddress | Unset): Represents a physical address of a customer.
    ...
    solution: PostAccountsAccountIDSystemsAccountSolution | Unset = UNSET
    parent_id: UUID | Unset = UNSET
    systems_count: int | Unset = UNSET
    kind: PostAccountsAccountIDSystemsAccountKind | Unset = UNSET
    main_address: PostAccountsAccountIDSystemsAccountAddress | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        solution: PostAccountsAccountIDSystemsAccountSolution | Unset
        if isinstance(_solution, Unset):
            solution = UNSET
        else:
            solution = PostAccountsAccountIDSystemsAccountSolution(_solution)
        ...
        kind: PostAccountsAccountIDSystemsAccountKind | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = PostAccountsAccountIDSystemsAccountKind(_kind)

        _main_address = d.pop("mainAddress", UNSET)
        main_address: PostAccountsAccountIDSystemsAccountAddress | Unset
        if isinstance(_main_address, Unset):
            main_address = UNSET
        else:
            main_address = PostAccountsAccountIDSystemsAccountAddress.from_dict(_main_address)

        customization = d.pop("customization", UNSET)

        post_accounts_account_id_systems_account = cls(
            id=id,
        ...
        post_accounts_account_id_systems_account.additional_properties = d
        return post_accounts_account_id_systems_account
