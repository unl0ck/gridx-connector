...
from ..models.combined_14a_raw_measurements_item_type_4_lpc_server_state import (
    Combined14ARawMeasurementsItemType4LpcServerState,
)

T = TypeVar("T", bound="Combined14ARawMeasurementsItemType4")


@_attrs_define
class Combined14ARawMeasurementsItemType4:
    ...
    Attributes:
        ...
        lpc_server_state (Combined14ARawMeasurementsItemType4LpcServerState): The current state of connection between
            the GridBox with the device serving the consumptionPowerLimit.
    """
    ...
    lpc_server_state: Combined14ARawMeasurementsItemType4LpcServerState
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lpc_server_state = Combined14ARawMeasurementsItemType4LpcServerState(d.pop("lpcServerState"))

        combined_14a_raw_measurements_item_type_4 = cls(
        ...
        combined_14a_raw_measurements_item_type_4.additional_properties = d
        return combined_14a_raw_measurements_item_type_4
