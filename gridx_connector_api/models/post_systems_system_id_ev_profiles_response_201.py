...
T = TypeVar("T", bound="PostSystemsSystemIDEvProfilesResponse201")


@_attrs_define
class PostSystemsSystemIDEvProfilesResponse201:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_systems_system_id_ev_profiles_response_201 = cls(
            id=id,
            system_id=system_id,
        ...
        post_systems_system_id_ev_profiles_response_201.additional_properties = d
        return post_systems_system_id_ev_profiles_response_201
