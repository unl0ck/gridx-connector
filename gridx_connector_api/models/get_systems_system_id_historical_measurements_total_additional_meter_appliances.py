...
T = TypeVar("T", bound="GetSystemsSystemIDHistoricalMeasurementsTotalAdditionalMeterAppliances")


@_attrs_define
class GetSystemsSystemIDHistoricalMeasurementsTotalAdditionalMeterAppliances:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_system_id_historical_measurements_total_additional_meter_appliances = cls(
            appliance_id=appliance_id,
            power=power,
            kind=kind,
        )

        get_systems_system_id_historical_measurements_total_additional_meter_appliances.additional_properties = d
        return get_systems_system_id_historical_measurements_total_additional_meter_appliances
