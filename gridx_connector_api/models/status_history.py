...
if TYPE_CHECKING:
    from ..models.status_history_periods_item import StatusHistoryPeriodsItem


T = TypeVar("T", bound="StatusHistory")
...
class StatusHistory:
    ...
    Attributes:
        ...
        periods (list[StatusHistoryPeriodsItem] | Unset):
    """

    from_: datetime.datetime | Unset = UNSET
    to: datetime.datetime | Unset = UNSET
    periods: list[StatusHistoryPeriodsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _periods is not UNSET:
            ...
            for periods_item_data in _periods:
                periods_item = StatusHistoryPeriodsItem.from_dict(periods_item_data)
        ...
        status_history.additional_properties = d
