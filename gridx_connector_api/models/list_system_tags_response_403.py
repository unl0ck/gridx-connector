...
T = TypeVar("T", bound="ListSystemTagsResponse403")


@_attrs_define
class ListSystemTagsResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_system_tags_response_403 = cls(
            message=message,
            details=details,
        )

        list_system_tags_response_403.additional_properties = d
        return list_system_tags_response_403
