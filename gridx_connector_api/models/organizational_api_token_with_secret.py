...
T = TypeVar("T", bound="OrganizationalAPITokenWithSecret")


@_attrs_define
class OrganizationalAPITokenWithSecret:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organizational_api_token_with_secret = cls(
            token=token,
        )

        organizational_api_token_with_secret.additional_properties = d
        return organizational_api_token_with_secret
