...
T = TypeVar("T", bound="PatchAccountsAccountIDParentAccountAddress")


@_attrs_define
class PatchAccountsAccountIDParentAccountAddress:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_accounts_account_id_parent_account_address = cls(
            city=city,
            country=country,
        ...
        patch_accounts_account_id_parent_account_address.additional_properties = d
        return patch_accounts_account_id_parent_account_address
