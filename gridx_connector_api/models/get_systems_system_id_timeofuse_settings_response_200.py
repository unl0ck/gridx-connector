...
T = TypeVar("T", bound="GetSystemsSystemIDTimeofuseSettingsResponse200")


@_attrs_define
class GetSystemsSystemIDTimeofuseSettingsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_systems_system_id_timeofuse_settings_response_200 = cls(
            enabled=enabled,
        ...
        get_systems_system_id_timeofuse_settings_response_200.additional_properties = d
        return get_systems_system_id_timeofuse_settings_response_200
