...
T = TypeVar("T", bound="DeleteSystemTagResponse404")


@_attrs_define
class DeleteSystemTagResponse404:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_system_tag_response_404 = cls(
            message=message,
            details=details,
        )

        delete_system_tag_response_404.additional_properties = d
        return delete_system_tag_response_404
